 ...
 *
 * $Revision: 79009 $
 * $Date: 2017-05-22 17:20:03 +0800 (Mon, 22 May 2017) $
 *
...
#define RTK_MAX_PHY_PER_UNIT                        8                               /* max number of PHY connected by a chip */
...
#define RTK_MAX_NUM_OF_VLAN_GROUPS                  16 /* Applicable to 9310 */
#else
#define RTK_MAX_NUM_OF_VLAN_GROUPS                  8  /* Applicable to 9300 */
#endif
...
typedef struct rtk_unit_port_s {
    uint32       unit;
    rtk_port_t  port;
} rtk_unit_port_t;
...
typedef struct drv_miim_pollConf_s
{
    uint32          eth_type;
    rtk_enable_t    pollExtPhy;
}drv_miim_pollConf_t;
