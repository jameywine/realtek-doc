 ...
 *
 * $Revision: 71737 $
 * $Date: 2016-09-20 10:57:19 +0800 (Tue, 20 Sep 2016) $
 *
...
typedef enum rt_error_code_e
{
    ...
    /* 0x0017xxxx for CAPWAP related */
    RT_ERR_CAPWAP_NO_EMPTY_ENTRY = 0x00170000,
    RT_ERR_CAPWAP_ENTRY_EXIST,
    RT_ERR_CAPWAP_BSSIDLIST_TBL_FULL,
    RT_ERR_CAPWAP_WIRELESS_FWD_NOT_EXIST,
    RT_ERR_CAPWAP_BSSID_NOT_EXIST,

    /* 0x0018xxxx for stacking related */
    RT_ERR_STACK_ID = 0x00180000,                   /* 0x00180000, Invalid stacking ID                                               */
