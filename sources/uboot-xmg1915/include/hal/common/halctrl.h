 ...
 *
 * $Revision: 80459 $
 * $Date: 2017-07-07 18:24:02 +0800 (Fri, 07 Jul 2017) $
 *
...
/* CAPWAP */
#define HAL_CAPWAP_HASHDEPTH(unit)                  (hal_ctrl[unit].pDev_info->pCapacityInfo->max_num_of_capwap_hashdepth)
...
#define HAL_STACK_PORT_START_BY_CHIP(chip_id)       (hal_stackPortStartEnd_get(chip_id, STACK_PORT_INDEX_TYPE_START))
#define HAL_STACK_PORT_END_BY_CHIP(chip_id)         (hal_stackPortStartEnd_get(chip_id, STACK_PORT_INDEX_TYPE_END))
/*
