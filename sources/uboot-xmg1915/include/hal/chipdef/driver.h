...
typedef struct rt_macdrv_s
{
    ...
    int32   (*fMdrv_miim_pollingConfig_set)(uint32 unit, uint32 port, drv_miim_pollConf_t *pPollConf);
    int32   (*fMdrv_miim_smiMdxProto_get)(uint32 unit, uint32 smi_id, drv_smi_mdxProtoSel_t *pProto);
    int32   (*fMdrv_miim_smiMdxProto_set)(uint32 unit, uint32 smi_id, drv_smi_mdxProtoSel_t proto);
} rt_macdrv_t;
