...
MEM_ENTRY_DECLARE(bssid_tnlSt_entry_t, 4);
...
MEM_ENTRY_DECLARE(bssid_entry_t, 3);
MEM_ENTRY_DECLARE(bssid_ts_entry_t, 4);
MEM_ENTRY_DECLARE(bssid_list_entry_t, 1);
MEM_ENTRY_DECLARE(capwap_entry_t, 3);
...
MEM_ENTRY_DECLARE(l3_prefix_route_entry_t, 5);
