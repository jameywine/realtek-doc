...
struct hsb_param_s
{
    union
    {
        ...
        struct
        {
            ...
            uint32 ctag_unit:4;          /* destination unit ID */
...
typedef enum rtk_dbg_mib_dbgType_e
{
    ...
    RTK_DBG_MIB_RX_FLOW_CONTROL_DROP_RTL8380,
    ...
    RTK_DBG_CNTR_ALE_RX_GOOD_PKTS = 0,
    RTK_DBG_CNTR_RX_MAX_FRAME_SIZE,
    RTK_DBG_CNTR_MAC_RX_DROP,
    RTK_DBG_CNTR_OPENFLOW_IP_MPLS_TTL,
    RTK_DBG_CNTR_OPENFLOW_TBL_MISS,
    RTK_DBG_CNTR_IGR_BW,
    RTK_DBG_CNTR_SPECIAL_CONGEST,
    RTK_DBG_CNTR_EGR_QUEUE,
    RTK_DBG_CNTR_RESERVED,
    RTK_DBG_CNTR_EGR_LINK_STATUS,
    RTK_DBG_CNTR_STACK_UCAST_NONUCAST_TTL = 10,
    RTK_DBG_CNTR_STACK_NONUC_BLOCKING_PMSK,
    RTK_DBG_CNTR_L2_CRC,
    RTK_DBG_CNTR_SRC_PORT_FILTER,
    RTK_DBG_CNTR_PARSER_PACKET_TOO_LONG,
    RTK_DBG_CNTR_PARSER_MALFORM_PACKET,
    RTK_DBG_CNTR_MPLS_OVER_2_LBL,
    RTK_DBG_CNTR_EACL_METER,
    RTK_DBG_CNTR_IACL_METER,
    RTK_DBG_CNTR_PROTO_STORM,
    RTK_DBG_CNTR_INVALID_CAPWAP_HEADER = 20,
    RTK_DBG_CNTR_MAC_IP_SUBNET_BASED_VLAN,
    RTK_DBG_CNTR_OAM_PARSER,
    RTK_DBG_CNTR_UC_MC_RPF,
    RTK_DBG_CNTR_IP_MAC_BINDING_MATCH_MISMATCH,
    RTK_DBG_CNTR_SA_BLOCK,
    RTK_DBG_CNTR_TUNNEL_IP_ADDRESS_CHECK,
    RTK_DBG_CNTR_EACL_DROP,
    RTK_DBG_CNTR_IACL_DROP,
    RTK_DBG_CNTR_ATTACK_PREVENT,
    RTK_DBG_CNTR_SYSTEM_PORT_LIMIT_LEARN = 30,
    RTK_DBG_CNTR_OAMPDU,
    RTK_DBG_CNTR_CCM_RX,
    RTK_DBG_CNTR_CFM_UNKNOWN_TYPE,
    RTK_DBG_CNTR_LBM_LBR_LTM_LTR,
    RTK_DBG_CNTR_Y_1731,
    RTK_DBG_CNTR_VLAN_LIMIT_LEARN,
    RTK_DBG_CNTR_VLAN_ACCEPT_FRAME_TYPE,
    RTK_DBG_CNTR_CFI_1,
    RTK_DBG_CNTR_STATIC_DYNAMIC_PORT_MOVING,
    RTK_DBG_CNTR_PORT_MOVE_FORBID = 40,
    RTK_DBG_CNTR_L3_CRC,
    RTK_DBG_CNTR_BPDU_PTP_LLDP_EAPOL_RMA,
    RTK_DBG_CNTR_MSTP_SRC_DROP_DISABLED_BLOCKING,
    RTK_DBG_CNTR_INVALID_SA,
    RTK_DBG_CNTR_NEW_SA,
    RTK_DBG_CNTR_VLAN_IGR_FILTER,
    RTK_DBG_CNTR_IGR_VLAN_CONVERT,
    RTK_DBG_CNTR_GRATUITOUS_ARP,
    RTK_DBG_CNTR_MSTP_SRC_DROP,
    RTK_DBG_CNTR_L2_HASH_FULL = 50,
    RTK_DBG_CNTR_MPLS_UNKNOWN_LBL,
    RTK_DBG_CNTR_L3_IPUC_NON_IP,
    RTK_DBG_CNTR_TTL,
    RTK_DBG_CNTR_MTU,
    RTK_DBG_CNTR_ICMP_REDIRECT,
    RTK_DBG_CNTR_STORM_CONTROL,
    RTK_DBG_CNTR_L3_DIP_DMAC_MISMATCH,
    RTK_DBG_CNTR_IP4_IP_OPTION,
    RTK_DBG_CNTR_IP6_HBH_EXT_HEADER,
    RTK_DBG_CNTR_IP4_IP6_HEADER_ERROR = 60,
    RTK_DBG_CNTR_ROUTING_IP_ADDR_CHECK,
    RTK_DBG_CNTR_ROUTING_EXCEPTION,
    RTK_DBG_CNTR_DA_BLOCK,
    RTK_DBG_CNTR_OAM_MUX,
    RTK_DBG_CNTR_PORT_ISOLATION,
    RTK_DBG_CNTR_VLAN_EGR_FILTER,
    RTK_DBG_CNTR_MIRROR_ISOLATE,
    RTK_DBG_CNTR_MSTP_DESTINATION_DROP,
    RTK_DBG_CNTR_L2_MC_BRIDGE,
    RTK_DBG_CNTR_IP_UC_MC_ROUTING_LOOK_UP_MISS = 70,
    RTK_DBG_CNTR_L2_UC,
    RTK_DBG_CNTR_L2_MC,
    RTK_DBG_CNTR_IP4_MC,
    RTK_DBG_CNTR_IP6_MC,
    RTK_DBG_CNTR_L3_UC_MC_ROUTE,
    RTK_DBG_CNTR_UNKNOWN_L2_UC_FLPM,
    RTK_DBG_CNTR_BC_FLPM,
    RTK_DBG_CNTR_VLAN_PRO_UNKNOWN_L2_MC_FLPM,
    RTK_DBG_CNTR_VLAN_PRO_UNKNOWN_IP4_MC_FLPM,
    RTK_DBG_CNTR_VLAN_PROFILE_UNKNOWN_IP6_MC_FLPM = 80,
#endif
#if defined(CONFIG_SDK_RTL9300)
    RTK_DBG_CNTR_OAM_PARSER     = 0,
    RTK_DBG_CNTR_UC_RPF,
    RTK_DBG_CNTR_DEI_CFI,
    RTK_DBG_CNTR_MAC_IP_SUBNET_BASED_VLAN,
    RTK_DBG_CNTR_VLAN_IGR_FILTER,

    RTK_DBG_CNTR_L2_UC_MC_BRIDGE,
    RTK_DBG_CNTR_IP4_IP6_MC_BRIDGE,
    RTK_DBG_CNTR_PTP,
    RTK_DBG_CNTR_USER_DEF_0_3,
    RTK_DBG_CNTR_RESERVED,

    RTK_DBG_CNTR_RESERVED1  = 10,
    RTK_DBG_CNTR_RESERVED2,
    RTK_DBG_CNTR_BPDU_RMA,
    RTK_DBG_CNTR_LACP,
    RTK_DBG_CNTR_LLDP,
    ...
    RTK_DBG_CNTR_XX_RMA,
    RTK_DBG_CNTR_L3_IPUC_NON_IP,
    RTK_DBG_CNTR_IP4_IP6_HEADER_ERROR,
    RTK_DBG_CNTR_L3_BAD_IP,

    RTK_DBG_CNTR_L3_DIP_DMAC_MISMATCH = 20,
    RTK_DBG_CNTR_IP4_IP_OPTION,
    RTK_DBG_CNTR_IP_UC_MC_ROUTING_LOOK_UP_MISS,
    RTK_DBG_CNTR_L3_DST_NULL_INTF,
    RTK_DBG_CNTR_L3_PBR_NULL_INTF,

    RTK_DBG_CNTR_HOST_NULL_INTF,
    RTK_DBG_CNTR_ROUTE_NULL_INTF,
    RTK_DBG_CNTR_BRIDGING_ACTION,
    RTK_DBG_CNTR_ROUTING_ACTION,
    RTK_DBG_CNTR_IPMC_RPF,

    RTK_DBG_CNTR_L2_NEXTHOP_AGE_OUT =30,
    RTK_DBG_CNTR_L3_UC_TTL_FAIL,
    RTK_DBG_CNTR_L3_MC_TTL_FAIL,
    RTK_DBG_CNTR_L3_UC_MTU_FAIL,
    RTK_DBG_CNTR_L3_MC_MTU_FAIL,

    RTK_DBG_CNTR_L3_UC_ICMP_REDIR,
    RTK_DBG_CNTR_IP6_MLD_OTHER_ACT,
    RTK_DBG_CNTR_ND,
    RTK_DBG_CNTR_IP_MC_RESERVED,
    RTK_DBG_CNTR_IP6_HBH,

    RTK_DBG_CNTR_INVALID_SA       =40,
    RTK_DBG_CNTR_L2_HASH_FULL,
    RTK_DBG_CNTR_NEW_SA,
    RTK_DBG_CNTR_PORT_MOVE_FORBID,
    RTK_DBG_CNTR_STATIC_PORT_MOVING,

    RTK_DBG_CNTR_DYNMIC_PORT_MOVING,
    RTK_DBG_CNTR_L3_CRC,
    RTK_DBG_CNTR_MAC_LIMIT,
    RTK_DBG_CNTR_ATTACK_PREVENT,
    RTK_DBG_CNTR_ACL_FWD_ACTION,

    RTK_DBG_CNTR_OAMPDU     =50,
    RTK_DBG_CNTR_OAM_MUX,
    RTK_DBG_CNTR_TRUNK_FILTER,
    RTK_DBG_CNTR_ACL_DROP,
    RTK_DBG_CNTR_IGR_BW,

    RTK_DBG_CNTR_ACL_METER,
    RTK_DBG_CNTR_VLAN_ACCEPT_FRAME_TYPE,
    RTK_DBG_CNTR_MSTP_SRC_DROP_DISABLED_BLOCKING,
    RTK_DBG_CNTR_SA_BLOCK,
    RTK_DBG_CNTR_DA_BLOCK,

    RTK_DBG_CNTR_STORM_CONTROL  =60,
    RTK_DBG_CNTR_VLAN_EGR_FILTER,
    RTK_DBG_CNTR_MSTP_DESTINATION_DROP,
    RTK_DBG_CNTR_SRC_PORT_FILTER,
    RTK_DBG_CNTR_PORT_ISOLATION,

    RTK_DBG_CNTR_TX_MAX_FRAME_SIZE,
    RTK_DBG_CNTR_EGR_LINK_STATUS,
    RTK_DBG_CNTR_MAC_TX_DISABLE,
    RTK_DBG_CNTR_MAC_PAUSE_FRAME,
    RTK_DBG_CNTR_MAC_RX_DROP,                     /*LLC check failure, 48pass1,dscrunout/l2-CRC/oversize/undersize/symbol-error*/

    RTK_DBG_CNTR_MIRROR_ISOLATE =70,
    RTK_DBG_CNTR_RX_FC,
    RTK_DBG_CNTR_EGR_QUEUE,
    RTK_DBG_CNTR_HSM_RUNOUT,            /*Replication*/
    RTK_DBG_CNTR_ROUTING_DISABLE,

    RTK_DBG_CNTR_INVALID_L2_NEXTHOP_ENTRY,
    RTK_DBG_CNTR_L3_MC_SRC_FLT,
    RTK_DBG_CNTR_CPUTAG_FLT,
    RTK_DBG_CNTR_FWD_PMSK_NULL,
    RTK_DBG_CNTR_IPUC_ROUTING_LOOKUP_MISS,

    RTK_DBG_CNTR_MY_UNIT_DROP   =80,
    RTK_DBG_CNTR_STACK_NONUC_BLOCKING_PMSK,     /*pmsk = 0*/
    RTK_DBG_CNTR_STACK_PORT_NOT_FOUND,
    RTK_DBG_CNTR_ACL_LOOPBACK_DROP,
    RTK_DBG_CNTR_IP6_ROUTING_EXT_HEADER,
#endif
