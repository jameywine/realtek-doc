...
#define RTK_ACL_FWD_FLAG_LOCAL_UNIT                 (1 << 4)    /* forward info is local unit for copy/redirect single port */
 ...
 */
    ...
    /* Applicable to 9310 */
    USER_FIELD_IGR_UNIT,                    /* ingress unit id */
    /* Applicable to 9300, 9310 */
 ...
 */
    ...
    /* Applicable to 9300 */
    USER_FIELD_VACL_ROUTING_HIT,            /* VACL unicast routing action hit */
 ...
 */
    ...
    /* Applicable to 9310 */
    USER_FIELD_EGR_UNIT,                    /* egress unit id */
    /* Applicable to 9310 */
...
typedef enum rtk_acl_vTnlType_s
{
    RTK_ACL_TNL_IP,
    RTK_ACL_TNL_CAPWAP,
    RTK_ACL_TNL_END,
...
typedef struct rtk_acl_vActTnl_s
{
    rtk_acl_vTnlType_t    type;
    uint32                  idx;
} rtk_acl_vActTnl_t;
...
#if defined(CONFIG_SDK_RTL9310)
    rtk_enable_t                    tnl_en;     /* tunnel action */
    rtk_acl_vActTnl_t          tnl_data;
#endif  /* defined(CONFIG_SDK_RTL9310) */
} rtk_acl_vAct_t;
