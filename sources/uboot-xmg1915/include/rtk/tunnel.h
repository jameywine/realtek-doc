 ...
 *
 * $Revision: 80572 $
 * $Date: 2017-07-13 19:07:20 +0800 (Thu, 13 Jul 2017) $
 *
...
typedef enum rtk_tunnel_type_e
{
    ...
    RTK_TUNNEL_TYPE_CAPWAP_IP,          /* CAPWAP-in-IPv4 tunnel */
    RTK_TUNNEL_TYPE_CAPWAP_IP6,         /* CAPWAP-in-IPv6 tunnel */
...
/* CAPWAP tunnel flags */
typedef enum rtk_tunnel_capwap_flag_e
{
    RTK_TUNNEL_CAPWAP_FLAG_NONE                 = 0x00000000,   /* none */

    RTK_TUNNEL_CAPWAP_FLAG_80211_FRAME          = 0x00000001,   /* 802.11 frame payload */
    RTK_TUNNEL_CAPWAP_FLAG_ITAG_ENABLE          = 0x00000002,   /* passenger inner tag state, takes effect if frame format is 802.3 */
    RTK_TUNNEL_CAPWAP_FLAG_OTAG_ENABLE          = 0x00000004,   /* passenger outer tag state, takes effect if frame format is 802.3 */
    RTK_TUNNEL_CAPWAP_FLAG_UDP_LITE             = 0x00000008,   /* use UDP-lite encapsulation */
    RTK_TUNNEL_CAPWAP_FLAG_RADIO_MAC_ADD        = 0x00000010,   /* insert Radio MAC Address field in CAPWAP header */
    RTK_TUNNEL_CAPWAP_FLAG_WL_INFO_ADD          = 0x00000020,   /* insert Wireless Specific Information field in CAPWAP header */
} rtk_tunnel_capwap_flag_t;
...
typedef struct rtk_tunnel_intf_s
{
    ...
    struct
    {
        rtk_intf_id_t   l3_intf_id;     /* ingress L3 interface ID */
    ...
    struct
    {
        rtk_intf_id_t   l3_intf_id;     /* egress L3 interface ID */
        rtk_mac_t       dmac;           /* destination MAC address */
        rtk_mac_t       smac;           /* source MAC address */
    ...
    union
    {
        ...
        struct
        {
            ...
            uint32  l4_udp_lite_en;

            uint32  flags;/* CAPWAP tunnel flags (rtk_tunnel_capwap_flag_t) */
        } capwap_ip;

        /* RTK_TUNNEL_TYPE_CAPWAP_IP6 */
        struct
        {
            struct
            {
...
/* types of counters per tunnel object. */
typedef enum rtk_tunnel_stat_e
{
    RTK_TUNNEL_STAT_INTF_IN_OCTETS,                 /* Byte count of packets at incoming */
    RTK_TUNNEL_STAT_INTF_IN_PKTS,                   /* Packet count of packets at incoming */
    RTK_TUNNEL_STAT_INTF_IN_DROPS,                  /* Packet count of dropped packets at incoming */

    RTK_TUNNEL_STAT_INTF_OUT_OCTETS,                /* Byte count of packets at outgoing */
    RTK_TUNNEL_STAT_INTF_OUT_PKTS,                  /* Packet count of packets at outgoing */
    RTK_TUNNEL_STAT_INTF_OUT_DROPS,                 /* Packet count of dropped packets at outgoing */

    RTK_TUNNEL_STAT_END                             /* end of enum */
} rtk_tunnel_stat_t;
