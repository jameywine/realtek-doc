...
{
    RTK_L3_ACT_FORWARD = 0,         /* may be bridging or routing */
    RTK_L3_ACT_DROP,
    RTK_L3_ACT_TRAP2CPU,
    RTK_L3_ACT_COPY2CPU,
...
typedef enum rtk_l3_stat_e
{
    RTK_L3_STAT_INTF_IN_OCTETS,                     /* Byte count of packets at incoming */
    RTK_L3_STAT_INTF_IN_UCAST_PKTS,                 /* Packet count of unicast packets at incoming */
    RTK_L3_STAT_INTF_IN_MULTICAST_PKTS,             /* Packet count of multicast packets at incoming */
    RTK_L3_STAT_INTF_IN_BROADCAST_PKTS,             /* Packet count of broadcast packets at incoming */
    RTK_L3_STAT_INTF_IN_UNKNOWN_PROTOS,             /* Packet count of unknown protocol packets at incoming */
    RTK_L3_STAT_INTF_IN_DISCARDS,                   /* Packet count of discarded packets at incoming */

    RTK_L3_STAT_INTF_OUT_OCTETS,                    /* Byte count of packets at outgoing */
    RTK_L3_STAT_INTF_OUT_UCAST_PKTS,                /* Packet count of unicast packets at outgoing */
    RTK_L3_STAT_INTF_OUT_MULTICAST_PKTS,            /* Packet count of multicast packets at outgoing */
    RTK_L3_STAT_INTF_OUT_BROADCAST_PKTS,            /* Packet count of broadcast packets at outgoing */
    RTK_L3_STAT_INTF_OUT_DISCARDS,                  /* Packet count of discarded packets at outgoing */

    RTK_L3_STAT_INTF_END                            /* end of enum */
} rtk_l3_stat_t;
...
/* L3 ECMP control type (GCT) */
typedef enum rtk_l3_ecmpCtrlType_e
{
    RTK_L3_ECT_NONE = 0,                            /* Dummy */

    RTK_L3_ECT_HASH_METER_EN,                       /* rtk_enable_t */
    RTK_L3_ECT_HASH_METER_IDX,                      /* uint32 */

    RTK_L3_ECT_END
} rtk_l3_ecmpCtrlType_t;
...
typedef struct rtk_l3_info_s
{
    ...
    int32 vrf_used;                 /* currect number of created virtual routers */
...
typedef struct rtk_l3_route_s {
    rtk_l3_flag_t       flags;          /* route flags */
 ...
 *      unit       - unit id
 *      ecmpId     - ECMP path ID
 *      nhIdCount  - number of entries of nexthop path
 *      pNhIdArray - pointer to the path IDs
 * Output:
 *      None
 * Return:
 ...
 */
extern int32
rtk_l3_ecmpHashTbl_set(uint32 unit, rtk_l3_pathId_t ecmpId, uint32 nhIdCount, rtk_l3_pathId_t *pNhIdArray);
 ...
 *          RTK_L3_FLAG_TTL_CHK_IGNORE  - ignore TTL check
 *          RTK_L3_FLAG_QOS_ASSIGN      - assign a new internal priority (with qos_pri field)
 *      (3) when pRoute->path_id = 0, the pRoute->fwd_act can only be RTK_L3_HOST_ACT_DROP
 *          or RTK_L3_HOST_ACT_TRAP2CPU
 * Changes:
 *      [SDK_3.0.0]
 *          New added function.
