...
typedef struct rtk_of_igrFT0ActOutput_s
{
    ...
    union
    {
        ...
        rtk_portmask_t              portmask;  /* OF_OUTPUT_TYPE_MULTI_EGR_PORT:       egress portmask
                                                ...
                                                */
        uint32 				        tunnel_idx;/* OF_OUTPUT_TYPE_TUNNEL:               index to tunnel start table */
    };

    uint32 				            unit;      /* OF_OUTPUT_TYPE_PHY_PORT_EX_SRC_PORT: stacking unit ID
                                                * OF_OUTPUT_TYPE_PHY_PORT:             stacking unit ID
                                                */
...
/* Function Name:
 *      rtk_mango_of_l2FlowEntryHitSts_get
 * Description:
