...
/* Flags for L3 multicast NextHop interface */
typedef enum rtk_mcast_egrIf_flag_e
{
    RTK_MCAST_NH_FLAG_PMSK_REPLACE  = 0x00000001,   /* When add next-hop portmask,
                                                     * replace the hardware with user input value
                                                     * instead of adding the ports to hardware. */
    RTK_MCAST_NH_FLAG_BRIDGE        = 0x00000002,   /* forwarding packet as bridging */
...
typedef enum rtk_mcast_egrIfType_e
{
    ...
    RTK_MCAST_EGRIF_TYPE_CAPWAP,       /* CAPWAP (L2 tunnel) */
 ...
 *      egrIf_max is the max entry number can use rtk_switch_deviceInfo_get() to get max_num_of_mcast_group_nexthop
 * Changes:
 *      [SDK_3.0.0]
 *          New added function.
 */
 ...
 * Note:
 *      (1) Applicable flags:
 *          RTK_MCAST_NH_FLAG_PMSK_REPLACE   - to indicate replace nexthop type entry portmask
 *          RTK_MCAST_NH_FLAG_BRIDGE         - to indicate L3 nexthop type used for L2 bridge
 * Changes:
 *      [SDK_3.0.0]
 *          New added function.
 */
 ...
 *          type and type info of l2/l3/stk/tunnel/capwap .
 * Changes:
 *      [SDK_3.0.0]
 *          New added function.
 */
