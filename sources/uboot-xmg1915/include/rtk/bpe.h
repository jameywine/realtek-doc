...
/* Function Name:
 *      rtk_bpe_pvidEntry_set
 * Description:
 *      Update an extended port's PVID entry on the specified device.
 * Input:
 *      unit   - unit id
 *      pEntry - pointer to the PVID entry
 * Output:
 ...
 */
extern int32
rtk_bpe_pvidEntry_set(uint32 unit, rtk_bpe_pvidEntry_t *pEntry);
...
/* Function Name:
 *      rtk_bpe_fwdEntry_set
 * Description:
 *      Update an E-CID forwarding entry on the specified device.
 * Input:
 *      unit   - unit id
 *      pEntry - pointer to the E-CID forwarding entry
 * Output:
 ...
 */
extern int32
rtk_bpe_fwdEntry_set(uint32 unit, rtk_bpe_fwdEntry_t *pEntry);
