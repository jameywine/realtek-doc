 ...
 */
 /*ver_A/B use old alg*/
#define IS_L3_ECO_VER(unit)     ((RTL9301_CHIP_ID_24G == HWP_CHIP_ID(unit)) && ((1==HWP_CHIP_REV(unit))||(2==HWP_CHIP_REV(unit))))
...
#define DAL_LONGAN_L3_VID_MAX            (4096) /* [FIXME] may use VLAN module's info or call table_size_get() API to get (TBD) */
...
#define DAL_LONGAN_L3_INTF_ID_ENTRY_IDX_MASK         (0x07FU)
