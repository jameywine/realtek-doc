 ...
 *                                    	      9300
 *          - MGMT_TYPE_ARP_REQ             (1011110)
 *          - MGMT_TYPE_ARP_REP             (1011110)
 *          - MGMT_TYPE_DHCP                (1011110)
 *          - MGMT_TYPE_DHCP6               (1011110)
 *          - MGMT_TYPE_MLD                 (1011110)
 *          - MGMT_TYPE_IGMP                (1011110)
...
/* Function Name:
 *      dal_longan_trap_mgmtFrameMgmtVlanEnable_get
 * Description:
 ...
 */
extern int32
dal_longan_trap_mgmtFrameMgmtVlanEnable_get(uint32 unit, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_longan_trap_mgmtFrameMgmtVlanEnable_set
 * Description:
 ...
 */
extern int32
dal_longan_trap_mgmtFrameMgmtVlanEnable_set(uint32 unit, rtk_enable_t enable);

/* Function Name:
 *      dal_longan_trap_mgmtFrameSelfARPEnable_get
 * Description:
 ...
 */
extern int32
dal_longan_trap_mgmtFrameSelfARPEnable_get(uint32 unit, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_longan_trap_mgmtFrameSelfARPEnable_set
 * Description:
 ...
 */
extern int32
dal_longan_trap_mgmtFrameSelfARPEnable_set(uint32 unit, rtk_enable_t enable);
