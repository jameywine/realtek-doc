...
typedef struct dal_mapper_s {
    ...
    int32   (*vlan_bssid_add)(uint32, rtk_vlan_t, rtk_mac_t *);
    int32   (*vlan_bssid_del)(uint32, rtk_vlan_t, rtk_mac_t *);
    int32   (*vlan_bssid_get)(uint32, rtk_vlan_t, uint32, rtk_mac_t *, uint32 *);
    ...
    int32   (*l2_mcastAddrEcidPmsk_add)(uint32, rtk_l2_mcastAddr_t *, rtk_bpe_pmskEntry_t *);
    int32   (*l2_mcastAddrEcidPmsk_del)(uint32, rtk_l2_mcastAddr_t, rtk_bpe_pmskEntry_t *);
    int32   (*l2_mcastAddrEcidPmsk_get)(uint32, rtk_l2_mcastAddr_t *, rtk_bpe_pmskEntry_t *);
    int32   (*l2_mcastAddrEcidPmskNextValid_get)(uint32, rtk_l2_mcastAddr_t *, rtk_bpe_pmskEntry_t *);
    ...
    int32   (*port_phyEyeMonitor_start)(uint32, rtk_port_t, uint32);
    ...
    int32   (*trunk_srcPortMap_get)(uint32, rtk_unit_port_t, uint32 *, rtk_trk_t *);
    int32   (*trunk_srcPortMap_set)(uint32, rtk_unit_port_t, uint32, rtk_trk_t);
    ...
    int32   (*rate_portIgrQueueFixedBwCtrlEnable_get)(uint32, rtk_port_t, rtk_qid_t, rtk_enable_t *);
    int32   (*rate_portIgrQueueFixedBwCtrlEnable_set)(uint32, rtk_port_t, rtk_qid_t, rtk_enable_t);
    ...
    int32   (*qos_portIgrQueueStrictEnable_get)(uint32, rtk_port_t, rtk_qid_t, rtk_enable_t * );
    int32   (*qos_portIgrQueueStrictEnable_set)(uint32, rtk_port_t, rtk_qid_t, rtk_enable_t );
    ...
    int32   (*switch_tagPauseAction_get)(uint32, rtk_action_t *);
    int32   (*switch_tagPauseAction_set)(uint32, rtk_action_t);
    int32   (*switch_halfConsecutiveRetryEnable_get)(uint32, rtk_enable_t *);
    int32   (*switch_halfConsecutiveRetryEnable_set)(uint32, rtk_enable_t);
    ...
    int32   (*l3_intfStat_get)(uint32, rtk_intf_id_t, rtk_l3_stat_t, uint64 *);
    ...
    int32   (*l3_ecmpHashTbl_get)(uint32, rtk_l3_pathId_t, uint32, uint32 *);
    int32   (*l3_ecmpHashTbl_set)(uint32, rtk_l3_pathId_t, uint32, uint32 *);
    int32   (*l3_ecmpCtrl_get)(uint32, rtk_l3_pathId_t, rtk_l3_ecmpCtrlType_t, int32 *);
    int32   (*l3_ecmpCtrl_set)(uint32, rtk_l3_pathId_t, rtk_l3_ecmpCtrlType_t, int32);
    ...
    int32   (*tunnel_intfStat_get)(uint32, rtk_intf_id_t, rtk_tunnel_stat_t, uint64 *);
    ...
    int32   (*tunnel_intfCtrl_get)(uint32, rtk_intf_id_t, rtk_tunnel_intfCtrlType_t, rtk_tunnel_intfCtrlParam_t *);
    int32   (*tunnel_intfCtrl_set)(uint32, rtk_intf_id_t, rtk_tunnel_intfCtrlType_t, rtk_tunnel_intfCtrlParam_t);
    ...
    int32   (*of_ftTemplateSelector_get)(uint32, uint32, rtk_of_ftTemplateIdx_t *);
    int32   (*of_ftTemplateSelector_set)(uint32, uint32 , rtk_of_ftTemplateIdx_t);
    ...
    /* CAPWAP */
    int32   (*capwap_init)(uint32);
    int32   (*capwap_enable_get)(uint32, rtk_enable_t *);
    int32   (*capwap_enable_set)(uint32, rtk_enable_t);
    int32   (*capwap_udpPort_get)(uint32, uint32 *, uint32 *);
    int32   (*capwap_udpPort_set)(uint32, uint32, uint32);
    int32   (*capwap_fwdAction_get)(uint32, rtk_capwap_fwdPktType_t, rtk_action_t *);
    int32   (*capwap_fwdAction_set)(uint32, rtk_capwap_fwdPktType_t, rtk_action_t);
    int32   (*capwap_trapTarget_get)(uint32, rtk_trapTarget_t *);
    int32   (*capwap_trapTarget_set)(uint32, rtk_trapTarget_t);
    int32   (*capwap_bssidTblHashAlgo_get)(uint32, uint32 *);
    int32   (*capwap_bssidTblHashAlgo_set)(uint32, uint32);
    int32   (*capwap_qosProfile_get)(uint32, uint32, rtk_capwap_qosProfile_t *);
    int32   (*capwap_qosProfile_set)(uint32, uint32, rtk_capwap_qosProfile_t);
    int32   (*capwap_tidRemarking_get)(uint32, uint32, rtk_pri_t, uint32 *);
    int32   (*capwap_tidRemarking_set)(uint32, uint32, rtk_pri_t, uint32);
    int32   (*capwap_bssidEntry_add)(uint32, rtk_capwap_bssidEntry_t *);
    int32   (*capwap_bssidEntry_del)(uint32, rtk_capwap_bssidEntry_t *);
    int32   (*capwap_bssidEntry_get)(uint32, rtk_capwap_bssidEntry_t *);
    int32   (*capwap_bssidEntryNextValid_get)(uint32, int32 *, rtk_capwap_bssidEntry_t *);
    int32   (*capwap_ucast_add)(uint32, rtk_capwap_ucast_t *);
    int32   (*capwap_ucast_del)(uint32, rtk_capwap_ucast_t *);
    int32   (*capwap_ucast_get)(uint32, rtk_capwap_ucast_t *);
    int32   (*capwap_ucastNextValid_get)(uint32, int32 *, rtk_capwap_ucast_t *);
    int32   (*capwap_mcastNextValid_get)(uint32, int32 *, rtk_capwap_mcast_t *);
    int32   (*capwap_mcastBssid_add)(uint32, rtk_capwap_mcastBssid_t *);
    int32   (*capwap_mcastBssid_del)(uint32, rtk_capwap_mcastBssid_t *);
    int32   (*capwap_mcastBssid_get)(uint32, rtk_capwap_mcastBssid_t *, uint32, rtk_mac_t *, uint32 *);
    int32   (*capwap_bssidListNextValid_get)(uint32, int32 *, rtk_capwap_bssidList_t *);
    ...
    int32   (*time_refTimeFreq_get)(uint32, uint32 *);
    int32   (*time_refTimeFreq_set)(uint32, uint32);
    ...
    int32   (*stack_unit_get)(uint32, uint32 *);
    int32   (*stack_unit_set)(uint32, uint32);
    int32   (*stack_masterUnit_get)(uint32, uint32 *);
    int32   (*stack_masterUnit_set)(uint32, uint32);
    int32   (*stack_loopGuard_get)(uint32, rtk_enable_t *);
    int32   (*stack_loopGuard_set)(uint32, rtk_enable_t);
    int32   (*stack_unitPortMap_get)(uint32, uint32, rtk_portmask_t *);
    int32   (*stack_unitPortMap_set)(uint32, uint32, rtk_portmask_t *);
