 ...
 *
 * $Revision: 76831 $
 * $Date: 2017-03-22 20:04:13 +0800 (Wed, 22 Mar 2017) $
 *
...
#define RTK_MII_READ(unit,port,p,r,pVal)            hal_ctrl[unit].pChip_driver->pMacdrv->fMdrv_miim_park_read(unit,port,p,0x1F,r,pVal)
#define RTK_MII_WRITE(unit,port,p,r,val)            hal_ctrl[unit].pChip_driver->pMacdrv->fMdrv_miim_park_write(unit,port,p,0x1F,r,val)
