...
#ifdef CMD_MIRROR_SET_MIRROR_ID_INDEX_TYPE_PORT_BASED_RSPAN_BASED_FLOW_BASED_MIRRORING_UNIT_PORT_INGRESS_MIRRORED_INGRESS_PORTS_NONE_EGRESS_MIRRORED_EGRESS_PORTS_NONE_OPTION_IGR_AND_EGR_MIRRORED_ONLY_ORIGINAL_PKT_DUPLICATE_FILTER_SELF_FILTER_MTP_VLAN
/*
 * mirror set mirror-id <UINT:index> type ( port-based | rspan-based | flow-based ) mirroring <UINT:unit> <UINT:port> ingress-mirrored ( <PORT_LIST:ingress_ports> | none ) egress-mirrored ( <PORT_LIST:egress_ports> | none ) option { igr-and-egr } { mirrored-only } { original-pkt } { duplicate-filter } { self-filter } { mtp-vlan } */
cparser_result_t
cparser_cmd_mirror_set_mirror_id_index_type_port_based_rspan_based_flow_based_mirroring_unit_port_ingress_mirrored_ingress_ports_none_egress_mirrored_egress_ports_none_option_igr_and_egr_mirrored_only_original_pkt_duplicate_filter_self_filter_mtp_vlan(
    ...
    char **egress_ports_ptr)
{
    ...
    mirror_entry.mirroring_unit = *unit_ptr;
    mirror_entry.mirroring_port = *port_ptr;
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_mirror_set_mirror_id_index_type_port_based_rspan_based_flow_based_mirroring_unit_port_ingress_mirrored_ingress_ports_none_egress_mirrored_egress_ports_none_option_igr_and_egr_mirrored_only_original_pkt_duplicate_filter_self_filter_mtp_vlan */
#endif
