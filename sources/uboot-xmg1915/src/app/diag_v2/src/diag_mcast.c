 ...
 *
 * $Revision: 81233 $
 * $Date: 2017-08-15 09:46:17 +0800 (Tue, 15 Aug 2017) $
 *
...
do{                     \
    ...
    DIAG_UTIL_MPRINTF(" L3 type for bridge  : %s \n", (__nh.flags & RTK_MCAST_NH_FLAG_BRIDGE) ? "True" : "False");   \
    }  \
    ...
    } else if (RTK_MCAST_EGRIF_TYPE_CAPWAP == __nh.type){     \
        DIAG_UTIL_MPRINTF(" Egr-I/f intf ID    : %d \n", __nh.capwap.intf_id);   \
        osal_memset(__portStr, 0, sizeof(__portStr));  \
        diag_util_lPortMask2str(__portStr, &__nh.l3.portmask);        \
        diag_util_mac2str(__portStr, (uint8 *)__nh.capwap.bssid.octet);          \
        DIAG_UTIL_MPRINTF(" Egr-I/f bssid ID   : %d \n", __portStr);   \
    ...
    char **ports_ptr)
{
    ...
    if (11 == TOKEN_NUM)
    {
        if ('r' ==  TOKEN_CHAR(10, 0))
            egrIf.flags |= RTK_MCAST_NH_FLAG_PMSK_REPLACE;
        else if ('b' ==  TOKEN_CHAR(10, 0))
            egrIf.flags |= RTK_MCAST_NH_FLAG_BRIDGE;
    }
...
#ifdef CMD_MCAST_ADD_EGRESS_INTERFACE_GROUP_GROUP_CAPWAP_INTF_INTF_ID_BASSID_MAC
/*
 * mcast add egress-interface group <UINT:group> capwap intf <UINT:intf_id> bassid <MACADDR:mac>
 */
cparser_result_t
cparser_cmd_mcast_add_egress_interface_group_group_capwap_intf_intf_id_bassid_mac(
    cparser_context_t *context,
    uint32_t *group_ptr,
    uint32_t *intf_id_ptr,
    cparser_macaddr_t *mac_ptr)
{
    ...
    osal_memset(&egrIf, 0, sizeof(rtk_mcast_egrif_t));
    egrIf.type = RTK_MCAST_EGRIF_TYPE_CAPWAP;
    egrIf.capwap.intf_id = *intf_id_ptr;
    osal_memcpy(egrIf.capwap.bssid.octet, mac_ptr->octet, 6);
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_mcast_add_egress_interface_group_group_capwap_intf_intf_id_bassid_mac */
#endif
...
#ifdef CMD_MCAST_DEL_EGRESS_INTERFACE_GROUP_GROUP_CAPWAP_INTF_INTF_ID_BASSID_MAC
/*
 * mcast del egress-interface group <UINT:group> capwap intf <UINT:intf_id> bassid <MACADDR:mac>
 */
cparser_result_t
cparser_cmd_mcast_del_egress_interface_group_group_capwap_intf_intf_id_bassid_mac(
    cparser_context_t *context,
    uint32_t *group_ptr,
    uint32_t *intf_id_ptr,
    cparser_macaddr_t *mac_ptr)
{
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_mcast_del_egress_interface_group_group_capwap_intf_intf_id_bassid_mac */
#endif
