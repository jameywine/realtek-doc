 ...
 *
 * $Revision: 80596 $
 * $Date: 2017-07-14 17:49:47 +0800 (Fri, 14 Jul 2017) $
 *
...
const char text_tunnel_stat[RTK_TUNNEL_STAT_END+1][32] =
{
    "Rx-Bytes",
    "Rx-Pkts",
    "Rx-Drops",
...
#ifdef CMD_TUNNEL_CREATE_INTF_TYPE_IP_IN_IP_IP6_IN_IP_IPANY_IN_IP_IP_IN_IP6_IP6_IN_IP6_IPANY_IN_IP6_ISATAP_6TO4_6RD_GRE_IP_IN_IP_GRE_IP6_IN_IP_GRE_IPANY_IN_IP_GRE_IP_IN_IP6_GRE_IP6_IN_IP6_GRE_IPANY_IN_IP6_VXLAN_IN_IP_VXLAN_IN_IP6_VXLAN_GPE_IN_IP_VXLAN_GPE_IN_IP6_CAPWAP_IN_IP_CAPWAP_IN_IP6
/*
 * tunnel create intf type ( ip-in-ip | ip6-in-ip | ipany-in-ip | ip-in-ip6 | ip6-in-ip6 | ipany-in-ip6 | isatap | 6to4 | 6rd | gre-ip-in-ip | gre-ip6-in-ip | gre-ipany-in-ip | gre-ip-in-ip6 | gre-ip6-in-ip6 | gre-ipany-in-ip6 | vxlan-in-ip | vxlan-in-ip6 | vxlan-gpe-in-ip | vxlan-gpe-in-ip6 | capwap-in-ip | capwap-in-ip6 )
 */
cparser_result_t
cparser_cmd_tunnel_create_intf_type_ip_in_ip_ip6_in_ip_ipany_in_ip_ip_in_ip6_ip6_in_ip6_ipany_in_ip6_isatap_6to4_6rd_gre_ip_in_ip_gre_ip6_in_ip_gre_ipany_in_ip_gre_ip_in_ip6_gre_ip6_in_ip6_gre_ipany_in_ip6_vxlan_in_ip_vxlan_in_ip6_vxlan_gpe_in_ip_vxlan_gpe_in_ip6_capwap_in_ip_capwap_in_ip6(
    cparser_context_t *context)

{
    ...
    else if (0 == osal_strcmp(TOKEN_STR(4), "capwap-in-ip"))
    {
        tunnelIntf.type = RTK_TUNNEL_TYPE_CAPWAP_IP;
    }
    else if (0 == osal_strcmp(TOKEN_STR(4), "capwap-in-ip6"))
    {
        tunnelIntf.type = RTK_TUNNEL_TYPE_CAPWAP_IP6;
    }
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_tunnel_create_intf_type_ip_in_ip_ip6_in_ip_ipany_in_ip_ip_in_ip6_ip6_in_ip6_ipany_in_ip6_isatap_6to4_6rd_gre_ip_in_ip_gre_ip6_in_ip_gre_ipany_in_ip_gre_ip_in_ip6_gre_ip6_in_ip6_gre_ipany_in_ip6_vxlan_in_ip_vxlan_in_ip6_vxlan_gpe_in_ip_vxlan_gpe_in_ip6_capwap_in_ip_capwap_in_ip6 */
#endif
...
#ifdef CMD_TUNNEL_SET_INTF_INTF_ID_TYPE_IP_IN_IP_IP6_IN_IP_IPANY_IN_IP_IP_IN_IP6_IP6_IN_IP6_IPANY_IN_IP6_ISATAP_6TO4_6RD_GRE_IP_IN_IP_GRE_IP6_IN_IP_GRE_IPANY_IN_IP_GRE_IP_IN_IP6_GRE_IP6_IN_IP6_GRE_IPANY_IN_IP6_VXLAN_IN_IP_VXLAN_IN_IP6_VXLAN_GPE_IN_IP_VXLAN_GPE_IN_IP6_CAPWAP_IN_IP_CAPWAP_IN_IP6
/*
 * tunnel set intf <UINT:intf_id> type ( ip-in-ip | ip6-in-ip | ipany-in-ip | ip-in-ip6 | ip6-in-ip6 | ipany-in-ip6 | isatap | 6to4 | 6rd | gre-ip-in-ip | gre-ip6-in-ip | gre-ipany-in-ip | gre-ip-in-ip6 | gre-ip6-in-ip6 | gre-ipany-in-ip6 | vxlan-in-ip | vxlan-in-ip6 | vxlan-gpe-in-ip | vxlan-gpe-in-ip6 | capwap-in-ip | capwap-in-ip6 )
 */
cparser_result_t
cparser_cmd_tunnel_set_intf_intf_id_type_ip_in_ip_ip6_in_ip_ipany_in_ip_ip_in_ip6_ip6_in_ip6_ipany_in_ip6_isatap_6to4_6rd_gre_ip_in_ip_gre_ip6_in_ip_gre_ipany_in_ip_gre_ip_in_ip6_gre_ip6_in_ip6_gre_ipany_in_ip6_vxlan_in_ip_vxlan_in_ip6_vxlan_gpe_in_ip_vxlan_gpe_in_ip6_capwap_in_ip_capwap_in_ip6(
    cparser_context_t *context,
    uint32_t *intf_id_ptr)
{
    uint32  unit;
    ...
    else if (0 == osal_strcmp(TOKEN_STR(5), "capwap-in-ip"))
    {
        if (RTK_TUNNEL_TYPE_CAPWAP_IP != tunnelIntf.type)
        {
            tunnelIntf.type = RTK_TUNNEL_TYPE_CAPWAP_IP;
            osal_memset(&tunnelIntf.capwap_ip.ip.local, 0x00, sizeof(rtk_ip_addr_t));
            osal_memset(&tunnelIntf.capwap_ip.ip.remote, 0x00, sizeof(rtk_ip_addr_t));
            tunnelIntf.capwap_ip.l4.remote_port = 0;
            tunnelIntf.capwap_ip.l4.local_port = 0;
            tunnelIntf.capwap_ip.flags = 0;
        }
    }
    else if (0 == osal_strcmp(TOKEN_STR(5), "capwap-in-ip6"))
    {
        if (RTK_TUNNEL_TYPE_CAPWAP_IP6 != tunnelIntf.type)
        {
            tunnelIntf.type = RTK_TUNNEL_TYPE_CAPWAP_IP6;
            osal_memset(&tunnelIntf.capwap_ip6.ip6.local, 0x00, sizeof(rtk_ipv6_addr_t));
            osal_memset(&tunnelIntf.capwap_ip6.ip6.remote, 0x00, sizeof(rtk_ipv6_addr_t));
            tunnelIntf.capwap_ip6.l4.remote_port = 0;
            tunnelIntf.capwap_ip6.l4.local_port = 0;
            tunnelIntf.capwap_ip6.flags = 0;
        }
    }
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_tunnel_set_intf_intf_id_type_ip_in_ip_ip6_in_ip_ipany_in_ip_ip_in_ip6_ip6_in_ip6_ipany_in_ip6_isatap_6to4_6rd_gre_ip_in_ip_gre_ip6_in_ip_gre_ipany_in_ip_gre_ip_in_ip6_gre_ip6_in_ip6_gre_ipany_in_ip6_vxlan_in_ip_vxlan_in_ip6_vxlan_gpe_in_ip_vxlan_gpe_in_ip6_capwap_in_ip_capwap_in_ip6 */
#endif
...
#ifdef CMD_TUNNEL_GET_INTF_INTF_ID_ENCAP_CONFIG_L3_INTF
/*
 * tunnel get intf <UINT:intf_id> encap-config l3-intf
 */
cparser_result_t
cparser_cmd_tunnel_get_intf_intf_id_encap_config_l3_intf(
    cparser_context_t *context,
    uint32_t *intf_id_ptr)
{
    uint32  unit;
    int32   ret = RT_ERR_FAILED;
    rtk_tunnel_intfCtrlType_t ctrlType = RTK_TUNNEL_ICT_ENCAP_L3_INTF_ID;
    rtk_tunnel_intfCtrlParam_t ctrlParam;

    DIAG_UTIL_PARAM_CHK();
    DIAG_OM_GET_UNIT_ID(unit);
    DIAG_UTIL_OUTPUT_INIT();

    DIAG_UTIL_ERR_CHK(rtk_tunnel_intfCtrl_get(unit, *intf_id_ptr, ctrlType, &ctrlParam), ret);
    DIAG_UTIL_MPRINTF("Egress L3 interface : %u (0x%X)\n", ctrlParam.intf_id, ctrlParam.intf_id);

    return CPARSER_OK;
}   /* end of cparser_cmd_tunnel_get_intf_intf_id_encap_config_l3_intf */
#endif

#ifdef CMD_TUNNEL_SET_INTF_INTF_ID_ENCAP_CONFIG_L3_INTF_L3_INTF_ID
/*
 * tunnel set intf <UINT:intf_id> encap-config l3-intf <UINT:l3_intf_id>
 */
cparser_result_t
cparser_cmd_tunnel_set_intf_intf_id_encap_config_l3_intf_l3_intf_id(
    cparser_context_t *context,
    uint32_t *intf_id_ptr,
    uint32_t *l3_intf_id_ptr)
{
    uint32  unit;
    int32   ret = RT_ERR_FAILED;
    rtk_tunnel_intfCtrlType_t ctrlType = RTK_TUNNEL_ICT_ENCAP_L3_INTF_ID;
    ...
    ctrlParam.intf_id = *l3_intf_id_ptr;
    DIAG_UTIL_ERR_CHK(rtk_tunnel_intfCtrl_set(unit, *intf_id_ptr, ctrlType, ctrlParam), ret);
    DIAG_UTIL_MPRINTF("Egress L3 interface : %u (0x%X)\n", ctrlParam.intf_id, ctrlParam.intf_id);

    return CPARSER_OK;
}   /* end of cparser_cmd_tunnel_set_intf_intf_id_encap_config_l3_intf_l3_intf_id */
#endif

#ifdef CMD_TUNNEL_GET_INTF_INTF_ID_ENCAP_CONFIG_DMAC
/*
 * tunnel get intf <UINT:intf_id> encap-config dmac
 */
cparser_result_t
cparser_cmd_tunnel_get_intf_intf_id_encap_config_dmac(
    cparser_context_t *context,
    uint32_t *intf_id_ptr)
{
    uint32  unit;
    int32   ret = RT_ERR_FAILED;
    rtk_tunnel_intfCtrlType_t ctrlType = RTK_TUNNEL_ICT_ENCAP_DMAC;
    rtk_tunnel_intfCtrlParam_t ctrlParam;
    char    strMac[32];
    ...
    DIAG_UTIL_ERR_CHK(rtk_tunnel_intfCtrl_get(unit, *intf_id_ptr, ctrlType, &ctrlParam), ret);
    DIAG_UTIL_ERR_CHK(diag_util_mac2str(strMac, ctrlParam.mac.octet), ret);
    DIAG_UTIL_MPRINTF("Tunnel DMAC : %s\n", strMac);

    return CPARSER_OK;
}   /* end of cparser_cmd_tunnel_get_intf_intf_id_encap_config_dmac */
#endif

#ifdef CMD_TUNNEL_SET_INTF_INTF_ID_ENCAP_CONFIG_DMAC_MAC_ADDR
/*
 * tunnel set intf <UINT:intf_id> encap-config dmac <MACADDR:mac_addr>
 */
cparser_result_t
cparser_cmd_tunnel_set_intf_intf_id_encap_config_dmac_mac_addr(
    cparser_context_t *context,
    uint32_t *intf_id_ptr,
    cparser_macaddr_t *mac_addr_ptr)
{
    ...
    ctrlParam.mac = *(rtk_mac_t *)mac_addr_ptr;
    DIAG_UTIL_ERR_CHK(rtk_tunnel_intfCtrl_set(unit, *intf_id_ptr, ctrlType, ctrlParam), ret);
    DIAG_UTIL_ERR_CHK(diag_util_mac2str(strMac, ctrlParam.mac.octet), ret);
    DIAG_UTIL_MPRINTF("Tunnel DMAC : %s\n", strMac);

    return CPARSER_OK;
}   /* end of cparser_cmd_tunnel_set_intf_intf_id_encap_config_dmac_mac_addr */
#endif

#ifdef CMD_TUNNEL_GET_INTF_INTF_ID_ENCAP_CONFIG_SMAC
/*
 * tunnel get intf <UINT:intf_id> encap-config smac
 */
cparser_result_t
cparser_cmd_tunnel_get_intf_intf_id_encap_config_smac(
    cparser_context_t *context,
    uint32_t *intf_id_ptr)
{
    uint32  unit;
    int32   ret = RT_ERR_FAILED;
    rtk_tunnel_intfCtrlType_t ctrlType = RTK_TUNNEL_ICT_ENCAP_SMAC;
    rtk_tunnel_intfCtrlParam_t ctrlParam;
    char    strMac[32];
    ...
    DIAG_UTIL_ERR_CHK(rtk_tunnel_intfCtrl_get(unit, *intf_id_ptr, ctrlType, &ctrlParam), ret);
    DIAG_UTIL_ERR_CHK(diag_util_mac2str(strMac, ctrlParam.mac.octet), ret);
    DIAG_UTIL_MPRINTF("Tunnel SMAC : %s\n", strMac);

    return CPARSER_OK;
}   /* end of cparser_cmd_tunnel_get_intf_intf_id_encap_config_smac */
#endif

#ifdef CMD_TUNNEL_SET_INTF_INTF_ID_ENCAP_CONFIG_SMAC_MAC_ADDR
/*
 * tunnel set intf <UINT:intf_id> encap-config smac <MACADDR:mac_addr>
 */
cparser_result_t
cparser_cmd_tunnel_set_intf_intf_id_encap_config_smac_mac_addr(
    cparser_context_t *context,
    uint32_t *intf_id_ptr,
    cparser_macaddr_t *mac_addr_ptr)
{
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_tunnel_set_intf_intf_id_encap_config_smac_mac_addr */
#endif
    ...
    uint32_t *ip_ptr)
{
    ...
    else if (RTK_TUNNEL_TYPE_CAPWAP_IP == tunnelIntf.type)
    {
        tunnelIntf.capwap_ip.ip.local = *ip_ptr;
    }
    else
    {
    ...
    uint32_t *ip_ptr)
{
    ...
    {
        tunnelIntf.capwap_ip.ip.remote = *ip_ptr;
    }
    else
    {
        DIAG_UTIL_MPRINTF("Not support for %s tunnel\n", text_tunnel_type[tunnelIntf.type]);
    ...
    char **ip6_ptr)
{
    ...
    else if (RTK_TUNNEL_TYPE_CAPWAP_IP6 != tunnelIntf.type)
    {
        diag_util_str2ipv6(tunnelIntf.capwap_ip6.ip6.local.octet, *ip6_ptr);
    }
    else
    {
        DIAG_UTIL_MPRINTF("Not support for %s tunnel\n", text_tunnel_type[tunnelIntf.type]);
    ...
    char **ip6_ptr)
{
    ...
    {
        diag_util_str2ipv6(tunnelIntf.capwap_ip6.ip6.remote.octet, *ip6_ptr);
    }
    else
    {
        DIAG_UTIL_MPRINTF("Not support for %s tunnel\n", text_tunnel_type[tunnelIntf.type]);
    ...
    uint32_t *port_ptr)
{
    ...
    {
        tunnelIntf.capwap_ip.l4.local_port = *port_ptr;
    }
    else if (RTK_TUNNEL_TYPE_CAPWAP_IP6 != tunnelIntf.type)
    {
        tunnelIntf.capwap_ip6.l4.local_port = *port_ptr;
    }
    else
    {
        DIAG_UTIL_MPRINTF("Not support for %s tunnel\n", text_tunnel_type[tunnelIntf.type]);
    ...
    uint32_t *port_ptr)
{
    ...
    {
        tunnelIntf.capwap_ip.l4.remote_port = *port_ptr;
    }
    else if (RTK_TUNNEL_TYPE_CAPWAP_IP6 != tunnelIntf.type)
    {
        tunnelIntf.capwap_ip6.l4.remote_port = *port_ptr;
    }
    else
    {
        DIAG_UTIL_MPRINTF("Not support for %s tunnel\n", text_tunnel_type[tunnelIntf.type]);
    ...
    uint32_t *intf_id_ptr)
{
    ...
    int32   ret = RT_ERR_FAILED;
    rtk_tunnel_intf_t tunnelIntf;
    char strSIP[128], strDIP[128], strMac[32];
    ...
    DIAG_UTIL_MPRINTF("  Egress Intf : %u (0x%X)\n", tunnelIntf.encap.l3_intf_id, tunnelIntf.encap.l3_intf_id);
    DIAG_UTIL_ERR_CHK(diag_util_mac2str(strMac, tunnelIntf.encap.dmac.octet), ret);
    DIAG_UTIL_MPRINTF("  Tunnel DMAC : %s\n", strMac);
    DIAG_UTIL_ERR_CHK(diag_util_mac2str(strMac, tunnelIntf.encap.smac.octet), ret);
    DIAG_UTIL_MPRINTF("  Tunnel SMAC : %s\n", strMac);
    ...
    {
        DIAG_UTIL_ERR_CHK(diag_util_ip2str(strSIP, tunnelIntf.capwap_ip.ip.local), ret);
        DIAG_UTIL_ERR_CHK(diag_util_ip2str(strDIP, tunnelIntf.capwap_ip.ip.remote), ret);
        DIAG_UTIL_MPRINTF("     Local-IP : %s\n", strSIP);
        DIAG_UTIL_MPRINTF("    Remote-IP : %s\n", strDIP);
        DIAG_UTIL_MPRINTF("   Local-Port : %u (0x%04X)\n", \
            tunnelIntf.capwap_ip.l4.local_port, \
            tunnelIntf.capwap_ip.l4.local_port);
        DIAG_UTIL_MPRINTF("  Remote-Port : %u (0x%04X)\n", \
            tunnelIntf.capwap_ip.l4.remote_port, \
            tunnelIntf.capwap_ip.l4.remote_port);
    }
    else if (RTK_TUNNEL_TYPE_CAPWAP_IP6 != tunnelIntf.type)
    {
        DIAG_UTIL_ERR_CHK(diag_util_ipv62str(strSIP, tunnelIntf.capwap_ip6.ip6.local.octet), ret);
        DIAG_UTIL_ERR_CHK(diag_util_ipv62str(strDIP, tunnelIntf.capwap_ip6.ip6.remote.octet), ret);
        DIAG_UTIL_MPRINTF("     Local-IP : %s\n", strSIP);
        DIAG_UTIL_MPRINTF("    Remote-IP : %s\n", strDIP);
        DIAG_UTIL_MPRINTF("   Local-Port : %u (0x%04X)\n", \
            tunnelIntf.capwap_ip6.l4.local_port, \
            tunnelIntf.capwap_ip6.l4.local_port);
        DIAG_UTIL_MPRINTF("  Remote-Port : %u (0x%04X)\n", \
            tunnelIntf.capwap_ip6.l4.remote_port, \
            tunnelIntf.capwap_ip6.l4.remote_port);
    }
    ...
    uint32_t *intf_id_ptr)
{
    uint32  unit;
    int32   ret = RT_ERR_FAILED;
    rtk_tunnel_stat_t stat = RTK_TUNNEL_STAT_END;
    uint64 value64;
    ...
    if ('r' == TOKEN_CHAR(5, 0))
    {
        if ('b' == TOKEN_CHAR(5, 3))
        {
            stat = RTK_TUNNEL_STAT_INTF_IN_OCTETS;
        }
        else if ('p' == TOKEN_CHAR(5, 3))
        {
            stat = RTK_TUNNEL_STAT_INTF_IN_PKTS;
        }
        else if ('d' == TOKEN_CHAR(5, 3))
        {
            stat = RTK_TUNNEL_STAT_INTF_IN_DROPS;
        }
    } else if ('t' == TOKEN_CHAR(5, 0))
    {
        if ('b' == TOKEN_CHAR(5, 3))
        {
            stat = RTK_TUNNEL_STAT_INTF_OUT_OCTETS;
        }
        else if ('p' == TOKEN_CHAR(5, 3))
        {
            stat = RTK_TUNNEL_STAT_INTF_OUT_PKTS;
        }
        else if ('d' == TOKEN_CHAR(5, 3))
        {
            stat = RTK_TUNNEL_STAT_INTF_OUT_DROPS;
        }
    }

    DIAG_UTIL_ERR_CHK(rtk_tunnel_intfStat_get(unit, *intf_id_ptr, stat, &value64), ret);

    DIAG_UTIL_MPRINTF(" %s : %llu\n", text_tunnel_stat[stat], value64);
    ...
    cparser_context_t *context)
{
    ...
    DIAG_UTIL_FUNC_INIT(unit);
    DIAG_UTIL_PARSE_ACTION(5, action);
