...
#ifdef CMD_QOS_GET_DEFAULT_PRIORITY_OUTER_TAG_SRC_UNIT_UNIT_PORT_PORTS_ALL_SOURCE
/*
 * qos get default-priority outer-tag src-unit <UINT:unit> port ( <PORT_LIST:ports> | all ) source
 */
cparser_result_t cparser_cmd_qos_get_default_priority_outer_tag_src_unit_unit_port_ports_all_source(cparser_context_t *context,
    uint32_t *unit_ptr,
    char **ports_ptr)
{
    int32       ret;
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
       DIAG_UTIL_ERR_CHK(rtk_qos_portOuter1pDfltPriSrcSelExt_get(unit, *unit_ptr, port, &src),ret);
...
#ifdef CMD_QOS_GET_DEFAULT_PRIORITY_OUTER_TAG_SRC_UNIT_UNIT_PORT_PORTS_ALL_PRIORITY
/*
 * qos get default-priority outer-tag src-unit <UINT:unit> port ( <PORT_LIST:ports> | all ) priority
 */
cparser_result_t cparser_cmd_qos_get_default_priority_outer_tag_src_unit_unit_port_ports_all_priority(cparser_context_t *context,
    uint32_t *unit_ptr,
    char **ports_ptr)
{
    int32       ret;
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        DIAG_UTIL_ERR_CHK(rtk_qos_portOuter1pDfltPriExt_get(unit, *unit_ptr, port, &pri),ret);
        diag_util_mprintf("Port %2d : %d\n", port, pri);
    }
...
#ifdef CMD_QOS_GET_DEFAULT_PRIORITY_INNER_TAG_SRC_UNIT_UNIT_PORT_PORTS_ALL_PRIORITY
/*
 * qos get default-priority inner-tag src-unit <UINT:unit> port ( <PORT_LIST:ports> | all ) priority
 */
cparser_result_t cparser_cmd_qos_get_default_priority_inner_tag_src_unit_unit_port_ports_all_priority(cparser_context_t *context,
    uint32_t *unit_ptr,
    char **ports_ptr)
{
    int32       ret;
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        DIAG_UTIL_ERR_CHK(rtk_qos_port1pDfltPriExt_get(unit, *unit_ptr, port, &pri),ret);
        diag_util_mprintf("Port %2d : %d\n", port, pri);
    }
...
#ifdef CMD_QOS_SET_DEFAULT_PRIORITY_INNER_TAG_SRC_UNIT_UNIT_PORT_PORTS_ALL_PRIORITY_PRIORITY
/*
 * qos set default-priority inner-tag src-unit <UINT:unit> port ( <PORT_LIST:ports> | all ) priority <UINT:priority>
 */
cparser_result_t cparser_cmd_qos_set_default_priority_inner_tag_src_unit_unit_port_ports_all_priority_priority(cparser_context_t *context,
    uint32_t *unit_ptr,
    char **ports_ptr,
    uint32_t *priority_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        if ((ret = rtk_qos_port1pDfltPriExt_set(unit, *unit_ptr, port, *priority_ptr)) != RT_ERR_OK)
        {
            DIAG_ERR_PRINT(ret);
            return CPARSER_NOT_OK;
        }
...
#ifdef CMD_QOS_GET_DEFAULT_PRIORITY_INNER_TAG_SRC_UNIT_UNIT_PORT_PORTS_ALL_SOURCE
/*
 * qos get default-priority inner-tag src-unit <UINT:unit> port ( <PORT_LIST:ports> | all ) source
 */
cparser_result_t cparser_cmd_qos_get_default_priority_inner_tag_src_unit_unit_port_ports_all_source(cparser_context_t *context,
    uint32_t *unit_ptr,
    char **ports_ptr)
{
    int32       ret;
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        DIAG_UTIL_ERR_CHK(rtk_qos_port1pDfltPriSrcSelExt_get(unit, *unit_ptr, port, &src),ret);
...
#ifdef CMD_QOS_SET_DEFAULT_PRIORITY_INNER_TAG_SRC_UNIT_UNIT_PORT_PORTS_ALL_SOURCE_COPY_DEFAULT_INNER_PRIORITY
/*
 * qos set default-priority inner-tag src-unit <UINT:unit> port ( <PORT_LIST:ports> | all ) source copy-default-inner-priority
 */
cparser_result_t cparser_cmd_qos_set_default_priority_inner_tag_src_unit_unit_port_ports_all_source_copy_default_inner_priority(cparser_context_t *context,
    uint32_t *unit_ptr,
    char **ports_ptr)
{
    uint32      unit = 0;
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        if ((ret = rtk_qos_port1pDfltPriSrcSelExt_set(unit, *unit_ptr, port, type)) != RT_ERR_OK)
        {
            DIAG_ERR_PRINT(ret);
            return CPARSER_NOT_OK;
        }
...
#ifdef CMD_QOS_SET_DEFAULT_PRIORITY_INNER_TAG_SRC_UNIT_UNIT_PORT_PORTS_ALL_SOURCE_COPY_INTERNAL_PRIORITY
/*
 * qos set default-priority inner-tag src-unit <UINT:unit> port ( <PORT_LIST:ports> | all ) source copy-internal-priority
 */
cparser_result_t cparser_cmd_qos_set_default_priority_inner_tag_src_unit_unit_port_ports_all_source_copy_internal_priority(cparser_context_t *context,
    uint32_t *unit_ptr,
    char **ports_ptr)
{
    uint32      unit = 0;
...
#ifdef CMD_QOS_SET_DEFAULT_PRIORITY_OUTER_TAG_SRC_UNIT_UNIT_PORT_PORTS_ALL_SOURCE_COPY_INNER_PRIORITY
/*
 * qos set default-priority outer-tag src-unit <UINT:unit> port ( <PORT_LIST:ports> | all ) source copy-inner-priority
 */
cparser_result_t cparser_cmd_qos_set_default_priority_outer_tag_src_unit_unit_port_ports_all_source_copy_inner_priority(cparser_context_t *context,
    uint32_t *unit_ptr,
    char **ports_ptr)
{
    uint32      unit = 0;
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        if ((ret = rtk_qos_portOuter1pDfltPriSrcSelExt_set(unit, *unit_ptr, port, type)) != RT_ERR_OK)
        {
            DIAG_ERR_PRINT(ret);
            return CPARSER_NOT_OK;
        }
...
#ifdef CMD_QOS_SET_DEFAULT_PRIORITY_OUTER_TAG_SRC_UNIT_UNIT_PORT_PORTS_ALL_SOURCE_COPY_INTERNAL_PRIORITY
/*
 * qos set default-priority outer-tag src-unit <UINT:unit> port ( <PORT_LIST:ports> | all ) source copy-internal-priority
 */
cparser_result_t cparser_cmd_qos_set_default_priority_outer_tag_src_unit_unit_port_ports_all_source_copy_internal_priority(cparser_context_t *context,
    uint32_t *unit_ptr,
    char **ports_ptr)
{
    uint32      unit = 0;
...
#ifdef CMD_QOS_SET_DEFAULT_PRIORITY_OUTER_TAG_SRC_UNIT_UNIT_PORT_PORTS_ALL_SOURCE_COPY_DEFAULT_OUTER_PRIORITY
/*
 * qos set default-priority outer-tag src-unit <UINT:unit> port ( <PORT_LIST:ports> | all ) source copy-default-outer-priority
 */
cparser_result_t cparser_cmd_qos_set_default_priority_outer_tag_src_unit_unit_port_ports_all_source_copy_default_outer_priority(cparser_context_t *context,
    uint32_t *unit_ptr,
    char **ports_ptr)
{
    uint32      unit = 0;
...
#ifdef CMD_QOS_SET_DEFAULT_PRIORITY_OUTER_TAG_SRC_UNIT_UNIT_PORT_PORTS_ALL_PRIORITY_PRIORITY
/*
 * qos set default-priority outer-tag src-unit <UINT:unit> port ( <PORT_LIST:ports> | all ) priority <UINT:priority>
 */
cparser_result_t cparser_cmd_qos_set_default_priority_outer_tag_src_unit_unit_port_ports_all_priority_priority(cparser_context_t *context,
    uint32_t *unit_ptr,
    char **ports_ptr,
    uint32_t *priority_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        if ((ret = rtk_qos_portOuter1pDfltPriExt_set(unit, *unit_ptr, port, *priority_ptr)) != RT_ERR_OK)
        {
            DIAG_ERR_PRINT(ret);
            return CPARSER_NOT_OK;
        }
    ...
    uint32_t *weight_ptr)
{
    ...
    if (DIAG_OM_GET_FAMILYID(RTL9310_FAMILY_ID) || DIAG_OM_GET_FAMILYID(RTL9300_FAMILY_ID))
    {
        ...
        DIAG_UTIL_PORTMASK_SCAN(portlist, port)
        {
            ...
            if(*qid_ptr >= qid_max)
            {
                diag_util_mprintf("Port %d Queue id must < %d\n", port, qid_max);
                return CPARSER_NOT_OK;
            }
        }
    }
...
#ifdef CMD_QOS_GET_SCHEDULING_INGRESS_STRICT_PRIORITY_PORT_PORTS_ALL_QUEUE_ID_QID_STATE
/*
*qos get scheduling ingress strict-priority port ( <PORT_LIST:ports> | all ) queue-id <UINT:qid> state
*/
cparser_result_t cparser_cmd_qos_get_scheduling_ingress_strict_priority_port_ports_all_queue_id_qid_state(cparser_context_t *context,
    char **ports_ptr,
    uint32_t *qid_ptr)
{
    int32       ret;
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        diag_util_mprintf("Ingress Strict-priority Ability\n");

        DIAG_UTIL_ERR_CHK(rtk_qos_portIgrQueueStrictEnable_get(unit, port, *qid_ptr, &enable), ret);
...
/*
 * qos set scheduling ingress strict-priority port ( <PORT_LIST:ports> | all ) queue-id <UINT:qid> state ( disable | enable )
 */
cparser_result_t cparser_cmd_qos_set_scheduling_ingress_strict_priority_port_ports_all_queue_id_qid_state_disable_enable(cparser_context_t *context,
    char **ports_ptr,
    uint32_t *qid_ptr)
{
    uint32      unit = 0;
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        ...
        if ((ret = rtk_qos_portIgrQueueStrictEnable_set(unit, port, *qid_ptr, enable)) != RT_ERR_OK)
        {
            DIAG_ERR_PRINT(ret);
            return CPARSER_NOT_OK;
        }
