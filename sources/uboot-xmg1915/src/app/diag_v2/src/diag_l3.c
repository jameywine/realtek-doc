 ...
 *
 * $Revision: 80809 $
 * $Date: 2017-07-25 17:32:53 +0800 (Tue, 25 Jul 2017) $
 *
...
#define DUMP_INTF_LH()  \
do{                     \
    DIAG_UTIL_MPRINTF(" Intf ID | VRF ID |  VLAN  |       MAC        | MTU  | TTL   \n");           \
    DIAG_UTIL_MPRINTF("---------+--------+--------+------------------+------+----\n");           \
}while(0);
...
do{                                                                                                     \
    ...
    diag_util_mac2str(__ms, __intf.mac_addr.octet);                                \
        DIAG_UTIL_MPRINTF("  %4d   |  %4d  | %4d   |%s | %4d | %d  \n",          \
            __intf.intf_id,__intf.vrf_id,__intf.vid,__ms,__intf.mtu,__intf.ttl);   \
}while(0);

//line header
#define DUMP_NH_LH()  \
do{                     \
    DIAG_UTIL_MPRINTF(" NextHop ID | Intf ID |       MAC           \n");           \
    DIAG_UTIL_MPRINTF("------------+---------+--------------------\n");           \
}while(0);
...
do{                                                                                                     \
    ...
    diag_util_mac2str(__ms, __nh.mac_addr.octet);                                \
        DIAG_UTIL_MPRINTF("  %4d      |  %4d   | %s   \n",          \
            __id,__nh.intf_id,__ms);                                            \
}while(0);
    ...
    uint32_t *vrf_id_ptr)
{
    ...
    DIAG_UTIL_MPRINTF("set interface %u vrf_id %u\n", intf.intf_id, intf.vrf_id);
    ...
    uint32_t *mtu_ptr)
{
    ...
    DIAG_UTIL_FUNC_INIT(unit);
    osal_memset(&intf, 0, sizeof(intf));
    intf.intf_id = *intf_id_ptr;
    DIAG_UTIL_ERR_CHK(rtk_l3_intf_get(unit, RTK_L3_INTFKEYTYPE_INTF_ID, &intf), ret);
    intf.mtu = *mtu_ptr;

    DIAG_UTIL_MPRINTF("set interface %u mtu %u\n", intf.intf_id, intf.mtu);
    DIAG_UTIL_ERR_CHK(rtk_l3_intf_set(unit, RTK_L3_INTFKEYTYPE_INTF_ID, &intf), ret);
    ...
    uint32_t *ttl_ptr)
{
    ...
    DIAG_UTIL_MPRINTF("set interface %u ttl %u\n", intf.intf_id, intf.ttl);
    DIAG_UTIL_ERR_CHK(rtk_l3_intf_set(unit, RTK_L3_INTFKEYTYPE_INTF_ID, &intf), ret);
    ...
    uint32_t *vrf_id_ptr)
{
    ...
    DIAG_UTIL_MPRINTF("set interface vid %u vrf_id %u\n", intf.vid, intf.vrf_id);
    ...
    uint32_t *ttl_ptr)
{
    ...
    DIAG_UTIL_MPRINTF("set interface vid %u ttl %u\n", intf.vid, intf.ttl);
    DIAG_UTIL_ERR_CHK(rtk_l3_intf_set(unit, RTK_L3_INTFKEYTYPE_VID, &intf), ret);
...
#ifdef CMD_L3_GET_INTF_INTF_ID_STATS_IN_OCTETS_IN_UCAST_PKTS_IN_MULTICAST_PKTS_IN_BROADCAST_PKTS_IN_UNKNOWN_PROTOS_IN_DISCARDS_OUT_OCTETS_OUT_UCAST_PKTS_OUT_MULTICAST_PKTS_OUT_BROADCAST_PKTS_OUT_DISCARDS
/*
 * l3 get intf <UINT:intf_id> stats ( in-octets | in-ucast-pkts | in-multicast-pkts | in-broadcast-pkts | in-unknown-protos | in-discards | out-octets | out-ucast-pkts | out-multicast-pkts | out-broadcast-pkts | out-discards )
 */
cparser_result_t
cparser_cmd_l3_get_intf_intf_id_stats_in_octets_in_ucast_pkts_in_multicast_pkts_in_broadcast_pkts_in_unknown_protos_in_discards_out_octets_out_ucast_pkts_out_multicast_pkts_out_broadcast_pkts_out_discards(
    cparser_context_t *context,
    uint32_t *intf_id_ptr)
{
    uint64 val = 0;
    uint32 unit;
    int32 ret = RT_ERR_FAILED;
    rtk_l3_stat_t stat = 0;

    if ('i' == TOKEN_CHAR(5, 0))
    {
        if ('o' == TOKEN_CHAR(5, 3))
        {
            stat = RTK_L3_STAT_INTF_IN_OCTETS;
        }
        else if ('u' == TOKEN_CHAR(5, 3))
        {
            if ('c' == TOKEN_CHAR(5, 4))
                stat = RTK_L3_STAT_INTF_IN_UCAST_PKTS;
            else if ('n' == TOKEN_CHAR(5, 4))
                stat = RTK_L3_STAT_INTF_IN_UNKNOWN_PROTOS;
        }
        else if ('m' == TOKEN_CHAR(5, 3))
        {
            stat = RTK_L3_STAT_INTF_IN_MULTICAST_PKTS;
        }
        else if ('b' == TOKEN_CHAR(5, 3))
        {
            stat = RTK_L3_STAT_INTF_IN_BROADCAST_PKTS;
        }
        else if ('d' == TOKEN_CHAR(5, 3))
        {
            stat = RTK_L3_STAT_INTF_IN_DISCARDS;
        }
    }
    else if ('o' == TOKEN_CHAR(5, 0))
    {
        if ('o' == TOKEN_CHAR(5, 4))
        {
            stat = RTK_L3_STAT_INTF_OUT_OCTETS;
        }
        else if ('u' == TOKEN_CHAR(5, 4))
        {
            stat = RTK_L3_STAT_INTF_OUT_UCAST_PKTS;
        }
        else if ('m' == TOKEN_CHAR(5, 4))
        {
            stat = RTK_L3_STAT_INTF_OUT_MULTICAST_PKTS;
        }
        else if ('b' == TOKEN_CHAR(5, 4))
        {
            stat = RTK_L3_STAT_INTF_OUT_BROADCAST_PKTS;
        }
        else if ('d' == TOKEN_CHAR(5, 4))
        {
            stat = RTK_L3_STAT_INTF_OUT_DISCARDS;
        }
    }

    DIAG_UTIL_FUNC_INIT(unit);
    DIAG_UTIL_ERR_CHK(rtk_l3_intfStat_get(unit, *intf_id_ptr, stat, &val), ret);
    DIAG_UTIL_MPRINTF("Interface counter %s: %llu \n", TOKEN_STR(5), val);

    return CPARSER_OK;
}   /* end of cparser_cmd_l3_get_intf_intf_id_stats_in_octets_in_ucast_pkts_in_multicast_pkts_in_broadcast_pkts_in_unknown_protos_in_discards_out_octets_out_ucast_pkts_out_ucast_pkts_out_multicast_pkts_out_broadcast_pkts_out_discards */
#endif
    ...
    uint32_t *end_index_ptr)
{
    ...
    if ('e' == TOKEN_CHAR(6, 0))
    {
        end = devInfo.capacityInfo.max_num_of_l3_nexthop - 1;
    }
    else
    {
        /* including the start number */
        end = ((*end_index_ptr) > 0)? \
               ((*end_index_ptr) - 1) : (devInfo.capacityInfo.max_num_of_l3_nexthop  - 1);
        end = (end > devInfo.capacityInfo.max_num_of_l3_nexthop  - 1) ? (devInfo.capacityInfo.max_num_of_l3_nexthop  - 1): end;
    }
    ...
    uint32_t *nh_id_8_ptr)
{
    ...
    DIAG_UTIL_MPRINTF("create ecmp id: %u with nd id %u %u %u %u %u %u %u %u \n", ecmpId,
        nhIds[0], nhIds[1], nhIds[2], nhIds[3], nhIds[4], nhIds[5], nhIds[6], nhIds[7]);
    ...
    uint32_t *ecmp_id_ptr)
{
    ...
    DIAG_UTIL_FUNC_INIT(unit);
    DIAG_UTIL_MPRINTF("destroy ecmpid %u nh-id %u\n", *ecmp_id_ptr);
    ...
    uint32_t *nh_id_8_ptr)
{
    ...
    DIAG_UTIL_MPRINTF("set ecmp id: %u with nd id %u %u %u %u %u %u %u %u \n", *ecmp_id_ptr,
        nhIds[0], nhIds[1], nhIds[2], nhIds[3], nhIds[4], nhIds[5], nhIds[6], nhIds[7]);
...
#ifdef CMD_L3_SET_ECMP_ECMP_ID_ECMP_ID_HASH_TABLE_HASH_VALUE_HASH_VALUE_NH_IDX_NH_IDX
/*
 * l3 set ecmp ecmp-id <UINT:ecmp_id> hash table hash-value <UINT:hash_value> nh-idx <UINT:nh_idx>
 */
cparser_result_t
cparser_cmd_l3_set_ecmp_ecmp_id_ecmp_id_hash_table_hash_value_hash_value_nh_idx_nh_idx(
    cparser_context_t *context,
    uint32_t *ecmp_id_ptr,
    ...
    uint32_t *nh_idx_ptr)
{
    ...
    idxCount = devInfo.capacityInfo.max_num_of_l3_ecmp_hash_idx;
    if ((*hash_value_ptr) >= idxCount)
    {
        DIAG_UTIL_MPRINTF("the maximum hash value is %d.", (idxCount > 0)? (idxCount - 1) : 0);
        return CPARSER_NOT_OK;
    }

    /* allocate memory */
    pNhIdx = osal_alloc(idxCount * sizeof(uint32));

    /* read */
    if (RT_ERR_OK != rtk_l3_ecmpHashTbl_get(unit, *ecmp_id_ptr, idxCount, pNhIdx))
    {
        ret = CPARSER_NOT_OK;
        goto errHandle;
    }
    ...
    /* update */
    *(pNhIdx + (*hash_value_ptr)) = *nh_idx_ptr;

    /* write back */
    if (RT_ERR_OK != rtk_l3_ecmpHashTbl_set(unit, *ecmp_id_ptr, idxCount, pNhIdx))
    {
        ret = CPARSER_NOT_OK;
        goto errHandle;
    }
...
errHandle:
    ...
    return ret;
}   /* end of cparser_cmd_l3_set_ecmp_ecmp_id_ecmp_id_hash_table_hash_value_hash_value_nh_idx_nh_idx */
#endif

#ifdef CMD_L3_GET_ECMP_ECMP_ID_ECMP_ID_HASH_TABLE
/*
 * l3 get ecmp ecmp-id <UINT:ecmp_id> hash table
 */
cparser_result_t
cparser_cmd_l3_get_ecmp_ecmp_id_ecmp_id_hash_table(
    cparser_context_t *context,
    uint32_t *ecmp_id_ptr)
{
    uint32  unit;
    ...
    /* display */
    DIAG_UTIL_MPRINTF("ECMP path ID : %u\n", *ecmp_id_ptr);
    for (idx=0; idx<idxCount; idx++)
    {
        DIAG_UTIL_MPRINTF("Hash [%2u] : Index [%u]\n", idx, *(pNhIdx + idx));
    }
...
errHandle:
    ...
    return ret;
}   /* end of cparser_cmd_l3_get_ecmp_ecmp_id_ecmp_id_hash_table */
#endif

#ifdef CMD_L3_SET_ECMP_ECMP_ID_ECMP_ID_HASH_METER_STATE_ENABLE_DISABLE
/*
 * l3 set ecmp ecmp-id <UINT:ecmp_id> hash meter state ( enable | disable )
 */
cparser_result_t
cparser_cmd_l3_set_ecmp_ecmp_id_ecmp_id_hash_meter_state_enable_disable(
    cparser_context_t *context,
    uint32_t *ecmp_id_ptr)
{
    uint32  unit;
    ...
    enable = ('e' == TOKEN_CHAR(8, 0))? ENABLED : DISABLED;

    DIAG_UTIL_FUNC_INIT(unit);
    DIAG_UTIL_ERR_CHK(rtk_l3_ecmpCtrl_set(unit, *ecmp_id_ptr, RTK_L3_ECT_HASH_METER_EN, enable), ret);

    return CPARSER_OK;
}   /* end of cparser_cmd_l3_set_ecmp_ecmp_id_ecmp_id_hash_meter_state_enable_disable */
#endif

#ifdef CMD_L3_SET_ECMP_ECMP_ID_ECMP_ID_HASH_METER_INDEX_METER_INDEX
/*
 * l3 set ecmp ecmp-id <UINT:ecmp_id> hash meter index <UINT:meter_index>
 */
cparser_result_t
cparser_cmd_l3_set_ecmp_ecmp_id_ecmp_id_hash_meter_index_meter_index(
    cparser_context_t *context,
    uint32_t *ecmp_id_ptr,
    uint32_t *meter_index_ptr)
{
    uint32  unit;
    int32   ret = RT_ERR_FAILED;
    uint32  index = *meter_index_ptr;

    DIAG_UTIL_FUNC_INIT(unit);
    DIAG_UTIL_ERR_CHK(rtk_l3_ecmpCtrl_set(unit, *ecmp_id_ptr, RTK_L3_ECT_HASH_METER_IDX, index), ret);

    return CPARSER_OK;
}   /* end of cparser_cmd_l3_set_ecmp_ecmp_id_ecmp_id_hash_meter_index_meter_index */
#endif

#ifdef CMD_L3_GET_ECMP_ECMP_ID_ECMP_ID_HASH_METER
/*
 * l3 get ecmp ecmp-id <UINT:ecmp_id> hash meter
 */
cparser_result_t
cparser_cmd_l3_get_ecmp_ecmp_id_ecmp_id_hash_meter(
    cparser_context_t *context,
    uint32_t *ecmp_id_ptr)
{
    uint32  unit;
    ...
    DIAG_UTIL_FUNC_INIT(unit);
    DIAG_UTIL_ERR_CHK(rtk_l3_ecmpCtrl_get(unit, *ecmp_id_ptr, RTK_L3_ECT_HASH_METER_EN, &enable), ret);
    DIAG_UTIL_ERR_CHK(rtk_l3_ecmpCtrl_get(unit, *ecmp_id_ptr, RTK_L3_ECT_HASH_METER_IDX, &index), ret);

    DIAG_UTIL_MPRINTF("ECMP path ID : %u\n", *ecmp_id_ptr);
    DIAG_UTIL_MPRINTF(" meter state : %s\n", text_state[(rtk_enable_t)enable]);
    DIAG_UTIL_MPRINTF(" meter index : %d\n", index);

    return CPARSER_OK;
}   /* end of cparser_cmd_l3_get_ecmp_ecmp_id_ecmp_id_hash_meter */
#endif
    ...
    char **ip6_addr_ptr)
{
    ...
    host.vrf_id = *vrf_id_ptr;
    host.flags |= RTK_L3_FLAG_IPV6;
    host.flags |= (8 == TOKEN_NUM) ? RTK_L3_FLAG_HIT : RTK_L3_FLAG_NONE;
    ...
    uint32_t *prefix_length_ptr)
{
    ...
    route.vrf_id = *vrf_id_ptr;
    route.prefix_len = *prefix_length_ptr;
    route.flags |= (10 == TOKEN_NUM) ? RTK_L3_FLAG_HIT : RTK_L3_FLAG_NONE;
    ...
    uint32_t *suffix_length_ptr)
{
    ...
    route.prefix_len = *prefix_length_ptr;
    route.suffix_len = *suffix_length_ptr;
    route.flags |= (12 == TOKEN_NUM) ? RTK_L3_FLAG_HIT : RTK_L3_FLAG_NONE;
