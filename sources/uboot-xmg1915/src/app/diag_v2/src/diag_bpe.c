    ...
    uint32_t *tpid_ptr)
{
    ...
    DIAG_UTIL_MPRINTF("set tpid: 0x%x\n", *tpid_ptr);
    ...
    cparser_context_t *context)
{
    ...
    DIAG_UTIL_MPRINTF("set CPU keep state as %s\n", text_state[state]);
    ...
    cparser_context_t *context)
{
    ...
    DIAG_UTIL_MPRINTF("set PE lookup miss filter  as %s\n", text_state[state]);
    ...
    char **ports_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portmask, port)
    {
        DIAG_UTIL_MPRINTF("port %u: E-TAG parse state: %s\n", port, text_state[state]);
    ...
    char **ports_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portmask, port)
    {
        DIAG_UTIL_MPRINTF("port %u: forward mode: %s\n", port, text_bpe_fwdMode[mode]);
    ...
    uint32_t *nsg_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portmask, port)
    {
        ...
        DIAG_UTIL_MPRINTF("set port %u NSG: 0x%x\n", port, *nsg_ptr);
    }
    ...
    uint32_t *pcid_ext_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portmask, port)
    {
        ...
        DIAG_UTIL_MPRINTF("set port %u: extension 0x%x\n", port, *pcid_ext_ptr);
    }
    return CPARSER_OK;
    ...
    uint32_t *pcid_base_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portmask, port)
    {
        ...
        DIAG_UTIL_MPRINTF("set port %u: base 0x%x\n", port, *pcid_base_ptr);
    }
    return CPARSER_OK;
    ...
    char **ports_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portmask, port)
    {
        DIAG_UTIL_MPRINTF("port %u: %s state: %s\n", port, TOKEN_STR(6), text_state[state]);
        DIAG_UTIL_ERR_CHK(rtk_bpe_portCtrl_set(unit, port, type, state), ret);
    }
    ...
    char **ports_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portmask, port)
    {
        DIAG_UTIL_MPRINTF("port %u: %s action: %s\n", port, TOKEN_STR(6), text_action[action]);
    ...
    char **ports_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portmask, port)
    {
        DIAG_UTIL_MPRINTF("port %u: %s state: %s\n", port, TOKEN_STR(5), text_state[state]);
        DIAG_UTIL_ERR_CHK(rtk_bpe_portCtrl_set(unit, port, type, state), ret);
    }
    ...
    char **ports_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portmask, port)
    {
        DIAG_UTIL_MPRINTF("port %u: %s state: %s\n", port, TOKEN_STR(6), text_bpe_tagSts[status]);
    ...
    char **ports_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portmask, port)
    {
        DIAG_UTIL_MPRINTF("port %u: %s state: %s\n", port, TOKEN_STR(6), text_bpe_vlanTagSts[status]);
    ...
    uint32_t *remark_pe_priority_ptr)
{
    ...
    DIAG_UTIL_MPRINTF("\tremark as PE priority: %u\n", *remark_pe_priority_ptr);
