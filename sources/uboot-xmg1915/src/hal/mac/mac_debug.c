 ...
 *
 * $Revision: 81134 $
 * $Date: 2017-08-09 11:13:21 +0800 (Wed, 09 Aug 2017) $
 *
...
int32 _rtk_getHsb(uint32 unit, hsb_param_t * hsb)
{
    ...
    if (HWP_9300_FAMILY_ID(unit))
    {
        ...
        hsb->r9300.ctag_unit = (hsb->r9300.fs3_data >>8) & 0xf;
...
int32 hal_dumpHsb(uint32 unit)
{
    ...
    if (HWP_9300_FAMILY_ID(unit))
    {
        ...
        osal_printf("%-14s = 0x%-10x", "ver", hsb.r9300.sthdr_comm_ver);
        osal_printf("%-14s = 0x%-10x", "info_hdr_type", hsb.r9300.sthdr_comm_info_hdr_type);
        osal_printf("%-14s = 0x%-10x\n", "sp_info", hsb.r9300.sthdr_comm_sp_info);

        osal_printf("%-14s = 0x%-10x", "sp_filter", hsb.r9300.sthdr_comm_sp_filter);
        osal_printf("%-14s = 0x%-10x", "dp_fmt", hsb.r9300.sthdr_comm_dp_fmt);
        osal_printf("%-14s = 0x%-10x\n", "dp_info", hsb.r9300.sthdr_comm_dp_info);

        osal_printf("%-14s = 0x%-10x", "fwd_type", hsb.r9300.sthdr_comm_fwd_type);
        osal_printf("%-14s = 0x%-10x", "sa_lrn", hsb.r9300.sthdr_comm_sa_lrn);
        osal_printf("%-14s = 0x%-10x\n", "sthdr_comm_vlan_tag", hsb.r9300.sthdr_comm_vlan_tag);

        osal_printf("********************Info header********************\n");
        osal_printf("%-14s = 0x%-10x", "cpu_tag_if", hsb.r9300.sthdr_info_cpu_tag_if);
        osal_printf("%-14s = 0x%-10x", "int_pri", hsb.r9300.sthdr_info_int_pri);
        osal_printf("%-14s = 0x%-10x\n", "trk_hash", hsb.r9300.sthdr_info_trk_hash);

        osal_printf("%-14s = 0x%-10x", "class", hsb.r9300.sthdr_info_class);
        osal_printf("%-14s = 0x%-10x", "da_hit", hsb.r9300.sthdr_info_da_hit);
        osal_printf("%-14s = 0x%-10x\n", "vb_iso_mbr", hsb.r9300.sthdr_info_vb_iso_mbr);

        osal_printf("%-14s = 0x%-10x", "int_otag_hit", hsb.r9300.sthdr_info_int_otag_hit);
        osal_printf("%-14s = 0x%-10x", "int_otag_if", hsb.r9300.sthdr_info_int_otag_if);
        osal_printf("%-14s = 0x%-10x\n", "int_otag_tpid_hit", hsb.r9300.sthdr_info_int_otag_tpid_hit);

        osal_printf("%-14s = 0x%-10x", "int_otag_tpid_idx", hsb.r9300.sthdr_info_int_otag_tpid_idx);
        osal_printf("%-14s = 0x%-10x", "int_otag_pri_hit", hsb.r9300.sthdr_info_int_otag_pri_hit);
        osal_printf("%-14s = 0x%-10x\n", "int_otag_pri", hsb.r9300.sthdr_info_int_otag_pri);

        osal_printf("%-14s = 0x%-10x", "int_ocfi", hsb.r9300.sthdr_info_int_ocfi);
        osal_printf("%-14s = 0x%-10x", "int_ovid", hsb.r9300.sthdr_info_int_ovid);
        osal_printf("%-14s = 0x%-10x\n", "int_itag_hit", hsb.r9300.sthdr_info_int_itag_hit);

        osal_printf("%-14s = 0x%-10x", "int_itag_if", hsb.r9300.sthdr_info_int_itag_if);
        osal_printf("%-14s = 0x%-10x", "int_itag_tpid_hit", hsb.r9300.sthdr_info_int_itag_tpid_hit);
        osal_printf("%-14s = 0x%-10x\n", "int_itag_tpid_idx", hsb.r9300.sthdr_info_int_itag_tpid_idx);

        osal_printf("%-14s = 0x%-10x", "int_itag_pri_hit", hsb.r9300.sthdr_info_int_itag_pri_hit);
        osal_printf("%-14s = 0x%-10x", "int_itag_pri", hsb.r9300.sthdr_info_int_itag_pri);
        osal_printf("%-14s = 0x%-10x\n", "int_icfi", hsb.r9300.sthdr_info_int_icfi);

        osal_printf("%-14s = 0x%-10x", "int_ivid", hsb.r9300.sthdr_info_int_ivid);
        osal_printf("%-14s = 0x%-10x", "fwd_base", hsb.r9300.sthdr_info_fwd_base);
        osal_printf("%-14s = 0x%-10x\n", "dp", hsb.r9300.sthdr_info_dp);

        osal_printf("%-14s = 0x%-10x", "int_dscp_hit", hsb.r9300.sthdr_info_int_dscp_hit);
        osal_printf("%-14s = 0x%-10x", "mir_id", hsb.r9300.sthdr_info_mir_id);
        osal_printf("%-14s = 0x%-10x\n", "rout_tunnel_if", hsb.r9300.sthdr_info_rout_tunnel_if);

        osal_printf("%-14s = 0x%-10x", "igr_l3_intf_type", hsb.r9300.sthdr_info_igr_l3_intf_type);
        osal_printf("%-14s = 0x%-10x\n", "igr_l3_intf_id", hsb.r9300.sthdr_info_igr_l3_intf_id);

        osal_printf("********************Vlan header Valid= %d********************\n", hsb.r9300.sthdr_comm_vlan_tag);
        osal_printf("%-14s = 0x%-10x", "ori_opri", hsb.r9300.sthdr_vlan_ori_opri);
        osal_printf("%-14s = 0x%-10x\n", "ori_ocfi", hsb.r9300.sthdr_vlan_ori_ocfi);

        osal_printf("%-14s = 0x%-10x", "ori_ipri", hsb.r9300.sthdr_vlan_ori_ipri);
        osal_printf("%-14s = 0x%-10x\n", "ori_icfi", hsb.r9300.sthdr_vlan_ori_icfi);

        osal_printf("********************Stack Tx CTag Valid= %d********************\n", (hsb.r9300.sthdr_info_cpu_tag_if==2 ? 1:0));
        osal_printf("%-14s = 0x%-10x", "fwd_type", hsb.r9300.sthdr_txCtag_fwd_type);
        osal_printf("%-14s = 0x%-10x", "acl_act", hsb.r9300.sthdr_txCtag_acl_act);
        osal_printf("%-14s = 0x%-10x\n", "cngst_drop", hsb.r9300.sthdr_txCtag_cngst_drop);

        osal_printf("%-14s = 0x%-10x", "dm_pkt", hsb.r9300.sthdr_txCtag_dm_pkt);
        osal_printf("%-14s = 0x%-10x", "dg_pkt", hsb.r9300.sthdr_txCtag_dg_pkt);
        osal_printf("%-14s = 0x%-10x\n", "bp_filter", hsb.r9300.sthdr_txCtag_bp_filter);

        osal_printf("%-14s = 0x%-10x", "bp_stp", hsb.r9300.sthdr_txCtag_bp_stp);
        osal_printf("%-14s = 0x%-10x", "bp_vlan_egr", hsb.r9300.sthdr_txCtag_bp_vlan_egr);
        osal_printf("%-14s = 0x%-10x\n", "ale_as_tagsts", hsb.r9300.sthdr_txCtag_ale_as_tagsts);

        osal_printf("%-14s = 0x%-10x", "l3_act", hsb.r9300.sthdr_txCtag_l3_act);
        osal_printf("%-14s = 0x%-10x", "as_qid", hsb.r9300.sthdr_txCtag_as_qid);
        osal_printf("%-14s = 0x%-10x\n", "qid", hsb.r9300.sthdr_txCtag_qid);

        osal_printf("%-14s = 0x%-10x", "src_filter_en", hsb.r9300.sthdr_txCtag_src_filter_en);
        osal_printf("%-14s = 0x%-10x", "sp_is_trk", hsb.r9300.sthdr_txCtag_sp_is_trk);
        osal_printf("%-14s = 0x%-10x\n", "spn", hsb.r9300.sthdr_txCtag_spn);

        osal_printf("%-14s = 0x%-10x", "sw_unit", hsb.r9300.sthdr_txCtag_sw_unit);
        osal_printf("%-14s = 0x%-10x", "dpm[1]", hsb.r9300.sthdr_txCtag_dpm.bits[1]);
        osal_printf("%-14s = 0x%-10x\n", "dpm[0]", hsb.r9300.sthdr_txCtag_dpm.bits[0]);

        osal_printf("********************Stack Rx CTag Valid= %d********************\n", (hsb.r9300.sthdr_info_cpu_tag_if==1 ? 1:0));
        osal_printf("%-14s = 0x%-10x", "of_lu_mis_tbl_id", hsb.r9300.sthdr_rxCtag_of_lu_mis_tbl_id);
        osal_printf("%-14s = 0x%-10x", "acl_of_hit", hsb.r9300.sthdr_rxCtag_acl_of_hit);
        osal_printf("%-14s = 0x%-10x\n", "of_tbl_id", hsb.r9300.sthdr_rxCtag_of_tbl_id);

        osal_printf("%-14s = 0x%-10x", "l2_err_pkt", hsb.r9300.sthdr_rxCtag_l2_err_pkt);
        osal_printf("%-14s = 0x%-10x", "l3_err_pkt", hsb.r9300.sthdr_rxCtag_l3_err_pkt);
        osal_printf("%-14s = 0x%-10x\n", "atk_type", hsb.r9300.sthdr_rxCtag_atk_type);

        osal_printf("%-14s = 0x%-10x", "qid", hsb.r9300.sthdr_rxCtag_qid);
        osal_printf("%-14s = 0x%-10x", "sthdr_rxCtag_idx", hsb.r9300.sthdr_rxCtag_idx);
        osal_printf("%-14s = 0x%-10x\n", "sflow", hsb.r9300.sthdr_rxCtag_sflow);

        osal_printf("%-14s = 0x%-10x", "tt_hit", hsb.r9300.sthdr_rxCtag_tt_hit);
        osal_printf("%-14s = 0x%-10x", "sthdr_rxCtag_tt_idx", hsb.r9300.sthdr_rxCtag_tt_idx);
        osal_printf("%-14s = 0x%-10x\n", "mac_cst", hsb.r9300.sthdr_rxCtag_mac_cst);

        osal_printf("%-14s = 0x%-10x", "dm_rxidx_of_lb_times", hsb.r9300.sthdr_rxCtag_dm_rxidx_of_lb_times);
        osal_printf("%-14s = 0x%-10x", "new_sa", hsb.r9300.sthdr_rxCtag_new_sa);
        osal_printf("%-14s = 0x%-10x\n", "pmv_forbid", hsb.r9300.sthdr_rxCtag_pmv_forbid);

        osal_printf("%-14s = 0x%-10x", "l2_sttc_pmv", hsb.r9300.sthdr_rxCtag_l2_sttc_pmv);
        osal_printf("%-14s = 0x%-10x", "l2_dyn_pmv", hsb.r9300.sthdr_rxCtag_l2_dyn_pmv);
        osal_printf("%-14s = 0x%-10x\n", "port_data_is_trk", hsb.r9300.sthdr_rxCtag_port_data_is_trk);

        osal_printf("%-14s = 0x%-10x", "port_data", hsb.r9300.sthdr_rxCtag_port_data);
        osal_printf("%-14s = 0x%-10x", "hash_full", hsb.r9300.sthdr_rxCtag_hash_full);
        osal_printf("%-14s = 0x%-10x\n", "invalid_sa", hsb.r9300.sthdr_rxCtag_invalid_sa);
        osal_printf("%-14s = 0x%-10x\n", "trap rsn", hsb.r9300.sthdr_rxCtag_rsn);

        osal_printf("*************************ACL************************************\n");
        osal_printf("%-14s = 0x%-10x", "fwd cpu pkt hit", hsb.r9300.sthdr_acl_fwd_cpu_pkt_hit);
        osal_printf("%-14s = 0x%-10x\n", "fwd cpu pkt fmt", hsb.r9300.sthdr_acl_fwd_cpu_pkt_fmt);

        /*Stacking Header*/
        osal_printf("--------------------------------------Packet Info-----------------------------------------\n");
        osal_printf("********************L2 Info********************\n");
        osal_printf("%-14s = %x:%x:%x:%x:%x:%x\n", "dmac[6]", hsb.r9300.dmac[0],hsb.r9300.dmac[1], hsb.r9300.dmac[2], hsb.r9300.dmac[3], hsb.r9300.dmac[4], hsb.r9300.dmac[5]);
        osal_printf("%-14s = %x:%x:%x:%x:%x:%x\n", "smac[6]", hsb.r9300.smac[0],hsb.r9300.smac[1], hsb.r9300.smac[2], hsb.r9300.smac[3], hsb.r9300.smac[4], hsb.r9300.smac[5]);

        osal_printf("%-14s = 0x%-10x", "sphy", hsb.r9300.sphy);
        osal_printf("%-14s = 0x%-10x", "l2_err_pkt", hsb.r9300.l2_err_pkt);
        osal_printf("%-14s = 0x%-10x\n", "typelen", hsb.r9300.typelen);

        osal_printf("%-14s = 0x%-10x", "llc_other", hsb.r9300.llc_other);
        osal_printf("%-14s = 0x%-10x", "dsap_ssap", hsb.r9300.dsap_ssap);
        osal_printf("%-14s = 0x%-10x\n", "pppoe_pkt", hsb.r9300.pppoe_pkt);

        osal_printf("%-14s = 0x%-10x", "rfc1042", hsb.r9300.rfc1042);
        osal_printf("%-14s = 0x%-10x", "pkt_len", hsb.r9300.pkt_len);
        osal_printf("%-14s = 0x%-10x\n", "igr_err", hsb.r9300.igr_err);

        osal_printf("%-14s = 0x%-10x", "page_cnt", hsb.r9300.page_cnt);
        osal_printf("%-14s = 0x%-10x", "fst_dsc", hsb.r9300.fst_dsc);
        osal_printf("%-14s = 0x%-10x\n", "lst_dsc", hsb.r9300.lst_dsc);
        osal_printf("********************VLAN Tag Info********************\n");
        osal_printf("%-14s = 0x%-10x", "otag_exist", hsb.r9300.otag_exist);
        osal_printf("%-14s = 0x%-10x", "otpid_idx", hsb.r9300.otpid_idx);
        osal_printf("%-14s = 0x%-10x\n", "opri", hsb.r9300.opri);

        osal_printf("%-14s = 0x%-10x", "ocfi", hsb.r9300.ocfi);
        osal_printf("%-14s = 0x%-10x\n", "ovid", hsb.r9300.ovid);

        osal_printf("%-14s = 0x%-10x", "itag_exist", hsb.r9300.itag_exist);
        osal_printf("%-14s = 0x%-10x", "itpid_idx", hsb.r9300.itpid_idx);
        osal_printf("%-14s = 0x%-10x\n", "ipri", hsb.r9300.ipri);

        osal_printf("%-14s = 0x%-10x", "icfi", hsb.r9300.icfi);
        osal_printf("%-14s = 0x%-10x\n", "ivid", hsb.r9300.ivid);

        osal_printf("%-14s = 0x%-10x", "rtag_exist", hsb.r9300.rtag_exist);
        osal_printf("%-14s = 0x%-10x", "rtag_type", hsb.r9300.rtag_type);
        osal_printf("%-14s = 0x%-10x\n", "etag_exist", hsb.r9300.etag_exist);
        osal_printf("********************L3/L4 Info********************\n");
        osal_printf("%-14s = 0x%-10x", "ipv4_pkt", hsb.r9300.ipv4_pkt);
        osal_printf("%-14s = 0x%-10x", "ipv6_pkt", hsb.r9300.ipv6_pkt);
        osal_printf("%-14s = 0x%-10x\n", "ip_ver", hsb.r9300.ip_ver);

        osal_printf("%-14s = 0x%-10x", "dip", hsb.r9300.dip);
        osal_printf("%-14s = 0x%-10x", "sip", hsb.r9300.sip);
        osal_printf("%-14s = 0x%-10x\n", "ip_ttl", hsb.r9300.ip_ttl);

        osal_printf("%-14s = 0x%-10x", "ip_tos", hsb.r9300.ip_tos);
        osal_printf("%-14s = 0x%-10x", "ip_protocol", hsb.r9300.ip_protocol);
        osal_printf("%-14s = 0x%-10x\n", "ip_flag", hsb.r9300.ip_flag);

        osal_printf("%-14s = 0x%-10x", "ip_offset", hsb.r9300.ip_offset);
        osal_printf("%-14s = 0x%-10x", "ip_length", hsb.r9300.ip_length);
        osal_printf("%-14s = 0x%-10x\n", "ipv4_hdrlen", hsb.r9300.ipv4_hdrlen);

        osal_printf("%-14s = 0x%-10x", "tcp_sn_eq_0", hsb.r9300.tcp_sn_eq_0);
        osal_printf("%-14s = 0x%-10x", "ipv6_hop", hsb.r9300.ipv6_hop);
        osal_printf("%-14s = 0x%-10x\n", "ipv6_rout", hsb.r9300.ipv6_rout);

        osal_printf("%-14s = 0x%-10x", "ipv6_frag", hsb.r9300.ipv6_frag);
        osal_printf("%-14s = 0x%-10x", "ipv6_dest", hsb.r9300.ipv6_dest);
        osal_printf("%-14s = 0x%-10x\n", "ipv6_auth", hsb.r9300.ipv6_auth);

        osal_printf("%-14s = 0x%-10x", "ipv4_chksum_ok", hsb.r9300.ipv4_chksum_ok);
        osal_printf("%-14s = 0x%-10x", "ipv6_ext_long", hsb.r9300.ipv6_ext_long);
        ...
        osal_printf("%-14s = 0x%-10x", "dport", hsb.r9300.dport);
        osal_printf("%-14s = 0x%-10x", "sport", hsb.r9300.sport);
        osal_printf("%-14s = 0x%-10x\n", "tcp_flag", hsb.r9300.tcp_flag);

        osal_printf("%-14s = 0x%-10x\n", "l4_hdr_chk", hsb.r9300.l4_hdr_chk);

        osal_printf("********************CPU Tag Info********************\n");
        osal_printf("%-14s = 0x%-10x", "ctag_exist", hsb.r9300.ctag_exist);
        osal_printf("%-14s = 0x%-10x", "ctag_acl_act", hsb.r9300.ctag_acl_act);
        osal_printf("%-14s = 0x%-10x\n", "ctag_cngst_drop", hsb.r9300.ctag_cngst_drop);

        osal_printf("%-14s = 0x%-10x", "ctag_dg_pkt", hsb.r9300.ctag_dg_pkt);
        osal_printf("%-14s = 0x%-10x", "ctag_bp_fltr", hsb.r9300.ctag_bp_fltr);
        osal_printf("%-14s = 0x%-10x\n", "ctag_bp_stp", hsb.r9300.ctag_bp_stp);

        osal_printf("%-14s = 0x%-10x", "ctag_bp_vlan_egr", hsb.r9300.ctag_bp_vlan_egr);
        osal_printf("%-14s = 0x%-10x", "ctag_ale_as_tagsts", hsb.r9300.ctag_ale_as_tagsts);
        osal_printf("%-14s = 0x%-10x\n", "ctag_as_qid", hsb.r9300.ctag_as_qid);

        osal_printf("%-14s = 0x%-10x", "ctag_qid", hsb.r9300.ctag_qid);
        osal_printf("%-14s = 0x%-10x", "ctag_ori_tagif_en", hsb.r9300.ctag_ori_tagif_en);
        osal_printf("%-14s = 0x%-10x\n", "ctag_ori_itagif", hsb.r9300.ctag_ori_itagif);

        osal_printf("%-14s = 0x%-10x", "ctag_ori_otagif", hsb.r9300.ctag_ori_otagif);
        osal_printf("%-14s = 0x%-10x", "ctag_fwd_vid_sel", hsb.r9300.ctag_fwd_vid_sel);
        osal_printf("%-14s = 0x%-10x\n", "ctag_fwd_vid_en", hsb.r9300.ctag_fwd_vid_en);

        osal_printf("%-14s = 0x%-10x", "ctag_fwd_vid", hsb.r9300.ctag_fwd_vid);
        osal_printf("%-14s = 0x%-10x", "ctag_fwd_type", hsb.r9300.ctag_fwd_type);
        osal_printf("%-14s = 0x%-10x\n", "ctag_src_filter_en", hsb.r9300.ctag_src_filter_en);

        osal_printf("%-14s = 0x%-10x", "ctag_sp_is_trk", hsb.r9300.ctag_sp_is_trk);
        osal_printf("%-14s = 0x%-10x", "ctag_spn", hsb.r9300.ctag_spn);
        osal_printf("%-14s = 0x%-10x\n", "ctag_unit", hsb.r9300.ctag_unit);

        osal_printf("%-14s = 0x%-10x", "ctag_dpm_0", hsb.r9300.ctag_dpm.bits[0]);
        osal_printf("%-14s = 0x%-10x\n", "ctag_dpm_1", hsb.r9300.ctag_dpm.bits[1]);
        osal_printf("********************ACL related Info********************\n");
        osal_printf("%-14s = 0x%-10x", "fs11_data", hsb.r9300.fs11_data);
        osal_printf("%-14s = 0x%-10x", "fs10_data", hsb.r9300.fs10_data);
        osal_printf("%-14s = 0x%-10x\n", "fs9_data", hsb.r9300.fs9_data);

        osal_printf("%-14s = 0x%-10x", "fs8_data", hsb.r9300.fs8_data);
        osal_printf("%-14s = 0x%-10x", "fs7_data", hsb.r9300.fs7_data);
        osal_printf("%-14s = 0x%-10x\n", "fs6_data", hsb.r9300.fs6_data);

        osal_printf("%-14s = 0x%-10x", "fs5_data", hsb.r9300.fs5_data);
        osal_printf("%-14s = 0x%-10x", "fs4_data", hsb.r9300.fs4_data);
        osal_printf("%-14s = 0x%-10x\n", "fs3_data", hsb.r9300.fs3_data);

        osal_printf("%-14s = 0x%-10x", "fs2_data", hsb.r9300.fs2_data);
        osal_printf("%-14s = 0x%-10x", "fs1_data", hsb.r9300.fs1_data);
        osal_printf("%-14s = 0x%-10x\n", "fs0_data", hsb.r9300.fs0_data);

        osal_printf("----------------------------Loopback header Valid = %d-------------------------------\n", hsb.r9300.lbhdr_vld );
        osal_printf("%-14s = 0x%-10x", "lbhdr_org_srcport", hsb.r9300.lbhdr_org_srcport);
        osal_printf("%-14s = 0x%-10x", "lbhdr_lbttl", hsb.r9300.lbhdr_lbttl);
        osal_printf("%-14s = 0x%-10x\n", "lbhdr_metadata", hsb.r9300.lbhdr_metadata);

        osal_printf("--------------------------------------Others-----------------------------------------\n");
        osal_printf("%-14s = 0x%-10x", "udp_ptp", hsb.r9300.udp_ptp);
        osal_printf("%-14s = 0x%-10x", "l2_ptp", hsb.r9300.l2_ptp);
...
int32 _rtk_getHsa(uint32 unit, hsa_param_t * hsa)
{
    ...
    if (HWP_9300_FAMILY_ID(unit))
    {
        ...
        reg_field_get(unit, LONGAN_HSA_DATA9r, LONGAN_CTX_UNIT_IDf, &tmpVal, &value);
    ...
    if (HWP_9310_FAMILY_ID(unit))
    {
        ...
        reg_field_get(unit, MANGO_HSA_DATAr, MANGO_HSA_SW_UNITf, &tmpVal, val);
        ...
        reg_field_get(unit, MANGO_HSA_DATAr, MANGO_HSA_IP_TTLf, &tmpVal, val);
...
int32 _hal_getHsm_9310(uint32 unit, hsm_param_t *hsm)
{
    ...
    reg_field_get(unit, MANGO_HSM_DATAr, MANGO_SW_UNITf, &tmpVal, val);
    ...
    reg_field_get(unit, MANGO_HSM_DATAr, MANGO_IP_TTLf, &tmpVal, val);
...
int32 _hal_dumpHsm_9310(uint32 unit)
{
    ...
    osal_printf("SW_UNIT : 0x%x\t\t\t", hsm.r9310.sw_unit);
...
int32 _hal_getHsm_9300(uint32 unit, uint32 index, hsm_param_t *hsm)
{
    ...
    if (index == 0) {
        ...
        reg_field_get(unit, LONGAN_HSM2_DATA21r, LONGAN_CTX_UNIT_IDf, &tmpVal, &val);
        ...
        reg_field_get(unit, LONGAN_HSM3_DATA21r, LONGAN_CTX_UNIT_IDf, &tmpVal, &val);
        ...
        HWP_8380_FAMILY_ID(unit))
    {
        switch (type)
        {
            ...
            case RTK_DBG_MIB_MCST_INVALID_DPM_DROP_RTL8380:
                ...
                break;
            case RTK_DBG_MIB_RX_FLOW_CONTROL_DROP_RTL8380:
    ...
    if (HWP_9300_FAMILY_ID(unit))
    {
        switch (type)
        {
            ...
            case RTK_DBG_CNTR_ATTACK_PREVENT:
                ...
                break;
            case RTK_DBG_CNTR_ACL_FWD_ACTION:
            ...
            case RTK_DBG_CNTR_PORT_ISOLATION:
                ...
                break;
            case RTK_DBG_CNTR_TX_MAX_FRAME_SIZE:
            ...
            case RTK_DBG_CNTR_EGR_LINK_STATUS:
                ...
                break;
            case RTK_DBG_CNTR_MAC_TX_DISABLE:
                ret = reg_field_read(unit, LONGAN_STAT_PRVTE_DROP_COUNTER67r, LONGAN_REASONf, pCntr);
                break;
            case RTK_DBG_CNTR_MAC_PAUSE_FRAME:
                ret = reg_field_read(unit, LONGAN_STAT_PRVTE_DROP_COUNTER68r, LONGAN_REASONf, pCntr);
                break;
            case RTK_DBG_CNTR_MAC_RX_DROP:                     /*LLC check failure, 48pass1,dscrunout/l2-CRC/oversize/undersize/symbol-error*/
