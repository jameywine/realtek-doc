 ...
 *
 * $Revision: 81200 $
 * $Date: 2017-08-14 14:12:22 +0800 (Mon, 14 Aug 2017) $
 *
...
static rt_register_capacity_t rtl9310_capacityInfo =
{
    ...
    .vlan_fid_max                   = 255,
    /* flow control */
    .flowctrl_thresh_max            = 5825,
    .flowctrl_pauseOn_page_packet_max       = 5825,
    .flowctrl_pauseOn_page_packet_len_max   = 0xFFFF,
...
static rt_register_capacity_t rtl9300_capacityInfo =
{
    ...
    .rate_of_storm_proto_control_max= 0x1FF,
    .burst_of_storm_proto_control_max= 0xFF,
    .burst_rate_of_storm_control_min= 1700,
    .burst_rate_of_storm_control_max= 0xFFFF,
    .burst_rate_of_10ge_storm_control_min= 2650,
    .burst_rate_of_10ge_storm_control_max    = 0xFFFFF,
...
hal_stackPortStartEnd_get(uint32 chip_id, stack_port_indexType_t type)
{
    ...
    for(i = 0; i < sizeof(supported_devices)/sizeof(rt_device_t); i++)
    {
        if (supported_devices[i].chip_id == chip_id)
        {
            return (STACK_PORT_INDEX_TYPE_START == type)? port_start : port_end;
        }
    }

get_failed:
    return (STACK_PORT_INDEX_TYPE_START == type)?(RTK_MAX_PORT_ID_PER_UNIT):(0);

}/* end of hal_stackPortStartEnd_get */
