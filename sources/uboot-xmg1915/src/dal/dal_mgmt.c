 ...
 *
 * $Revision: 81195 $
 * $Date: 2017-08-14 11:19:18 +0800 (Mon, 14 Aug 2017) $
 *
...
dal_mapper_t            *mgmt_dal_mapper[RT_CHIP_FAMILY_INDEX_END];
...
int32 dal_mgmt_initDevice(void)
{
    ...
    {
        if(HWP_SWCORE_SUPPORT(unit)==FALSE)
            continue;
