 ...
 *
 * $Revision: 80803 $
 * $Date: 2017-07-25 15:22:43 +0800 (Tue, 25 Jul 2017) $
 *
...
dal_longan_trap_mgmtFrameAction_get(uint32 unit, rtk_trap_mgmtType_t frameType, rtk_mgmt_action_t *pAction)
{
    ...
    {
        case MGMT_TYPE_MLD:
            reg = LONGAN_VLAN_APP_PKT_CTRLr;
            field = LONGAN_MLD_ACTf;
            break;
        ...
        case MGMT_TYPE_ARP_REQ:
            reg = LONGAN_VLAN_APP_PKT_CTRLr;
            field = LONGAN_ARP_REQ_ACTf;
            break;

        case MGMT_TYPE_ARP_REP:
            reg = LONGAN_VLAN_APP_PKT_CTRLr;
            field = LONGAN_ARP_REP_ACTf;
            break;

        case MGMT_TYPE_DHCP:
            reg = LONGAN_VLAN_APP_PKT_CTRLr;
            field = LONGAN_DHCP_ACTf;
            break;

        case MGMT_TYPE_DHCP6:
            reg = LONGAN_VLAN_APP_PKT_CTRLr;
            field = LONGAN_DHCP6_ACTf;
            break;
        ...
        switch (value)
        {
            ...
            case 3:
                *pAction = MGMT_ACTION_TRAP2MASTERCPU;
                break;
            case 4:
                *pAction = MGMT_ACTION_COPY2MASTERCPU;
                break;
            default:
                return RT_ERR_FAILED;
        }
    ...
    else
    {
        switch (action)
        {
            ...
            case MGMT_ACTION_TRAP2MASTERCPU:
                value = 3;
                break;
            case MGMT_ACTION_COPY2MASTERCPU:
                value = 4;
                break;
            default:
                return RT_ERR_FAILED;
