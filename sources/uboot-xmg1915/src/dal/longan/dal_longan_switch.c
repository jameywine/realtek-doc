 ...
 *
 * $Revision: 80529 $
 * $Date: 2017-07-12 15:25:53 +0800 (Wed, 12 Jul 2017) $
 *
...
dal_longan_switchMapper_init(dal_mapper_t *pMapper)
{
    ...
    pMapper->switch_halfConsecutiveRetryEnable_get = dal_longan_switch_halfConsecutiveRetryEnable_get;
    pMapper->switch_halfConsecutiveRetryEnable_set = dal_longan_switch_halfConsecutiveRetryEnable_set;
    return RT_ERR_OK;
}
...
/* Function Name:
 *      dal_longan_switch_halfConsecutiveRetryEnable_get
 * Description:
 ...
 */
int32
dal_longan_switch_halfConsecutiveRetryEnable_get(uint32 unit, rtk_enable_t *pEnable)
{
    int32   ret = RT_ERR_FAILED;
    uint32  val = 0;
...
/* Function Name:
 *      dal_longan_switch_halfConsecutiveRetryEnable_set
 * Description:
 ...
 */
int32
dal_longan_switch_halfConsecutiveRetryEnable_set(uint32 unit, rtk_enable_t enable)
{
    int32   ret = RT_ERR_FAILED;
    uint32  val;
