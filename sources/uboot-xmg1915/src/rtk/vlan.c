    ...
    rtk_enable_t    eanble)
{
    ...
    return RT_MAPPER(unit)->vlan_portEgrVlanTransparentEnable_set(unit, port, type, eanble);
...
rtk_vlan_bssid_add(uint32 unit, rtk_vlan_t vid, rtk_mac_t *pBssid)
{
    ...
    return RT_MAPPER(unit)->vlan_bssid_add(unit, vid, pBssid);
...
rtk_vlan_bssid_del(uint32 unit, rtk_vlan_t vid, rtk_mac_t *pBssid)
{
    ...
    return RT_MAPPER(unit)->vlan_bssid_del(unit, vid, pBssid);
    ...
    uint32      *pBssidCnt)
{
    ...
    return RT_MAPPER(unit)->vlan_bssid_get(unit, vid, arraySize, pBssidArray, pBssidCnt);
