...
rtk_port_isolationExt_get(uint32 unit, uint32 srcUnit, rtk_port_t srcPort, rtk_portmask_t *pPortmask)
{
    ...
    return RT_MAPPER(unit)->port_isolationExt_get(unit, srcUnit, srcPort, pPortmask);
...
rtk_port_isolationExt_set(uint32 unit, uint32 srcUnit, rtk_port_t srcPort, rtk_portmask_t *pPortmask)
{
    ...
    return RT_MAPPER(unit)->port_isolationExt_set(unit, srcUnit, srcPort, pPortmask);
...
rtk_port_phyEyeMonitor_start(uint32 unit, rtk_port_t port, uint32 frameNum)
{
    ...
    return RT_MAPPER(unit)->port_phyEyeMonitor_start(unit, port, frameNum);
