 ...
 *
 * $Revision: 77506 $
 * $Date: 2017-04-12 16:06:27 +0800 (Wed, 12 Apr 2017) $
 *
    ...
    rtk_of_ftTemplateIdx_t  *pTemplate_idx)
{
    ...
    return RT_MAPPER(unit)->of_ftTemplateSelector_get(unit, block_idx, pTemplate_idx);
    ...
    rtk_of_ftTemplateIdx_t  template_idx)
{
    ...
    return RT_MAPPER(unit)->of_ftTemplateSelector_set(unit, block_idx, template_idx);
