...
/* Function Name:
 *      rtk_l2_mcastAddrEcidPmsk_add
 * Description:
 *      Add an E-CID to an L2 multicast entry on the specified device.
 * Input:
 *      unit        - unit id
 *      pMcast_addr - pointer to l2 multicast address
    ...
    rtk_bpe_pmskEntry_t *pEntry)
{
    ...
    return RT_MAPPER(unit)->l2_mcastAddrEcidPmsk_add(unit, pMcast_addr, pEntry);
}   /* end of rtk_l2_mcastAddrEcidPmsk_add */

/* Function Name:
 *      rtk_l2_mcastAddrEcidPmsk_del
 * Description:
 *      Delete an E-CID from an L2 multicast entry on the specified device.
 * Input:
 *      unit      - unit id
 *      mcastAddr - l2 multicast address
 *      pEntry    - pointer to ECID_PMSK entry
 * Output:
 *      None
 * Return:
    ...
    rtk_bpe_pmskEntry_t *pEntry)
{
    ...
    return RT_MAPPER(unit)->l2_mcastAddrEcidPmsk_del(unit, mcastAddr, pEntry);
}   /* end of rtk_l2_mcastAddrEcidPmsk_del */

/* Function Name:
 *      rtk_l2_mcastAddrEcidPmsk_get
 * Description:
 *      Get the portmask of an E-CID of a VLAN on the specified device.
 * Input:
 *      unit       - unit id
 *      pMcastAddr - pointer to the l2 multicast address
 *      pEntry     - pointer to ECID_PMSK entry
 * Output:
 *      pEntry     - pointer to ECID_PMSK entry
 * Return:
    ...
    rtk_bpe_pmskEntry_t *pEntry)
{
    ...
    return RT_MAPPER(unit)->l2_mcastAddrEcidPmsk_get(unit, pMcastAddr, pEntry);
}   /* end of rtk_l2_mcastAddrEcidPmsk_get */

/* Function Name:
 *      rtk_l2_mcastAddrEcidPmskNextValid_get
 * Description:
 *      Get the portmask of the next valid E-CID of an L2 multicast entry on the specified device.
 * Input:
 *      unit       - unit id
 *      pMcastAddr - pointer to the l2 multicast address
 *      pEntry     - pointer to ECID_PMSK entry
    ...
    rtk_l2_mcastAddr_t *pMcastAddr, rtk_bpe_pmskEntry_t *pEntry)
{
    ...
    return RT_MAPPER(unit)->l2_mcastAddrEcidPmskNextValid_get(unit, pMcastAddr, pEntry);
