 ...
 *
 * $Revision: 76408 $
 * $Date: 2017-03-10 15:57:05 +0800 (Fri, 10 Mar 2017) $
 *
...
rtk_ipmc_globalCtrl_set(uint32 unit, rtk_ipmc_globalCtrlType_t controlType, int32 arg)
{
    ...
    return  RT_MAPPER(unit)->ipmc_globalCtrl_set(unit, controlType, arg);
}
...
rtk_ipmc_globalCtrl_get(uint32 unit, rtk_ipmc_globalCtrlType_t controlType, int32 *pArg)
{
    ...
    return  RT_MAPPER(unit)->ipmc_globalCtrl_get(unit, controlType, pArg);
}
