...
{
#if defined(CONFIG_SDK_DRIVER_I2C_R8390)
        {RTL8390_FAMILY_ID, FAMILY_ID_MASK, I2C_R8390},
        {RTL8350_FAMILY_ID, FAMILY_ID_MASK, I2C_R8390},
#endif
#if defined(CONFIG_SDK_DRIVER_I2C_R8380)
        {RTL8380_FAMILY_ID, FAMILY_ID_MASK, I2C_R8380},
        {RTL8330_FAMILY_ID, FAMILY_ID_MASK, I2C_R8380},
#endif
#if (defined(CONFIG_SDK_DRIVER_I2C_R9300))
        {RTL9300_FAMILY_ID, FAMILY_ID_MASK, I2C_R9300},
#endif
#if (defined(CONFIG_SDK_DRIVER_I2C_R9310))
        {RTL9310_FAMILY_ID, FAMILY_ID_MASK, I2C_R9310},
#endif
};
