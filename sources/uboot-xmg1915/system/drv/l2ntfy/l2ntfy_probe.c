...
const static cid_prefix_group_t l2ntfy_db[] =
{
    ...
    {RTL8390_FAMILY_ID, FAMILY_ID_MASK, L2NTFY_R8390},
    {RTL8350_FAMILY_ID, FAMILY_ID_MASK, L2NTFY_R8390},
#endif
#if (defined(CONFIG_SDK_DRIVER_L2NTFY_R9300) || defined(CONFIG_SDK_DRIVER_NOTIF_R9300_MODULE))
    {RTL9300_FAMILY_ID, FAMILY_ID_MASK, L2NTFY_R9300},
#endif
#if defined(CONFIG_SDK_DRIVER_L2NTFY_R9310)
    {RTL9310_FAMILY_ID, FAMILY_ID_MASK, L2NTFY_R9310},
#endif
};
