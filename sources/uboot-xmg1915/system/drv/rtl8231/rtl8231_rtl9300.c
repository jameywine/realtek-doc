 ...
 *
 * $Revision: 79585 $
 * $Date: 2017-06-13 17:01:23 +0800 (Tue, 13 Jun 2017) $
 *
 ...
 */
int32
r9300_rtl8231_directAccess_set(uint32 unit, uint32 dev, drv_extGpio_directAccessMode_t mode, rtk_enable_t enable)
{
    uint32  temp = 0;
    ...
    {
        temp |= RTL9300_EXT_GPIO_GLB_CTRL_EXT_GPIO_MDX3_ACCESS_MODE_MASK;
        temp |= RTL9300_EXT_GPIO_GLB_CTRL_EXT_GPIO_MDX2_ACCESS_MODE_MASK;
    }else{
        temp &= ~(RTL9300_EXT_GPIO_GLB_CTRL_EXT_GPIO_MDX3_ACCESS_MODE_MASK);
        temp &= ~(RTL9300_EXT_GPIO_GLB_CTRL_EXT_GPIO_MDX2_ACCESS_MODE_MASK);
    }
    ...
    if(enable == ENABLED)
    {
        temp |= RTL9300_EXT_GPIO_GLB_CTRL_EXT_GPIO_MDX3_EN_MASK;
        temp |= RTL9300_EXT_GPIO_GLB_CTRL_EXT_GPIO_MDX2_EN_MASK;
    }else{
        temp &= ~(RTL9300_EXT_GPIO_GLB_CTRL_EXT_GPIO_MDX3_EN_MASK);
        temp &= ~(RTL9300_EXT_GPIO_GLB_CTRL_EXT_GPIO_MDX2_EN_MASK);
    }
