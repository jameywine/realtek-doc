 ...
 *
 * $Revision: 80804 $
 * $Date: 2017-07-25 16:45:26 +0800 (Tue, 25 Jul 2017) $
 *
 ...
 */
int32
drv_rtl8231_directAccess_set(uint32 unit, uint32 dev, drv_extGpio_directAccessMode_t mode, rtk_enable_t enable)
{
    RT_PARAM_CHK((unit > RTK_MAX_UNIT_ID), RT_ERR_UNIT_ID);
    RT_PARAM_CHK(!RTL8231_CHK(unit), RT_ERR_CHIP_NOT_FOUND);

    return RTL8231_CTRL(unit).directAccess_set(unit, dev, mode, enable);
