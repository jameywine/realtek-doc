 ...
 *
 * $Revision: 80657 $
 * $Date: 2017-07-19 09:07:12 +0800 (Wed, 19 Jul 2017) $
 *
...
#define STR_MOD_TIME            "time"
#define STR_MOD_ACL             "acl"
#define STR_MOD_MPLS            "mpls"
#define STR_MOD_DIAG            "diag"
#define STR_MOD_STACK           "stack"
#define STR_MOD_COMMON          "common"
#define STR_MOD_TUNNEL          "tunnel"
#define STR_MOD_OPENFLOW        "openflow"
#define STR_MOD_CAPWAP          "capwap"
#define STR_MOD_MCAST           "mcast"
#define STR_MOD_IPMCAST         "ipmcast"
#define STR_MOD_BPE             "bpe"
#define STR_MOD_BSP             "bsp"
#define STR_MOD_PHY             "phy"
...
#define RT_LOG_MODULE_STRING               \
    (uint8 *)STR_MOD_GENERAL,              \
    (uint8 *)STR_MOD_FLOWCTRL,             \
    (uint8 *)STR_MOD_INIT,                 \
    (uint8 *)STR_MOD_L2,                   \
    (uint8 *)STR_MOD_MIRROR,               \
    (uint8 *)STR_MOD_NIC,                  \
    (uint8 *)STR_MOD_PORT,                 \
    (uint8 *)STR_MOD_QOS,                  \
    (uint8 *)STR_MOD_RATE,                 \
    ...
    (uint8 *)STR_MOD_RTDRV,                \
    (uint8 *)STR_MOD_RTUSR,                \
    (uint8 *)STR_MOD_DIAGSHELL,            \
    (uint8 *)STR_MOD_UNITTEST,             \
    (uint8 *)STR_MOD_OAM,                  \
    (uint8 *)STR_MOD_L3,                   \
    (uint8 *)STR_MOD_RTCORE,               \
    (uint8 *)STR_MOD_EEE,                  \
    (uint8 *)STR_MOD_SEC,                  \
    (uint8 *)STR_MOD_LED,                  \
    (uint8 *)STR_MOD_TIME,                 \
    ...
    (uint8 *)STR_MOD_DIAG,                 \
    (uint8 *)STR_MOD_STACK,                \
    (uint8 *)STR_MOD_COMMON,               \
    (uint8 *)STR_MOD_TUNNEL,               \
    (uint8 *)STR_MOD_OPENFLOW,             \
    (uint8 *)STR_MOD_CAPWAP,               \
    (uint8 *)STR_MOD_MCAST,                \
    (uint8 *)STR_MOD_IPMCAST,              \
    (uint8 *)STR_MOD_BPE,                  \
    (uint8 *)STR_MOD_BSP,                  \
    (uint8 *)STR_MOD_PHY,                  \
    (uint8 *)STR_MOD_END                   \
