...
#define DRAM_MEM_SIZE                   0x08000000
#define DMA_MEM_SIZE                    0x00800000  /* for NIC driver, L2NTFY driver DMA usage, for our Linux User Space example code */
...
#define DMA_PHYS_BASE                   (DRAM_PHYS_BASE + DRAM_MEM_SIZE - DMA_MEM_SIZE)
