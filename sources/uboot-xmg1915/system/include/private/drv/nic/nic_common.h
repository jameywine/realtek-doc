...
typedef enum drv_nic_rx_reason_e
{
    ...
    NIC_RX_REASON_OF_CAPWAP_TT_EXCPT,   /* CAPWAP Tunnel Terminate Exception */
...
typedef struct drv_nic_pkt_s
{
    ...
    struct
    {
        ...
        uint8   ext_unit;           /* The extended unit ID */
                                    /* The original switch device unit if port move */
