...
int32 rtk_rate_init(uint32 unit)
{
...
int32 rtk_rate_includeIfg_get(uint32 unit, rtk_rate_module_t module, rtk_enable_t *pIfg_include)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_includeIfg_set(uint32 unit, rtk_rate_module_t module, rtk_enable_t ifg_include)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portIgrBwCtrlEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portIgrBwCtrlEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portIgrBwCtrlRate_get(uint32 unit, rtk_port_t port, uint32 *pRate)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portIgrBwCtrlRate_set(uint32 unit, rtk_port_t port, uint32 rate)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_igrPortBwCtrlBurstSize_get(uint32 unit, uint32 *pBurst_size)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_igrPortBwCtrlBurstSize_set(uint32 unit, uint32 burst_size)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portIgrBwCtrlBurstSize_get(uint32 unit, rtk_port_t port, rtk_rate_igrBwBurst_cfg_t *pCfg)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portIgrBwCtrlBurstSize_set(uint32 unit, rtk_port_t port, rtk_rate_igrBwBurst_cfg_t *pCfg)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portIgrBwFlowctrlEnable_get(
    uint32              unit,
    rtk_port_t          port,
...
int32 rtk_rate_portIgrBwFlowctrlEnable_set(
    uint32              unit,
    rtk_port_t          port,
    rtk_enable_t        enable)
{
...
int32 rtk_rate_portIgrQueueBwCtrlBurstSize_get(uint32 unit, rtk_port_t port, rtk_qid_t queue, uint32 *pBurst_size)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portIgrQueueBwCtrlBurstSize_set(uint32 unit, rtk_port_t port, rtk_qid_t queue, uint32 burst_size)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portIgrQueueFixedBwCtrlEnable_get(
    uint32          unit,
    rtk_port_t      port,
    rtk_qid_t       queue,
    rtk_enable_t    *pEnable)
{
    ...
    rate_cfg.port = port;
    rate_cfg.queue = queue;
    GETSOCKOPT(RTDRV_RATE_PORT_IGR_QUEUE_FIXED_BWCTRL_ENABLE_GET, &rate_cfg, rtdrv_rateCfg_t, 1);
    *pEnable = rate_cfg.enable;

    return RT_ERR_OK;
}

int32 rtk_rate_portIgrQueueFixedBwCtrlEnable_set(
    uint32          unit,
    rtk_port_t      port,
    rtk_qid_t       queue,
    rtk_enable_t    enable)
{
    ...
    rate_cfg.queue = queue;
    rate_cfg.enable = enable;
    SETSOCKOPT(RTDRV_RATE_PORT_IGR_QUEUE_FIXED_BWCTRL_ENABLE_SET, &rate_cfg, rtdrv_rateCfg_t, 1);

    return RT_ERR_OK;
}

int32 rtk_rate_portEgrBwCtrlEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portEgrBwCtrlEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portEgrBwCtrlRate_get(uint32 unit, rtk_port_t port, uint32 *pRate)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portEgrBwCtrlRate_set(uint32 unit, rtk_port_t port, uint32 rate)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portEgrBwCtrlBurstSize_get(uint32 unit, rtk_port_t port, uint32 *pBurst_size)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portEgrBwCtrlBurstSize_set(uint32 unit, rtk_port_t port, uint32 burst_size)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_egrPortBwCtrlBurstSize_get(
    uint32                  unit,
    uint32                  *pBurst_size)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_egrPortBwCtrlBurstSize_set(uint32 unit, uint32 burst_size)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portEgrQueueBwCtrlEnable_get(
    uint32          unit,
    rtk_port_t      port,
    rtk_qid_t       queue,
    rtk_enable_t    *pEnable)
...
int32 rtk_rate_portEgrQueueBwCtrlEnable_set(
    uint32          unit,
    rtk_port_t      port,
    rtk_qid_t       queue,
    rtk_enable_t    enable)
...
int32 rtk_rate_portEgrQueueBwCtrlRate_get(
    uint32      unit,
    rtk_port_t  port,
    rtk_qid_t   queue,
    uint32      *pRate)
...
int32 rtk_rate_portEgrQueueBwCtrlRate_set(
    uint32      unit,
    rtk_port_t  port,
    rtk_qid_t   queue,
    uint32      rate)
...
int32 rtk_rate_portEgrQueueBwCtrlBurstSize_get(uint32 unit, rtk_port_t port, rtk_qid_t queue, uint32 *pBurst_size)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portEgrQueueBwCtrlBurstSize_set(uint32 unit, rtk_port_t port, rtk_qid_t queue, uint32 burst_size)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portEgrQueueAssuredBwCtrlEnable_get(
    uint32          unit,
    rtk_port_t      port,
    rtk_qid_t       queue,
    rtk_enable_t    *pEnable)
...
int32 rtk_rate_portEgrQueueAssuredBwCtrlEnable_set(
    uint32          unit,
    rtk_port_t      port,
    rtk_qid_t       queue,
    rtk_enable_t    enable)
...
int32 rtk_rate_portEgrQueueAssuredBwCtrlRate_get(uint32 unit, rtk_port_t port, rtk_qid_t queue, uint32 *pRate)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portEgrQueueAssuredBwCtrlRate_set(uint32 unit, rtk_port_t port, rtk_qid_t queue, uint32 rate)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portEgrQueueAssuredBwCtrlBurstSize_get(uint32 unit, rtk_port_t port, rtk_qid_t queue, uint32 *pBurst_size)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portEgrQueueAssuredBwCtrlBurstSize_set(uint32 unit, rtk_port_t port, rtk_qid_t queue, uint32 burst_size)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portEgrQueueAssuredBwCtrlMode_get(uint32 unit, rtk_port_t port, rtk_qid_t queue, rtk_rate_assuredMode_t *pMode)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portEgrQueueAssuredBwCtrlMode_set(uint32 unit, rtk_port_t port, rtk_qid_t queue, rtk_rate_assuredMode_t mode)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portStormCtrlEnable_get(
    uint32                  unit,
    rtk_port_t              port,
...
int32 rtk_rate_portStormCtrlEnable_set(
    uint32                  unit,
    rtk_port_t              port,
    rtk_rate_storm_group_t  storm_type,
    rtk_enable_t            enable)
...
int32 rtk_rate_portStormCtrlRate_get(uint32 unit, rtk_port_t port, rtk_rate_storm_group_t storm_type, uint32 *pRate)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portStormCtrlRate_set(uint32 unit, rtk_port_t port, rtk_rate_storm_group_t storm_type, uint32 rate)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_stormControlBurstSize_get(
    uint32                  unit,
    rtk_rate_storm_group_t  storm_type,
    uint32                  *pBurst_size)
{
...
int32 rtk_rate_stormControlBurstSize_set(
    uint32                  unit,
    rtk_rate_storm_group_t  storm_type,
    uint32                  burst_size)
{
...
int32 rtk_rate_portStormCtrlBurstSize_get(
    uint32                  unit,
    rtk_port_t              port,
    rtk_rate_storm_group_t  storm_type,
    uint32                  *pBurst_size)
...
int32 rtk_rate_portStormCtrlBurstSize_set(
    uint32                  unit,
    rtk_port_t              port,
    rtk_rate_storm_group_t  storm_type,
    uint32                  burst_size)
...
int32 rtk_rate_portStormCtrlExceed_get(uint32 unit, rtk_port_t port, rtk_rate_storm_group_t storm_type, uint32 *pIsExceed)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portStormCtrlExceed_reset(uint32 unit, rtk_port_t port, rtk_rate_storm_group_t storm_type)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portStormCtrlRateMode_get(
    uint32                      unit,
    rtk_port_t              port,
    rtk_rate_storm_rateMode_t   *pRate_mode)
{
...
int32 rtk_rate_portStormCtrlRateMode_set(
    uint32                      unit,
    rtk_port_t              port,
    rtk_rate_storm_rateMode_t   rate_mode)
{
...
int32 rtk_rate_portStormCtrlTypeSel_get(uint32 unit, rtk_port_t port, rtk_rate_storm_group_t storm_type, rtk_rate_storm_sel_t *pStorm_sel)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portStormCtrlTypeSel_set(uint32 unit, rtk_port_t port, rtk_rate_storm_group_t storm_type, rtk_rate_storm_sel_t storm_sel)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portStormCtrlProtoEnable_get(uint32 unit, rtk_port_t port, rtk_rate_storm_proto_group_t storm_type, rtk_enable_t *pEnable)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portStormCtrlProtoEnable_set(uint32 unit, rtk_port_t port, rtk_rate_storm_proto_group_t storm_type, rtk_enable_t enable)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portStormCtrlProtoRate_get(
    uint32                          unit,
    rtk_port_t                      port,
...
int32 rtk_rate_portStormCtrlProtoRate_set(
    uint32                  unit,
    rtk_port_t              port,
    rtk_rate_storm_proto_group_t  storm_type,
    uint32                  rate)
...
int32 rtk_rate_portStormCtrlProtoBurstSize_get(
    uint32                  unit,
    rtk_port_t              port,
    rtk_rate_storm_proto_group_t  storm_type,
    uint32                 *pBurst_size)
...
int32 rtk_rate_portStormCtrlProtoBurstSize_set(
    uint32                  unit,
    rtk_port_t              port,
    rtk_rate_storm_proto_group_t  storm_type,
    uint32                  burst_size)
...
int32 rtk_rate_portStormCtrlProtoExceed_get(uint32 unit, rtk_port_t port, rtk_rate_storm_proto_group_t storm_type, uint32 *pIsExceed)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_portStormCtrlProtoExceed_reset(uint32 unit, rtk_port_t port, rtk_rate_storm_proto_group_t storm_type)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_stormCtrlProtoVlanConstrtEnable_get(uint32 unit, rtk_rate_storm_proto_group_t storm_type, rtk_enable_t *pEnable)
{
    rtdrv_rateCfg_t rate_cfg;
...
int32 rtk_rate_stormCtrlProtoVlanConstrtEnable_set(uint32 unit, rtk_rate_storm_proto_group_t storm_type, rtk_enable_t enable)
{
    rtdrv_rateCfg_t rate_cfg;
