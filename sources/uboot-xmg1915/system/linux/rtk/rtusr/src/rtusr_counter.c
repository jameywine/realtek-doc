...
int32 rtk_stat_enable_get(uint32 unit, rtk_enable_t *pEnable)
{
...
int32 rtk_stat_enable_set(uint32 unit, rtk_enable_t enable)
{
    rtdrv_counterCfg_t counter_cfg;
...
int32 rtk_stat_stackHdrLenCntIncEnable_get(uint32 unit, rtk_stat_stackHdrCnt_type_t type, rtk_enable_t *pEnable)
{
    rtdrv_counterCfg_t counter_cfg;
...
int32 rtk_stat_stackHdrLenCntIncEnable_set(uint32 unit, rtk_stat_stackHdrCnt_type_t type, rtk_enable_t enable)
{
    rtdrv_counterCfg_t counter_cfg;
...
int32 rtk_stat_flexibleCntRange_get(uint32 unit, uint32 idx, rtk_stat_flexCntSet_t *pRange)
{
    rtdrv_counterCfg_t counter_cfg;
...
int32 rtk_stat_flexibleCntRange_set(uint32 unit, uint32 idx, rtk_stat_flexCntSet_t *pRange)
{
    rtdrv_counterCfg_t counter_cfg;
