...
int32 rtk_trap_rmaAction_get(uint32 unit, rtk_mac_t *pRma_frame, rtk_mgmt_action_t *pRma_action)
{
...
int32 rtk_trap_rmaAction_set(uint32 unit, rtk_mac_t *pRma_frame, rtk_mgmt_action_t rma_action)
{
    rtdrv_trapCfg_t trap_cfg;
...
int32 rtk_trap_userDefineRmaAction_get(uint32 unit, uint32 userDefine_idx, rtk_mgmt_action_t *pAction)
{
    rtdrv_trapL2userRmaCfg_t  trap_cfg;
...
int32 rtk_trap_userDefineRmaAction_set(uint32 unit, uint32 userDefine_idx, rtk_mgmt_action_t action)
{
    rtdrv_trapL2userRmaCfg_t  trap_cfg;
...
int32 rtk_trap_mgmtFrameAction_get(uint32 unit, rtk_trap_mgmtType_t frameType, rtk_mgmt_action_t *pAction)
{
...
int32 rtk_trap_mgmtFrameAction_set(uint32 unit, rtk_trap_mgmtType_t frameType, rtk_mgmt_action_t action)
{
    rtdrv_trapMgmRmaCfg_t  trap_cfg;
...
int32 rtk_trap_mgmtFrameQueue_get(uint32 unit, rtk_trap_qType_t qType, rtk_qid_t *pQid)
{
    rtdrv_trapMgmRmaCfg_t  trap_cfg;
...
int32 rtk_trap_mgmtFrameQueue_set(uint32 unit, rtk_trap_qType_t qType, rtk_qid_t qid)
{
    rtdrv_trapMgmRmaCfg_t  trap_cfg;
...
int32 rtk_trap_portMgmtFrameAction_get(uint32 unit, rtk_port_t port, rtk_trap_mgmtType_t frameType, rtk_mgmt_action_t *pAction)
{
    rtdrv_trapMgmRmaCfg_t  trap_cfg;
...
int32 rtk_trap_portMgmtFrameAction_set(uint32 unit, rtk_port_t port, rtk_trap_mgmtType_t frameType, rtk_mgmt_action_t action)
{
    rtdrv_trapMgmRmaCfg_t  trap_cfg;
...
int32
rtk_trap_eapolFloodPortmask_get(uint32 unit, rtk_portmask_t * pEapol_flood_portmask)
{
    rtdrv_floodPmskCfg_t config;
...
int32
rtk_trap_eapolFloodPortmask_set(uint32 unit, rtk_portmask_t * pEapol_flood_portmask)
{
    rtdrv_floodPmskCfg_t config;
...
int32
rtk_trap_rmaFloodPortmask_get(uint32 unit, rtk_portmask_t * pRma_flood_portmask)
{
    rtdrv_floodPmskCfg_t config;
...
int32
rtk_trap_rmaFloodPortmask_set(uint32 unit, rtk_portmask_t * pRma_flood_portmask)
{
    rtdrv_floodPmskCfg_t config;
