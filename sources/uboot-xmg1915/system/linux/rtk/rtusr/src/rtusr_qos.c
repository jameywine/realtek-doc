...
int32 rtk_qos_pri2QidMap_get(uint32 unit, rtk_pri_t pri, rtk_qid_t *pQid)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_pri2QidMap_set(uint32 unit, rtk_pri_t pri, rtk_qid_t qid)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_cpuQid2QidMap_get(uint32 unit, rtk_qid_t cpuQid, rtk_qid_t *pQid)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_cpuQid2QidMap_set(uint32 unit, rtk_qid_t cpuQid, rtk_qid_t qid)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_cpuQid2StackQidMap_get(uint32 unit, rtk_qid_t cpuQid, rtk_qid_t *pQid)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_cpuQid2StackQidMap_set(uint32 unit, rtk_qid_t cpuQid, rtk_qid_t qid)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portDpSel_get(uint32 unit, rtk_port_t port, rtk_qos_dpSelWeight_t *pWeightOfDpSel)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portDpSel_set(uint32 unit, rtk_port_t port, rtk_qos_dpSelWeight_t *pWeightOfDpSel)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_dpRemap_get(uint32 unit, rtk_qos_dpSrc_t src, rtk_qos_dpSrcRemap_t srcVal, uint32 * pDp)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_dpRemap_set(uint32 unit, rtk_qos_dpSrc_t src, rtk_qos_dpSrcRemap_t srcVal, uint32 dp)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_priRemap_get(uint32 unit, rtk_qos_priSrc_t src, rtk_qos_priSrcRemap_t srcVal, uint32 *pPri)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_priRemap_set(uint32 unit, rtk_qos_priSrc_t src, rtk_qos_priSrcRemap_t srcVal, uint32 pri)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_port1pRemarkEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_port1pRemarkEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_1pRemarking_get(uint32 unit, rtk_qos_1pRmkSrc_t src, rtk_qos_1pRmkVal_t val, rtk_pri_t *pPri)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_1pRemarking_set(uint32 unit, rtk_qos_1pRmkSrc_t src, rtk_qos_1pRmkVal_t val, rtk_pri_t pri)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_port1pDfltPri_get(uint32 unit, rtk_port_t port, rtk_pri_t *pPri)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_port1pDfltPri_set(uint32 unit, rtk_port_t port, rtk_pri_t pri)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_port1pDfltPriExt_get(uint32 unit, uint32 srcUnit, rtk_port_t port, rtk_pri_t *pPri)
{
    rtdrv_qosCfg_t qos_cfg;

    osal_memset(&qos_cfg, 0, sizeof(rtdrv_qosCfg_t));
    qos_cfg.unit = unit;
    qos_cfg.srcUnit = srcUnit;
    qos_cfg.port = port;
...
int32 rtk_qos_port1pDfltPriExt_set(uint32 unit, uint32 srcUnit, rtk_port_t port, rtk_pri_t pri)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_port1pDfltPriSrcSel_get(uint32 unit, rtk_port_t port, rtk_qos_1pDfltPriSrc_t *pSrc)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_port1pDfltPriSrcSel_set(uint32 unit, rtk_port_t port, rtk_qos_1pDfltPriSrc_t src)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_port1pDfltPriSrcSelExt_get(uint32 unit, uint32 srcUnit, rtk_port_t port, rtk_qos_1pDfltPriSrc_t *pSrc)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_port1pDfltPriSrcSelExt_set(uint32 unit, uint32 srcUnit, rtk_port_t port, rtk_qos_1pDfltPriSrc_t src)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_1pDfltPriCfgSrcSel_get(uint32 unit, rtk_qos_1pDfltCfgSrc_t *pCfg)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_1pDfltPriCfgSrcSel_set(uint32 unit, rtk_qos_1pDfltCfgSrc_t cfg)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portOut1pRemarkEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portOut1pRemarkEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_outer1pRemarking_get(uint32 unit, rtk_qos_outer1pRmkSrc_t src, rtk_qos_outer1pRmkVal_t val, rtk_pri_t *pPri)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_outer1pRemarking_set(uint32 unit, rtk_qos_outer1pRmkSrc_t src, rtk_qos_outer1pRmkVal_t val, rtk_pri_t pri)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portOuter1pDfltPri_get(uint32 unit, rtk_port_t port, rtk_pri_t *pPri)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portOuter1pDfltPri_set(uint32 unit, rtk_port_t port, rtk_pri_t pri)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portOuter1pDfltPriExt_get(uint32 unit, uint32 srcUnit, rtk_port_t port, rtk_pri_t *pPri)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portOuter1pDfltPriExt_set(uint32 unit, uint32 srcUnit, rtk_port_t port, rtk_pri_t pri)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portDscpRemarkEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portDscpRemarkEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_dscpRemarking_get(uint32 unit, rtk_qos_dscpRmkSrc_t src, rtk_qos_dscpRmkVal_t val, uint32 *pDscp)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_dscpRemarking_set(uint32 unit, rtk_qos_dscpRmkSrc_t src, rtk_qos_dscpRmkVal_t val, uint32 dscp)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portDeiRemarkEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portDeiRemarkEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_deiRemarking_get(uint32 unit, rtk_qos_deiRmkSrc_t src, rtk_qos_deiRmkVal_t val, uint32 *pDei)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_deiRemarking_set(uint32 unit, rtk_qos_deiRmkSrc_t src, rtk_qos_deiRmkVal_t val, uint32 dei)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_deiRemarkSrcSel_get(uint32 unit, rtk_qos_deiRmkSrc_t * pType)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_deiRemarkSrcSel_set(uint32 unit, rtk_qos_deiRmkSrc_t type)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portOuter1pDfltPriSrcSelExt_get(uint32 unit, uint32 srcUnit, rtk_port_t port, rtk_qos_outer1pDfltSrc_t *pType)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portOuter1pDfltPriSrcSelExt_set(uint32 unit, uint32 srcUnit, rtk_port_t port, rtk_qos_outer1pDfltSrc_t type)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portCongAvoidAlgo_get(uint32 unit, rtk_port_t port, rtk_qos_congAvoidAlgo_t *pAlgo)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_portCongAvoidAlgo_set(uint32 unit, rtk_port_t port, rtk_qos_congAvoidAlgo_t algo)
{
    rtdrv_qosCfg_t qos_cfg;
...
int32 rtk_qos_congAvoidGlobalQueueConfig_get(
    uint32                      unit,
    rtk_qid_t                   queue,
    uint32                      dp,
    rtk_qos_congAvoidThresh_t   *pCongAvoidThresh)
...
int32 rtk_qos_congAvoidGlobalQueueConfig_set(
    uint32                      unit,
    rtk_qid_t                   queue,
    uint32                      dp,
    rtk_qos_congAvoidThresh_t   *pCongAvoidThresh)
...
int32 rtk_qos_portIgrQueueStrictEnable_get(uint32 unit, rtk_port_t port, rtk_qid_t queue, rtk_enable_t * pEnable)
{
    rtdrv_qosCfg_t qos_cfg;
    ...
    qos_cfg.port = port;
    qos_cfg.queue = queue;
    GETSOCKOPT(RTDRV_QOS_PORT_IGR_QUEUE_STRICT_ENABLE_GET, &qos_cfg, rtdrv_qosCfg_t, 1);
    *pEnable = qos_cfg.enable;

    return RT_ERR_OK;
}

int32 rtk_qos_portIgrQueueStrictEnable_set(uint32 unit, rtk_port_t port, rtk_qid_t queue, rtk_enable_t enable)
{
    rtdrv_qosCfg_t qos_cfg;
    ...
    qos_cfg.queue = queue;
    qos_cfg.enable = enable;
    SETSOCKOPT(RTDRV_QOS_PORT_IGR_QUEUE_STRICT_ENABLE_SET, &qos_cfg, rtdrv_qosCfg_t, 1);
