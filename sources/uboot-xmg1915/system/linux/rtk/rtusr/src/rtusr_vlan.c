 ...
 *
 * $Revision: 81250 $
 * $Date: 2017-08-15 11:10:58 +0800 (Tue, 15 Aug 2017) $
 *
...
int32 rtk_vlan_portPvid_get(uint32 unit, rtk_port_t port, rtk_vlanType_t type, uint32 *pPvid)
{
...
int32 rtk_vlan_portPvid_set(uint32 unit, rtk_port_t port, rtk_vlanType_t type, uint32 pvid)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portAcceptFrameType_get(uint32 unit, rtk_port_t port, rtk_vlanType_t type, rtk_vlan_acceptFrameType_t *pAccept_frame_type)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portAcceptFrameType_set(uint32 unit, rtk_port_t port, rtk_vlanType_t type, rtk_vlan_acceptFrameType_t accept_frame_type)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_l2LookupSvlFid_get(uint32 unit, rtk_vlan_l2mactype_t type, rtk_fid_t *pFid)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_l2LookupSvlFid_set(uint32 unit, rtk_vlan_l2mactype_t type, rtk_fid_t fid)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portIgrTpid_get(uint32 unit, rtk_port_t port, rtk_vlanType_t type,uint32 *pTpid_idx_mask)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portIgrTpid_set(uint32 unit, rtk_port_t port, rtk_vlanType_t type,uint32 tpid_idx_mask)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portEgrTpid_get(uint32 unit, rtk_port_t port, rtk_vlanType_t type, uint32 *pTpid_idx)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portEgrTpid_set(uint32 unit, rtk_port_t port, rtk_vlanType_t type, uint32 tpid_idx)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portEgrTpidSrc_get(uint32 unit, rtk_port_t port,rtk_vlanType_t type, rtk_vlan_egrTpidSrc_t *pTpid_src)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portEgrTpidSrc_set(uint32 unit, rtk_port_t port, rtk_vlanType_t type, rtk_vlan_egrTpidSrc_t tpid_src)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portIgrVlanTransparentEnable_get(
    uint32          unit,
    rtk_port_t      port,
    rtk_vlanType_t  type,
...
int32 rtk_vlan_portIgrVlanTransparentEnable_set(
    uint32          unit,
    rtk_port_t      port,
    rtk_vlanType_t  type,
    rtk_enable_t    enable)
...
int32 rtk_vlan_portEgrVlanTransparentEnable_get(
    uint32          unit,
    rtk_port_t      port,
    rtk_vlanType_t  type,
    rtk_enable_t    *pEnable)
...
int32 rtk_vlan_portEgrVlanTransparentEnable_set(
    uint32          unit,
    rtk_port_t      port,
    rtk_vlanType_t  type,
    rtk_enable_t    enable)
...
int32 rtk_vlan_l2LookupMode_get(uint32 unit, rtk_vlan_t vid, rtk_vlan_l2mactype_t macType, rtk_vlan_l2LookupMode_t *pMode)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_l2LookupMode_set(uint32 unit, rtk_vlan_t vid, rtk_vlan_l2mactype_t macType, rtk_vlan_l2LookupMode_t mode)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_groupMask_get(uint32 unit, rtk_vlan_t vid, rtk_vlan_groupMask_t *pGroupmask)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_groupMask_set(uint32 unit, rtk_vlan_t vid, rtk_vlan_groupMask_t *pGroupmask)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portFwdVlan_get(uint32 unit,rtk_port_t port,rtk_vlan_pktTagMode_t tagMode,rtk_vlanType_t *pVlanType)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portFwdVlan_set(uint32 unit,rtk_port_t port,rtk_vlan_pktTagMode_t tagMode,rtk_vlanType_t vlanType)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portPvidMode_get(uint32 unit, rtk_port_t port, rtk_vlanType_t type, rtk_vlan_pbVlan_mode_t *pMode)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portPvidMode_set(uint32 unit, rtk_port_t port, rtk_vlanType_t type, rtk_vlan_pbVlan_mode_t mode)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portMacBasedVlanEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portMacBasedVlanEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portIpSubnetBasedVlanEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portIpSubnetBasedVlanEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_tpidEntry_get(uint32 unit, rtk_vlan_tagType_t tagType, uint32 tpid_idx, uint32 *pTpid)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_tpidEntry_set(uint32 unit, rtk_vlan_tagType_t tagType, uint32 tpid_idx, uint32 tpid)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portEgrTagSts_get(uint32 unit, rtk_port_t port, rtk_vlanType_t type, rtk_vlan_tagSts_t *pSts)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portEgrTagSts_set(uint32 unit, rtk_port_t port, rtk_vlanType_t type, rtk_vlan_tagSts_t sts)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portIgrVlanCnvtLuMisAct_get(uint32 unit, rtk_port_t port,rtk_vlanType_t type,rtk_vlan_lookupMissAct_t *pAction)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portIgrVlanCnvtLuMisAct_set(uint32 unit,rtk_port_t port,rtk_vlanType_t type,rtk_vlan_lookupMissAct_t action)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portEgrVlanCnvtLuMisAct_get(uint32 unit, rtk_port_t port,rtk_vlanType_t type,rtk_vlan_lookupMissAct_t *pAction)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portEgrVlanCnvtLuMisAct_set(uint32 unit, rtk_port_t port,rtk_vlanType_t type,rtk_vlan_lookupMissAct_t action)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32
rtk_vlan_igrVlanCnvtRangeCheckEntry_get(uint32 unit, uint32 setIdx, uint32 index,
...
int32
rtk_vlan_igrVlanCnvtRangeCheckEntry_set(uint32 unit, uint32 setIdx, uint32 index,
    rtk_vlan_vlanCnvtRangeCheck_vid_t *pData)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32
rtk_vlan_egrVlanCnvtRangeCheckEntry_get(uint32 unit, uint32 setIdx, uint32 index,
    rtk_vlan_vlanCnvtRangeCheck_vid_t *pData)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32
rtk_vlan_egrVlanCnvtRangeCheckEntry_set(uint32 unit, uint32 setIdx, uint32 index,
    rtk_vlan_vlanCnvtRangeCheck_vid_t *pData)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_l2UcastLookupMode_get(uint32 unit, rtk_vlan_t vid, rtk_vlan_l2LookupMode_t *pMode)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_l2UcastLookupMode_set(uint32 unit, rtk_vlan_t vid, rtk_vlan_l2LookupMode_t mode)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_l2McastLookupMode_get(uint32 unit, rtk_vlan_t vid, rtk_vlan_l2LookupMode_t *pMode)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_l2McastLookupMode_set(uint32 unit, rtk_vlan_t vid, rtk_vlan_l2LookupMode_t mode)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portInnerAcceptFrameType_get(uint32 unit, rtk_port_t port, rtk_vlan_acceptFrameType_t *pAccept_frame_type)
{
...
int32 rtk_vlan_portInnerAcceptFrameType_set(uint32 unit, rtk_port_t port, rtk_vlan_acceptFrameType_t accept_frame_type)
{
    rtdrv_portCfg_t port_cfg;
...
int32 rtk_vlan_portInnerPvidMode_get(uint32 unit, rtk_port_t port, rtk_vlan_pbVlan_mode_t *pMode)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portInnerPvidMode_set(uint32 unit, rtk_port_t port, rtk_vlan_pbVlan_mode_t mode)
{
    rtdrv_vlanCfg_t vlan_cfg;
...
int32 rtk_vlan_portInnerPvid_get(uint32 unit, rtk_port_t port, uint32 *pPvid)
{
    rtdrv_portCfg_t port_cfg;
...
int32 rtk_vlan_portInnerPvid_set(uint32 unit, rtk_port_t port, uint32 pvid)
{
    rtdrv_portCfg_t port_cfg;
 ...
 *      rtk_vlan_bssid_add
 * Description:
 *      Add a BSSID to the specified VLAN for VLAN flooding.
 * Input:
 *      unit	- unit id
 *      vid     - vlan id
 *      bssid   - BSSID
 ...
 * Note:
 *      Before invoking this API, the corresponding BSSID entry must be created, refer to rtk_capwap_bssidEntry_add().
 ...
 */
int32
rtk_vlan_bssid_add(uint32 unit, rtk_vlan_t vid, rtk_mac_t *pBssid)
{
    rtdrv_vlanCfg_t cfg;
    ...
    osal_memcpy(&cfg.unit, &unit, sizeof(uint32));
    osal_memcpy(&cfg.vid, &vid, sizeof(rtk_vlan_t));
    osal_memcpy(&cfg.bssid, pBssid, sizeof(rtk_mac_t));
    SETSOCKOPT(RTDRV_VLAN_BSSID_ADD, &cfg, rtdrv_vlanCfg_t, 1);

    return RT_ERR_OK;
}   /* end of rtk_vlan_bssid_add */

/* Function Name:
 *      rtk_vlan_bssid_del
 * Description:
 *      Delete a BSSID from the specified VLAN.
 * Input:
 *      unit	- unit id
 *      vid     - vlan id
 *      bssid   - BSSID
 ...
 */
int32
rtk_vlan_bssid_del(uint32 unit, rtk_vlan_t vid, rtk_mac_t *pBssid)
{
    rtdrv_vlanCfg_t cfg;
    ...
    osal_memcpy(&cfg.vid, &vid, sizeof(rtk_vlan_t));
    osal_memcpy(&cfg.bssid, pBssid, sizeof(rtk_mac_t));
    SETSOCKOPT(RTDRV_VLAN_BSSID_DEL, &cfg, rtdrv_vlanCfg_t, 1);

    return RT_ERR_OK;
}   /* end of rtk_vlan_bssid_del */

/* Function Name:
 *      rtk_vlan_bssid_get
 * Description:
 *      Get all BSSIDs of the specified VLAN.
 * Input:
 *      unit	    - unit id
 *      vid         - vlan id
