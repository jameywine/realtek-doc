...
int32 rtk_flowctrl_init(uint32 unit)
{
...
int32 rtk_flowctrl_portPauseOnAction_get(
    uint32                          unit,
    rtk_port_t                      port,
...
int32 rtk_flowctrl_portPauseOnAction_set(
    uint32                          unit,
    rtk_port_t                      port,
...
int32 rtk_flowctrl_portPauseOnAllowedPageNum_get(uint32 unit, rtk_port_t port, uint32 *pPageNum)
{
    rtdrv_flowctrlCfg_t flowctrl_cfg;
...
int32 rtk_flowctrl_portPauseOnAllowedPageNum_set(uint32 unit, rtk_port_t port, uint32 pageNum)
{
    rtdrv_flowctrlCfg_t flowctrl_cfg;
...
int32 rtk_flowctrl_igrJumboSystemPauseThresh_get(uint32 unit, rtk_flowctrl_thresh_t *pThresh)
{
    rtdrv_flowctrlCfg_t flowctrl_cfg;
...
int32 rtk_flowctrl_igrJumboSystemPauseThresh_set(uint32 unit, rtk_flowctrl_thresh_t *pThresh)
{
    rtdrv_flowctrlCfg_t flowctrl_cfg;
...
int32 rtk_flowctrl_portIgrPortThreshGroupSel_get(uint32 unit, rtk_port_t port, uint32 *pGrp_idx)
{
    rtdrv_flowctrlCfg_t flowctrl_cfg;
...
int32 rtk_flowctrl_portIgrPortThreshGroupSel_set(uint32 unit, rtk_port_t port, uint32 grp_idx)
{
    rtdrv_flowctrlCfg_t flowctrl_cfg;
...
int32 rtk_flowctrl_igrJumboSystemCongestThresh_get(uint32 unit, rtk_flowctrl_thresh_t *pThresh)
{
    rtdrv_flowctrlCfg_t flowctrl_cfg;
...
int32 rtk_flowctrl_igrJumboSystemCongestThresh_set(uint32 unit, rtk_flowctrl_thresh_t *pThresh)
{
    rtdrv_flowctrlCfg_t flowctrl_cfg;
...
int32 rtk_flowctrl_portEgrDropRefCongestEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    rtdrv_flowctrlCfg_t flowctrl_cfg;
...
int32 rtk_flowctrl_portEgrDropRefCongestEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    rtdrv_flowctrlCfg_t flowctrl_cfg;
