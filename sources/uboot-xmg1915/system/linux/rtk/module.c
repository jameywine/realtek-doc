 ...
 *
 * $Revision: 81273 $
 * $Date: 2017-08-15 16:06:39 +0800 (Tue, 15 Aug 2017) $
 *
...
EXPORT_SYMBOL(rtk_l2_mcastAddrEcidPmsk_add);
EXPORT_SYMBOL(rtk_l2_mcastAddrEcidPmsk_del);
EXPORT_SYMBOL(rtk_l2_mcastAddrEcidPmsk_get);
EXPORT_SYMBOL(rtk_l2_mcastAddrEcidPmskNextValid_get);
...
EXPORT_SYMBOL(rtk_qos_portIgrQueueStrictEnable_get);
EXPORT_SYMBOL(rtk_qos_portIgrQueueStrictEnable_set);
...
EXPORT_SYMBOL(rtk_rate_portIgrQueueFixedBwCtrlEnable_get);
EXPORT_SYMBOL(rtk_rate_portIgrQueueFixedBwCtrlEnable_set);
...
EXPORT_SYMBOL(rtk_switch_tagPauseAction_get);
EXPORT_SYMBOL(rtk_switch_tagPauseAction_set);
EXPORT_SYMBOL(rtk_switch_halfConsecutiveRetryEnable_get);
EXPORT_SYMBOL(rtk_switch_halfConsecutiveRetryEnable_set);
...
EXPORT_SYMBOL(rtk_time_refTimeFreq_get);
EXPORT_SYMBOL(rtk_time_refTimeFreq_set);
...
EXPORT_SYMBOL(rtk_vlan_bssid_add);
EXPORT_SYMBOL(rtk_vlan_bssid_del);
EXPORT_SYMBOL(rtk_vlan_bssid_get);
...
EXPORT_SYMBOL(rtk_l3_intfStat_get);
...
EXPORT_SYMBOL(rtk_l3_ecmpHashTbl_get);
EXPORT_SYMBOL(rtk_l3_ecmpHashTbl_set);
EXPORT_SYMBOL(rtk_l3_ecmpCtrl_get);
EXPORT_SYMBOL(rtk_l3_ecmpCtrl_set);
...
EXPORT_SYMBOL(rtk_tunnel_intfStat_get);
...
EXPORT_SYMBOL(rtk_tunnel_intfCtrl_get);
EXPORT_SYMBOL(rtk_tunnel_intfCtrl_set);
...
/* CAPWAP */
EXPORT_SYMBOL(rtk_capwap_init);
EXPORT_SYMBOL(rtk_capwap_enable_get);
EXPORT_SYMBOL(rtk_capwap_enable_set);
EXPORT_SYMBOL(rtk_capwap_udpPort_get);
EXPORT_SYMBOL(rtk_capwap_udpPort_set);
EXPORT_SYMBOL(rtk_capwap_fwdAction_get);
EXPORT_SYMBOL(rtk_capwap_fwdAction_set);
EXPORT_SYMBOL(rtk_capwap_trapTarget_get);
EXPORT_SYMBOL(rtk_capwap_trapTarget_set);
EXPORT_SYMBOL(rtk_capwap_bssidTblHashAlgo_get);
EXPORT_SYMBOL(rtk_capwap_bssidTblHashAlgo_set);
EXPORT_SYMBOL(rtk_capwap_qosProfile_get);
EXPORT_SYMBOL(rtk_capwap_qosProfile_set);
EXPORT_SYMBOL(rtk_capwap_tidRemarking_get);
EXPORT_SYMBOL(rtk_capwap_tidRemarking_set);
EXPORT_SYMBOL(rtk_capwap_bssidEntry_add);
EXPORT_SYMBOL(rtk_capwap_bssidEntry_del);
EXPORT_SYMBOL(rtk_capwap_bssidEntry_get);
EXPORT_SYMBOL(rtk_capwap_bssidEntryNextValid_get);
EXPORT_SYMBOL(rtk_capwap_ucast_add);
EXPORT_SYMBOL(rtk_capwap_ucast_del);
EXPORT_SYMBOL(rtk_capwap_ucast_get);
EXPORT_SYMBOL(rtk_capwap_ucastNextValid_get);
EXPORT_SYMBOL(rtk_capwap_mcastNextValid_get);
EXPORT_SYMBOL(rtk_capwap_mcastBssid_add);
EXPORT_SYMBOL(rtk_capwap_mcastBssid_del);
EXPORT_SYMBOL(rtk_capwap_mcastBssid_get);
EXPORT_SYMBOL(rtk_capwap_bssidListNextValid_get);
#endif
...
EXPORT_SYMBOL(rtk_stack_unit_get);
EXPORT_SYMBOL(rtk_stack_unit_set);
EXPORT_SYMBOL(rtk_stack_masterUnit_get);
EXPORT_SYMBOL(rtk_stack_masterUnit_set);
EXPORT_SYMBOL(rtk_stack_loopGuard_get);
EXPORT_SYMBOL(rtk_stack_loopGuard_set);
EXPORT_SYMBOL(rtk_stack_unitPortMap_get);
EXPORT_SYMBOL(rtk_stack_unitPortMap_set);
...
EXPORT_SYMBOL(hal_stackPortStartEnd_get);
...
EXPORT_SYMBOL(rtk_masterLedEnable_set);
  ...
  EXPORT_SYMBOL(phy_8295r_rxCaliConf_set);
  EXPORT_SYMBOL(phy_8295r_rxCaliConf_get);
