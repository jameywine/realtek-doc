...
enum rtdrv_l2_set_e
{
    ...
    RTDRV_L2_MCASTADDRECIDPMSK_ADD,
    RTDRV_L2_MCASTADDRECIDPMSK_DEL,
};
...
enum rtdrv_l3_set_e
{
    ...
    RTDRV_L3_ECMP_ADD,
    RTDRV_L3_ECMP_DEL,
    RTDRV_L3_ECMPHASHTBL_SET,
    RTDRV_L3_ECMPCTRL_SET,
    RTDRV_L3_KEY_T_INIT,
...
typedef enum rtdrv_vlan_set_e
{
    ...
    RTDRV_VLAN_BSSID_ADD,
    RTDRV_VLAN_BSSID_DEL,
...
enum rtdrv_capwap_set_e
{
    RTDRV_CAPWAP_INIT = (RTDRV_BASE_CTL + RTDRV_CAPWAP_OFFSET),
    RTDRV_CAPWAP_ENABLE_SET,
    RTDRV_CAPWAP_UDPPORT_SET,
    RTDRV_CAPWAP_FWDACTION_SET,
    RTDRV_CAPWAP_TRAPTARGET_SET,
    RTDRV_CAPWAP_BSSIDTBLHASHALGO_SET,
    RTDRV_CAPWAP_QOSPROFILE_SET,
    RTDRV_CAPWAP_TIDREMARKING_SET,
    RTDRV_CAPWAP_BSSIDENTRY_ADD,
    RTDRV_CAPWAP_BSSIDENTRY_DEL,
    RTDRV_CAPWAP_UCAST_ADD,
    RTDRV_CAPWAP_UCAST_DEL,
    RTDRV_CAPWAP_MCAST_ADD,
    RTDRV_CAPWAP_MCAST_DEL,
    RTDRV_CAPWAP_MCASTBSSID_ADD,
    RTDRV_CAPWAP_MCASTBSSID_DEL,
};
...
enum rtdrv_qos_set_e
{
    ...
    RTDRV_QOS_PORT_IGR_QUEUE_STRICT_ENABLE_SET,
...
enum rtdrv_rate_set_e
{
    ...
    RTDRV_RATE_PORT_IGR_QUEUE_FIXED_BWCTRL_ENABLE_SET,
...
enum rtdrv_switch_set_e
{
    ...
    RTDRV_SWITCH_TAGPAUSEACTION_SET,
    RTDRV_SWITCH_HALF_CONSECUTIVE_RETRY_ENABLE_SET,
};
...
enum rtdrv_l2_get_e
{
    ...
    RTDRV_L2_MCASTADDRECIDPMSK_GET,
    RTDRV_L2_MCASTADDRECIDPMSKNEXTVALID_GET,
...
enum rtdrv_l3_get_e
{
    ...
    RTDRV_L3_INFO_GET,
    RTDRV_L3_INTF_GET,
    RTDRV_L3_INTFSTAT_GET,
    RTDRV_L3_NEXTHOP_GET,
    RTDRV_L3_NEXTHOPPATH_FIND,
    RTDRV_L3_ECMP_GET,
    RTDRV_L3_ECMP_FIND,
    RTDRV_L3_ECMPHASHTBL_GET,
    RTDRV_L3_ECMPCTRL_GET,
    RTDRV_L3_HOST_FIND,
...
enum rtdrv_capwap_get_e
{
    RTDRV_CAPWAP_ENABLE_GET = (RTDRV_BASE_CTL + RTDRV_CAPWAP_OFFSET),
    RTDRV_CAPWAP_UDPPORT_GET,
    RTDRV_CAPWAP_FWDACTION_GET,
    RTDRV_CAPWAP_TRAPTARGET_GET,
    RTDRV_CAPWAP_BSSIDTBLHASHALGO_GET,
    RTDRV_CAPWAP_QOSPROFILE_GET,
    RTDRV_CAPWAP_TIDREMARKING_GET,
    RTDRV_CAPWAP_BSSIDENTRY_GET,
    RTDRV_CAPWAP_BSSIDENTRYNEXTVALID_GET,
    RTDRV_CAPWAP_UCAST_GET,
    RTDRV_CAPWAP_UCASTNEXTVALID_GET,
    RTDRV_CAPWAP_MCAST_GET,
    RTDRV_CAPWAP_MCASTNEXTVALID_GET,
    RTDRV_CAPWAP_MCASTBSSID_GET,
    RTDRV_CAPWAP_BSSIDLISTNEXTVALID_GET,
};
...
enum rtdrv_qos_get_e
{
    ...
    RTDRV_QOS_PORT_IGR_QUEUE_STRICT_ENABLE_GET,
...
enum rtdrv_rate_get_e
{
    ...
    RTDRV_RATE_PORT_IGR_QUEUE_FIXED_BWCTRL_ENABLE_GET,
...
enum rtdrv_switch_get_e
{
    ...
    RTDRV_SWITCH_TAGPAUSEACTION_GET,
    RTDRV_SWITCH_HALF_CONSECUTIVE_RETRY_ENABLE_GET,
};
...
typedef struct rtdrv_l3Cfg_s
{
    ...
    rtk_l3_ecmpCtrlType_t           ecmpCtrlType;
...
typedef struct rtdrv_tunnelCfg_s
{
    ...
    rtk_intf_id_t                   intfId;
    rtk_tunnel_stat_t               stat;
    uint64                          value64;
    uint32                          idx;
    rtk_tunnel_qosProfile_t         profile;
    rtk_tunnel_globalCtrlType_t     type;
    int32                           arg;
    rtk_tunnel_intfCtrlType_t       intfType;
    rtk_tunnel_intfCtrlParam_t      intfArg;
} rtdrv_tunnelCfg_t;
...
typedef struct rtdrv_capwapCfg_s
{
    uint32                          unit;
    rtk_enable_t                    enable;
    uint32                          ctrl_port;
    uint32                          data_port;
    rtk_capwap_fwdPktType_t         type;
    rtk_action_t                    action;
    rtk_trapTarget_t                target;
    uint32                          algo;
    uint32                          index;
    rtk_capwap_qosProfile_t         profile;
    uint32                          dp;
    rtk_pri_t                       int_pri;
    uint32                          tid;
    rtk_capwap_bssidEntry_t         bssid_entry;
    int32                           scan_idx;
    rtk_capwap_ucast_t              ucast_entry;
    rtk_capwap_mcast_t              mcast_entry;
    rtk_capwap_mcastBssid_t         mcastBssid_entry;
    uint32                          arraySize;
    rtk_mac_t                       bssidArray;
    uint32                          bssidCnt;
    rtk_capwap_bssidList_t          bssidList_entry;
} rtdrv_capwapCfg_t;
...
typedef struct rtdrv_8295r_rxCaliConf_s
{
    uint32                      unit;
    uint32                      s1rxCaliDacLongCableOffset;
} rtdrv_8295r_rxCaliConf_t;
...
typedef struct rtdrv_l2EcidCfg_s
{
    uint32                 unit;
...
typedef union rtdrv_union_u
{
    ...
    rtdrv_8295r_rxCaliConf_t        rxCaliConf; /* 8295/8295R/8214QF */
