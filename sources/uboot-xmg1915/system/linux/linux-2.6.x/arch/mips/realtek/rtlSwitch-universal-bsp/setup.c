 ...
 *
 * $Revision: 77006 $
 * $Date: 2017-03-30 12:42:32 +0800 (Thu, 30 Mar 2017) $
 *
 */
...
void bsp_interrupt_irq_mapping_setup(void)
{
    ...
    {
        bsp_Interrupt_IRQ_Mapping_IP[index] = (unsigned int)((interrupt_mapping_conf_t *)(intr_mapping_table + index)->intr_src_id);
    }
}
