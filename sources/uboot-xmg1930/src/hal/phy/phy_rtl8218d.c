...
phy_8218d_rtctResult_get(uint32 unit, rtk_port_t port, rtk_rtctResult_t *pRtctResult)
{
    ...
    else
    {
        ...
        if ((ret = _phy_8218d_indr_read(unit, port, 0x802d, &phyData)) != RT_ERR_OK)
            return ret;
        pRtctResult->ge_result.channelALen = PHY_8218D_RTCT_LENGTH(phyData);

        if ((ret = _phy_8218d_indr_read(unit, port, 0x8031, &phyData)) != RT_ERR_OK)
            return ret;
        pRtctResult->ge_result.channelBLen = PHY_8218D_RTCT_LENGTH(phyData);

        if ((ret = _phy_8218d_indr_read(unit, port, 0x8035, &phyData)) != RT_ERR_OK)
            return ret;
        pRtctResult->ge_result.channelCLen = PHY_8218D_RTCT_LENGTH(phyData);

        if ((ret = _phy_8218d_indr_read(unit, port, 0x8039, &phyData)) != RT_ERR_OK)
            return ret;
        pRtctResult->ge_result.channelDLen = PHY_8218D_RTCT_LENGTH(phyData);
        ...
        if ((ret = _phy_8218d_rtctGeStatus_convert(phyData,
                                &pRtctResult->ge_result.channelAShort, &pRtctResult->ge_result.channelAOpen,
                                &pRtctResult->ge_result.channelAMismatch, &pRtctResult->ge_result.channelALinedriver,
                                &pRtctResult->ge_result.channelAHiImpedance, &pRtctResult->ge_result.channelACross,
                                &pRtctResult->ge_result.channelAPartialCross, &pRtctResult->ge_result.channelAPairBusy)) != RT_ERR_OK)
            return ret;
        ...
        if ((ret = _phy_8218d_rtctGeStatus_convert(phyData,
                                &pRtctResult->ge_result.channelBShort, &pRtctResult->ge_result.channelBOpen,
                                &pRtctResult->ge_result.channelBMismatch, &pRtctResult->ge_result.channelBLinedriver,
                                &pRtctResult->ge_result.channelBHiImpedance, &pRtctResult->ge_result.channelBCross,
                                &pRtctResult->ge_result.channelBPartialCross, &pRtctResult->ge_result.channelBPairBusy)) != RT_ERR_OK)
            return ret;
        ...
        if ((ret = _phy_8218d_rtctGeStatus_convert(phyData,
                                &pRtctResult->ge_result.channelCShort, &pRtctResult->ge_result.channelCOpen,
                                &pRtctResult->ge_result.channelCMismatch, &pRtctResult->ge_result.channelCLinedriver,
                                &pRtctResult->ge_result.channelCHiImpedance, &pRtctResult->ge_result.channelCCross,
                                &pRtctResult->ge_result.channelCPartialCross, &pRtctResult->ge_result.channelCPairBusy)) != RT_ERR_OK)
            return ret;
        ...
        if ((ret = _phy_8218d_rtctGeStatus_convert(phyData,
                                &pRtctResult->ge_result.channelDShort, &pRtctResult->ge_result.channelDOpen,
                                &pRtctResult->ge_result.channelDMismatch, &pRtctResult->ge_result.channelDLinedriver,
                                &pRtctResult->ge_result.channelDHiImpedance, &pRtctResult->ge_result.channelDCross,
                                &pRtctResult->ge_result.channelDPartialCross, &pRtctResult->ge_result.channelDPairBusy)) != RT_ERR_OK)
            return ret;
    }
