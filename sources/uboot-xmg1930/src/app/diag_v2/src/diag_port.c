 ...
 *
 * $Revision: 90658 $
 * $Date: 2018-07-24 15:28:19 +0800 (Tue, 24 Jul 2018) $
 *
 ...
 */
cparser_result_t cparser_cmd_port_set_phy_force_port_ports_all_ability_10h_10f_100h_100f_1000f_10000f(cparser_context_t *context,
    char **ports_ptr)
{
    uint32              unit = 0;
    int32               ret = RT_ERR_FAILED;
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        ...
        switch (media)
        {
            ...
            case PORT_10GMEDIA_FIBER_10G_1G_AUTO:
                diag_util_mprintf("fiber 10G/1G auto\n");
                break;
