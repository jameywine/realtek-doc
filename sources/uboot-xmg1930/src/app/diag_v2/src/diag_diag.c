    ...
    char **ports_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        ...
        if (rtctResult.linkType == PORT_SPEED_1000M)
        {
            ...
            if (rtctResult.ge_result.channelAHiImpedance)
                diag_util_printf("[HiImpedance]");
            if (rtctResult.ge_result.channelACross)
                diag_util_printf("[Cross]");
            if (rtctResult.ge_result.channelAPartialCross)
                diag_util_printf("[PartialCross]");
            if (rtctResult.ge_result.channelAPairBusy)
            ...
            if (!(rtctResult.ge_result.channelAShort | rtctResult.ge_result.channelAOpen |
                ...
                rtctResult.ge_result.channelAHiImpedance | rtctResult.ge_result.channelACross |
                rtctResult.ge_result.channelAPartialCross | rtctResult.ge_result.channelAPairBusy))
            ...
            if (rtctResult.ge_result.channelBLinedriver)
                diag_util_printf("[Linedriver]");
            if (rtctResult.ge_result.channelBHiImpedance)
                diag_util_printf("[HiImpedance]");
            if (rtctResult.ge_result.channelBCross)
                diag_util_printf("[Cross]");
            if (rtctResult.ge_result.channelBPartialCross)
                diag_util_printf("[PartialCross]");
            if (rtctResult.ge_result.channelBPairBusy)
                diag_util_printf("[PairBusy]");
            if (!(rtctResult.ge_result.channelBShort | rtctResult.ge_result.channelBOpen |
                ...
                rtctResult.ge_result.channelBHiImpedance | rtctResult.ge_result.channelBCross |
                rtctResult.ge_result.channelBPartialCross | rtctResult.ge_result.channelBPairBusy))
                diag_util_printf("[Normal]");
            diag_util_printf("\n");
            ...
            if (rtctResult.ge_result.channelCLinedriver)
                diag_util_printf("[Linedriver]");
            if (rtctResult.ge_result.channelCHiImpedance)
                diag_util_printf("[HiImpedance]");
            if (rtctResult.ge_result.channelCCross)
                diag_util_printf("[Cross]");
            if (rtctResult.ge_result.channelCPartialCross)
                diag_util_printf("[PartialCross]");
            if (rtctResult.ge_result.channelCPairBusy)
                diag_util_printf("[PairBusy]");
            if (!(rtctResult.ge_result.channelCShort | rtctResult.ge_result.channelCOpen |
                ...
                rtctResult.ge_result.channelCHiImpedance | rtctResult.ge_result.channelCCross |
                rtctResult.ge_result.channelCPartialCross | rtctResult.ge_result.channelCPairBusy))
                diag_util_printf("[Normal]");
            diag_util_printf("\n");
            ...
            if (rtctResult.ge_result.channelDLinedriver)
                diag_util_printf("[Linedriver]");
            if (rtctResult.ge_result.channelDHiImpedance)
                diag_util_printf("[HiImpedance]");
            if (rtctResult.ge_result.channelDCross)
                diag_util_printf("[Cross]");
            if (rtctResult.ge_result.channelDPartialCross)
                diag_util_printf("[PartialCross]");
            if (rtctResult.ge_result.channelDPairBusy)
                diag_util_printf("[PairBusy]");
            if (!(rtctResult.ge_result.channelDShort | rtctResult.ge_result.channelDOpen |
                ...
                rtctResult.ge_result.channelDHiImpedance | rtctResult.ge_result.channelDCross |
                rtctResult.ge_result.channelDPartialCross | rtctResult.ge_result.channelDPairBusy))
                diag_util_printf("[Normal]");
            diag_util_printf("\n");
