 ...
 *
 * $Revision: 94589 $
 * $Date: 2019-01-03 15:25:08 +0800 (Thu, 03 Jan 2019) $
 *
 ...
 *      None
 */
void _dal_mango_construct_phyReset(uint32 unit)
{
    CNSTRT_PRINT("%s()\n", __func__);

    return;
}   /* end of _dal_mango_construct_phyReset */
...
_dal_mango_construct_sdsMode_set(uint32 unit, uint32 sds, rtk_serdesMode_t mode)
{
    ...
    uint32  board_sds_tx[] = {0x1380, 0x1380, 0x200, 0x200, 0x200,
...
void dal_mango_construct_serdesConfig_init(uint32 unit)
{
    ...
    HWP_SDS_TRAVS(unit, sds)
    {
        ...
        phy_rtl9310_sdsCustConfig_init(unit, sds);
    }
