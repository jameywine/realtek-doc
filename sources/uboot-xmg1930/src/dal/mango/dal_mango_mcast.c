 ...
 *
 * $Revision: 90261 $
 * $Date: 2018-07-09 10:29:45 +0800 (Mon, 09 Jul 2018) $
 *
...
_dal_mango_mcast_ipEgrIfL2_del(uint32 unit, dal_mango_mcast_group_t *pGroup, rtk_mcast_egrif_t *pEgrIf)
{
    ...
    {
        MANGO_MCAST_DBG_PRINTF(2, "[DBG] needFreeL2PmskIdx = TRUE, pGroup->ipmc_bind = %d\n", pGroup->ip.ipmc_bind);
 ...
 */
int32
_dal_mango_mcast_ipmc_unbind(uint32 unit, rtk_mcast_group_t groupId, uint32 *pEntryIdx)
{
    int32   ret = RT_ERR_OK;
    rtk_mcast_type_t    groupType = DAL_MANGO_MCAST_GROUP_ID_TYPE(groupId);
    int32               groupIdx = DAL_MANGO_MCAST_GROUP_ID_IDX(groupId);
