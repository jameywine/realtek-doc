 ...
 *
 * $Revision: 94847 $
 * $Date: 2019-01-16 11:19:31 +0800 (Wed, 16 Jan 2019) $
 *
...
typedef struct rtk_l3_intf_stats_s
{
    ...
    struct {
        ...
        uint32  unicast_pkts;           /* Packet count of unicast packets at incoming */
        uint32  multicast_pkts;         /* Packet count of multicast packets at incoming */
        uint32  broadcast_pkts;         /* Packet count of broadcast packets at incoming */
        uint32  discards;               /* Packet count of discarded packets at incoming */
    } rx;

    /* TX */
    struct {
        uint64  octets;                 /* Byte count of packets at outgoing */
        uint32  unicast_pkts;           /* Packet count of unicast packets at outgoing */
        uint32  multicast_pkts;         /* Packet count of multicast packets at outgoing */
        uint32  broadcast_pkts;         /* Packet count of broadcast packets at outgoing */
        uint32  discards;               /* Packet count of discarded packets at outgoing */
    } tx;
} rtk_l3_intf_stats_t;
