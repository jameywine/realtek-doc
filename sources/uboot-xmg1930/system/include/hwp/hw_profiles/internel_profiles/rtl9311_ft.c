 ...
 * 48 + 6*10G mode
 */
static hwp_swDescp_t rtl9311_ft_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id = 16, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 2,       .phy_idx = 2,        .smi = 1,        .phy_addr = 0,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 17, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 2,       .phy_idx = 2,        .smi = 1,        .phy_addr = 1,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 18, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 2,       .phy_idx = 2,        .smi = 1,        .phy_addr = 2,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 19, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 2,       .phy_idx = 2,        .smi = 1,        .phy_addr = 3,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 20, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 2,       .phy_idx = 2,        .smi = 1,        .phy_addr = 4,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 21, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 2,       .phy_idx = 2,        .smi = 1,        .phy_addr = 5,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 22, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 2,       .phy_idx = 2,        .smi = 1,        .phy_addr = 6,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 23, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 2,       .phy_idx = 2,        .smi = 1,        .phy_addr = 7,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 24, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 3,       .phy_idx = 3,        .smi = 1,        .phy_addr = 8,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 25, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 3,       .phy_idx = 3,        .smi = 1,        .phy_addr = 9,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 26, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 3,       .phy_idx = 3,        .smi = 1,        .phy_addr = 10,       .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 27, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 3,       .phy_idx = 3,        .smi = 1,        .phy_addr = 11,       .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 28, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 3,       .phy_idx = 3,        .smi = 1,        .phy_addr = 12,       .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 29, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 3,       .phy_idx = 3,        .smi = 1,        .phy_addr = 13,       .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 30, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 3,       .phy_idx = 3,        .smi = 1,        .phy_addr = 14,       .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 31, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 3,       .phy_idx = 3,        .smi = 1,        .phy_addr = 15,       .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 32, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 4,       .phy_idx = 4,        .smi = 2,        .phy_addr = 0,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 33, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 4,       .phy_idx = 4,        .smi = 2,        .phy_addr = 1,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 34, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 4,       .phy_idx = 4,        .smi = 2,        .phy_addr = 2,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 35, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 4,       .phy_idx = 4,        .smi = 2,        .phy_addr = 3,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 36, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 4,       .phy_idx = 4,        .smi = 2,        .phy_addr = 4,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 37, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 4,       .phy_idx = 4,        .smi = 2,        .phy_addr = 5,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 38, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 4,       .phy_idx = 4,        .smi = 2,        .phy_addr = 6,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 39, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 4,       .phy_idx = 4,        .smi = 2,        .phy_addr = 7,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 40, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 5,       .phy_idx = 5,        .smi = 2,        .phy_addr = 8,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 41, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 5,       .phy_idx = 5,        .smi = 2,        .phy_addr = 9,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 42, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 5,       .phy_idx = 5,        .smi = 2,        .phy_addr = 10,       .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 43, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 5,       .phy_idx = 5,        .smi = 2,        .phy_addr = 11,       .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 44, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 5,       .phy_idx = 5,        .smi = 2,        .phy_addr = 12,       .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 45, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 5,       .phy_idx = 5,        .smi = 2,        .phy_addr = 13,       .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 46, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 5,       .phy_idx = 5,        .smi = 2,        .phy_addr = 14,       .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 47, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER,  .sds_idx = 5,       .phy_idx = 5,        .smi = 2,        .phy_addr = 15,       .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9311_ft = {
    .identifier.name        = "RTL9311_FT",
    .identifier.id          = HWP_RTL9311_FT,
