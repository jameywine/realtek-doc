...
norsf_g2_info_t norsf_mx25v1635f_info SECTION_NOR_SPIF_GEN2_PARAM = {
    .num_chips       = 1,
    .sec_sz_b        = 4*1024,   /* Set to the sector size for UBoot or Linux */
    .size_per_chip_b = 2*1024*1024, /* Set to 0 for auto-size detection. */
    .addr_mode       = norsf_3b_addr,
    .arch_wip        = norsf_cmn_arch_wip,
    .arch_erase      = norsf_cmn_arch_erase,
    .arch_read       = norsf_cmn_arch_read,
...
norsf_g2_info_t *norsf_mxic_probe(void) {
	...
	case 0xC2201A:
		...
		break;
    case 0xC22315: /*mx25v1635F 2MB*/
        res = &norsf_mx25v1635f_info;
		break;
    default:
        break;
    }
