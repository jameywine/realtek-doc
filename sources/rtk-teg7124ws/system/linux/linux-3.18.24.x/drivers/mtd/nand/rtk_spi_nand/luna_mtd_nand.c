...
extern void add_recovery_mtd_part(void);
...
static struct mtd_partition rtk_nand_128M_parts[] = {
    { name: "ubifs",      offset: 0,          size: 0x4000000,  mask_flags:0},
    { name: "runtime1",   offset: 0x4000000,  size: 0x1E00000,  mask_flags:0},
    { name: "runtime2",   offset: 0x5E00000,  size: 0x1E00000,  mask_flags:0},
};
...
/*SENAO: 2M SPI-NOR add JFFS2 partition for config recovery*/
#ifdef CONFIG_SENAO_FLASH_LAYOUT_TYPE5_JFFS2_CFG_RECOVERY
    add_recovery_mtd_part();
#endif /*CONFIG_SENAO_FLASH_LAYOUT_TYPE5_JFFS2_CFG_RECOVERY*/
