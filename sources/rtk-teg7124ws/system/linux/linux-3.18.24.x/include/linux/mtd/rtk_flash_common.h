...
#define RTK_MTD_PARTITION_NUM           3
#define RTK_MTD_PARTITION_NUM_RESCUE    6
#else
...
struct rtk_partition_info_t{
    ...
    unsigned int  rescue_jffs2_cfg_offset;
    unsigned int  rescue_jffs2_cfg_size;
    unsigned int  rescue_jffs2_log_offset;
    unsigned int  rescue_jffs2_log_size;
    unsigned int  rescue_kernel_offset;
    unsigned int  rescue_kernel_size;
