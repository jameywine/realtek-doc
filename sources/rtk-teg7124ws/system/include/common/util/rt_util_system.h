...
#define EXT_BOARD_PROBE_PIN_NUMBER          6
#define BOARD_PROBE_PIN_MAX_NUMBER          6      /*The current maximum pin number is 6.*/
...
#define HWP_GPIO_ADDRESS_INIT_CNT           16
#endif

#define ENV_PARAMETER_LEN                   1024*8
 ...
 */
    ...
    typedef struct board_probe_advgpio_e
    {
        int                        total_gpio;
        board_probe_gpio_pin_t     pin[BOARD_PROBE_PIN_MAX_NUMBER];
    }board_probe_advgpio_t;
...
extern int32 rt_util_boardID_ADVGPIO_get(uint32 *pPinValue, uint8 type , uint32 family_id);
 ...
 *    None
 */
extern int32  rt_util_GPIO_init(int);
