...
int32 drv_software_i2c_sequential_nbyte_read(uint32 mAddrs, uint8 *pRdata, uint32 dev);
int32 drv_software_i2c_nbyte_write(uint32 mAddrs, uint8 *pWdata, uint32 dev);
// Starry@20211007 Add POE MCU FW -#
