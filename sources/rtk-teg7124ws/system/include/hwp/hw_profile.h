...
/* PHY auto selection related definitions */
#define PHY_STANDARD_PAGE                               0x0
#define PHY_STANDARD_REG_PHYID1                         0x2
#define PHY_STANDARD_REG_PHYID2                         0x3
#define RTL8218_PHYID1                                  0x001c
#define RTL8218B_PHYID2                                 0xc981
#define RTL8218D_PHYID2                                 0xc983
#define RTL8218E_PHYID2                                 0xc984

enum PHY_CHIP_RTL8218_NAME
{
    PHY_CHIP_RTL8218D = 0,
    PHY_CHIP_RTL8218E = 1,
    PHY_CHIP_RTL8218_NAME_END
};

#define EXT_GPIO_TEST 1
#define HWP_SENAO_INTERNAL_GPIO 0
#define HWP_SENAO_EXTERNAL_GPIO 1
/*
...
typedef enum hwp_id_e
{
    ...
    HWP_RTL9302C_2xGPY2xx_2XGE_1LED, // Starry@20210813 for SQX10 one LED 2 Color
    HWP_RTL9302C_1x8221B_1xGPY2xx,
    HWP_DTS_RTL9301_3x8218D_4XGE,
    HWP_DTS_RTL9302C_2xGPY2xx_2XGE,
    HWP_DTS_RTL9302C_2xGPY2xx_2XGE_1LED,
    HWP_RTL9302B_2x8218D_2x8224_4XGE, /* Starry@20221130 for SGQX28 */
...
typedef struct hwp_idmapping_s
{
    char    broadmodel[HWP_PROFILE_NAME_LEN_MAX];
    int     id;
}hwp_idmapping_t;
