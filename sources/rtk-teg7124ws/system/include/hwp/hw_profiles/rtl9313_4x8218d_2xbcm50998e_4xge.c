...
static hwp_swDescp_t rtl9313_4x8218d_2xbcm50998e_4xge_swDescp = {
    ...
    .phy.descp = {
        ...
        [4] = { .chip = RTK_PHYTYPE_CUST1, .mac_id = 32,.phy_max = 8 },
        [5] = { .chip = RTK_PHYTYPE_CUST1, .mac_id = 40,.phy_max = 8 },
        [6] = { .chip = HWP_END },
    }   /* .phy.descp */
};
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9313_4x8218d_2xbcm50998e_4xge = {
    .identifier.name        = "RTL9313_4x8218D_2xBCM50998E_4XGE",
    .identifier.id          = HWP_RTL9313_4x8218D_2xBCM50998E_4XGE,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9313_4x8218d_2xbcm50998e_4xge_swDescp,
    }
