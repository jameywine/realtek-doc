 ...
 *
 * Feature : RTL9302C  8×2.5G + 2×10G Fiber RTL9302C*1(RTL9302C + 2*BCM50998)
 *
 */

static hwp_swDescp_t rtl9302c_2xbcm50998_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id =  8, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds_idx = 1, .phy_idx = 0,        .smi = 0,        .phy_addr =  4,        .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,},
        { .mac_id =  9, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds_idx = 1, .phy_idx = 0,        .smi = 0,        .phy_addr =  5,        .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,},
        { .mac_id = 10, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds_idx = 1, .phy_idx = 0,        .smi = 0,        .phy_addr =  6,        .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,},
        { .mac_id = 11, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds_idx = 1, .phy_idx = 0,        .smi = 0,        .phy_addr =  7,        .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,},
        { .mac_id = 24, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_SERDES, .sds_idx = 2, .phy_idx = HWP_NONE, .smi = HWP_NONE, .phy_addr = HWP_NONE,  .led_c = 1,        .led_f = 1,       .led_layout = SINGLE_SET,},
        { .mac_id = 25, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_SERDES, .sds_idx = 3, .phy_idx = HWP_NONE, .smi = HWP_NONE, .phy_addr = HWP_NONE,  .led_c = 1,        .led_f = 1,       .led_layout = SINGLE_SET,},
        { .mac_id = 26, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_SERDES, .sds_idx = 4, .phy_idx = HWP_NONE, .smi = HWP_NONE, .phy_addr = HWP_NONE,  .led_c = 1,        .led_f = 1,       .led_layout = SINGLE_SET,},
        { .mac_id = 27, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_SERDES, .sds_idx = 5, .phy_idx = HWP_NONE, .smi = HWP_NONE, .phy_addr = HWP_NONE,  .led_c = 1,        .led_f = 1,       .led_layout = SINGLE_SET,},
    ...
    .phy.descp = {
        [0] = { .chip = RTK_PHYTYPE_CUST1 , .mac_id = 0,  .phy_max = 12 },
        [1] = { .chip = HWP_END },
    },   /* .phy.descp */
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9302c_2xbcm50998 = {

    .identifier.name        = "RTL9302C_2xBCM50998",
    .identifier.id          = HWP_RTL9302C_2xBCM50998,
