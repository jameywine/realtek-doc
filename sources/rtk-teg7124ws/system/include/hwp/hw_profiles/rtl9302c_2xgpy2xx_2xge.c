...
static hwp_swDescp_t rtl9302c_2xgpy2xx_2xge_swDescp = {
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9302c_2xgpy2xx_2xge = {

    .identifier.name        = "RTL9302C_2xGPY2xx_2XGE",
    .identifier.id          = HWP_RTL9302C_2xGPY2xx_2XGE,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9302c_2xgpy2xx_2xge_swDescp,
    }

};

static hwp_hwProfile_t DTS_rtl9302c_2xgpy2xx_2xge = {
    .identifier.name        = "DTS_RTL9302C_2xGPY2xx_2XGE",
    .identifier.id          = HWP_DTS_RTL9302C_2xGPY2xx_2XGE,
