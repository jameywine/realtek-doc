...
static hwp_swDescp_t rtl9302b_2x8218d_2xbcm50998e_4xge_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id = 16, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds_idx = 2, .phy_idx = 2,        .smi = 2,        .phy_addr =  0,        .led_c = 1,        .led_f = 1,.led_layout = SINGLE_SET,},
        { .mac_id = 17, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds_idx = 2, .phy_idx = 2,        .smi = 2,        .phy_addr =  1,        .led_c = 1,        .led_f = 1,.led_layout = SINGLE_SET,},
        { .mac_id = 18, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds_idx = 2, .phy_idx = 2,        .smi = 2,        .phy_addr =  2,        .led_c = 1,        .led_f = 1,.led_layout = SINGLE_SET,},
        { .mac_id = 19, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds_idx = 2, .phy_idx = 2,        .smi = 2,        .phy_addr =  3,        .led_c = 1,        .led_f = 1,.led_layout = SINGLE_SET,},
        { .mac_id = 20, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds_idx = 3, .phy_idx = 2,        .smi = 2,        .phy_addr =  4,        .led_c = 1,        .led_f = 1,.led_layout = SINGLE_SET,},
        { .mac_id = 21, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds_idx = 3, .phy_idx = 2,        .smi = 2,        .phy_addr =  5,        .led_c = 1,        .led_f = 1,.led_layout = SINGLE_SET,},
        { .mac_id = 22, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds_idx = 3, .phy_idx = 2,        .smi = 2,        .phy_addr =  6,        .led_c = 1,        .led_f = 1,.led_layout = SINGLE_SET,},
        { .mac_id = 23, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds_idx = 3, .phy_idx = 2,        .smi = 2,        .phy_addr =  7,        .led_c = 1,        .led_f = 1,.led_layout = SINGLE_SET,},
    ...
    .phy.descp = {
        ...
        [2] = { .chip = RTK_PHYTYPE_CUST1,          .mac_id = 16, .phy_max = 8 },
		[3] = { .chip = HWP_END },
    },   /* .phy.descp */
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9302b_2x8218d_2xbcm50998e_4xge = {

    .identifier.name        = "RTL9302B_2x8218D_2xBCM50998E_4XGE",
    .identifier.id          = HWP_RTL9302B_2x8218D_2xBCM50998E_4XGE,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9302b_2x8218d_2xbcm50998e_4xge_swDescp,
    }
