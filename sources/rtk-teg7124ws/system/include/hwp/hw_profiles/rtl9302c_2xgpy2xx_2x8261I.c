 ...
 *
 * Feature : RTL9302C  8x2.5G + 2×10G Copper RTL9302C*1(RTL9302C + 2*GPY2xx + 2*RTL8261I)
 *
 */

static hwp_swDescp_t rtl9302c_2xgpy2xx_2x8261I_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id = 24, .attr = HWP_ETH, .eth = HWP_XGE,   .medi = HWP_COPPER, .sds_idx = 2,        .phy_idx = 2,        .smi = 1,        .phy_addr =  12,       .led_c = 1,        .led_f = 1,        .led_layout = SINGLE_SET,},
        { .mac_id = 25, .attr = HWP_ETH, .eth = HWP_XGE,   .medi = HWP_COPPER, .sds_idx = 3,        .phy_idx = 3,        .smi = 1,        .phy_addr =  13,       .led_c = 1,        .led_f = 1,        .led_layout = SINGLE_SET,},
    ...
    .phy.descp = {
        ...
        [2] = { .chip = RTK_PHYTYPE_RTL8261I, .mac_id = 24, .phy_max = 1 },
        [3] = { .chip = RTK_PHYTYPE_RTL8261I, .mac_id = 25, .phy_max = 1 },
        [4] = { .chip = HWP_END },
    },   /* .phy.descp */
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9302c_2xgpy2xx_2x8261I = {

    .identifier.name        = "RTL9302C_2xGPY2xx_2x8261I",
    .identifier.id          = HWP_RTL9302C_2xGPY2xx_2x8261I,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9302c_2xgpy2xx_2x8261I_swDescp,
    }
