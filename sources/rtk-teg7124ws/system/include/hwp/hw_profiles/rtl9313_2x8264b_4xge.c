...
static hwp_swDescp_t rtl9313_2x8264b_4xge_swDescp = {
    ...
    .port.descp = {
        { .mac_id =  0, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_COPPER, .sds_idx = 0,  .phy_idx = 0,        .smi = 0,        .phy_addr =  0,        .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,     .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0  },
        { .mac_id =  8, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_COPPER, .sds_idx = 1,  .phy_idx = 0,        .smi = 0,        .phy_addr =  1,        .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,     .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0  },
        { .mac_id = 16, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_COPPER, .sds_idx = 2,  .phy_idx = 0,        .smi = 0,        .phy_addr =  2,        .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,     .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0  },
        { .mac_id = 24, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_COPPER, .sds_idx = 3,  .phy_idx = 0,        .smi = 0,        .phy_addr =  3,        .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,     .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0  },
        { .mac_id = 32, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_COPPER, .sds_idx = 4,  .phy_idx = 1,        .smi = 1,        .phy_addr =  4,        .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,     .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0  },
        { .mac_id = 40, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_COPPER, .sds_idx = 5,  .phy_idx = 1,        .smi = 1,        .phy_addr =  5,        .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,     .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0  },
        { .mac_id = 48, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_COPPER, .sds_idx = 6,  .phy_idx = 1,        .smi = 1,        .phy_addr =  6,        .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,     .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0  },
        { .mac_id = 50, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_COPPER, .sds_idx = 7,  .phy_idx = 1,        .smi = 1,        .phy_addr =  7,        .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,     .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0  },
    ...
    .led.descp = {
        ...
        /* For Coper Port*/
        .led_definition_set[0].led[0] = 0x2A0,        /* 100M 1000M link*/
        .led_definition_set[0].led[1] = 0x20B,        /* 2.5G 5G 10G link*/
        .led_definition_set[0].led[2] = 0xAAB,        /* 10G/5G/2.5G/1000M/100M link act */
        .led_definition_set[0].led[3] = HWP_LED_END,  /* None */
        .led_definition_set[0].led[4] = HWP_LED_END,  /* None */
        /* For Fiber Port*/
        .led_definition_set[1].led[0] = 0x220,        /* 10G link*/
        .led_definition_set[1].led[1] = 0x201,        /* 1000M link*/
        .led_definition_set[1].led[2] = 0xAAB,        /* 10G/5G/2.5G/1000M/100M link act */
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9313_2x8264b_4xge = {

    .identifier.name        = "RTL9313_2x8264B_4XGE",
    .identifier.id          = HWP_RTL9313_2x8264B_4XGE,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9313_2x8264b_4xge_swDescp,
    }
