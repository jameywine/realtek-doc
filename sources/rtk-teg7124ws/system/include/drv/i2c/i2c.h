...
typedef enum drv_i2c_interface_e
{
    ...
    // Starry@20211007 Add POE MCU FW -S
    I2C_INTF_SOFTWARE_WRITEE_MCU_UPGRADE, /* GPIO simulates the I2C interface for PoE MCU Upgrade*/
    // Starry@20211007 Add POE MCU FW -E    
    I2C_INTF_END
...
typedef enum drv_i2c_read_type_e
{
    ...
    // Starry@20211007 Add POE MCU FW -S
    I2C_INTF_READ_TYPE_MCU_UPGRADE,     /* Use Sequential Read for PoE MCU Upgrade*/
    // Starry@20211007 Add POE MCU FW -E
...
// Starry@20211009  -S
int32 drv_i2c_dev_addr_update  (uint32 unit, uint32 dev, int32 dev_addr);
// Starry@20211009  -E
