...
#ifndef __HWP_INIT_C__
#define __HWP_INIT_C__
...
#if defined(CONFIG_SDK_PHY_CUST1) || defined(CONFIG_SDK_PHY_GPY2xx)
...
#if defined(CONFIG_SDK_PHY_CUST1) || defined(CONFIG_SDK_PHY_GPY2xx)
phyp_senao_phy_info_t *senao_non_rtl_phy_info=NULL;
uint32                 phy_board_type = RHY_BOARD_TYPE_END;
#endif
...
#if defined(CONFIG_SDK_PHY_CUST1) || defined(CONFIG_SDK_PHY_GPY2xx)
    char    MagicNumberString[HWP_PROFILE_NAME_LEN_MAX];
    int32   ret = RT_ERR_FAILED;

    memset(MagicNumberString,0,sizeof(MagicNumberString));
#endif
    /* init var. */
    for(i = 0; i < p->sw_count; i++)
    {
        ...
        if (RT_ERR_OK != (ret = rt_util_flashEnv_get("magic_number", MagicNumberString, HWP_PROFILE_NAME_LEN_MAX)))
            return RT_ERR_FAILED;

        if(strcmp(MagicNumberString, "0x83024005") == 0 || /*ECS2512*/ 
           strcmp(MagicNumberString, "0x83024205") == 0 || /*ECS2512FP*/
           strcmp(MagicNumberString, "0x93020000") == 0 || /*EWS2512*/
           strcmp(MagicNumberString, "0x93020001") == 0 || /*EWS2512FP*/
           strcmp(MagicNumberString, "0x05010003") == 0 || /*SWS22-08*/
           strcmp(MagicNumberString, "0x05010004") == 0 || /*SWS22-08FPOE*/
           strcmp(MagicNumberString, "0x00040000") == 0 || /*SQX12*/
           strcmp(MagicNumberString, "0x00040001") == 0 || /*SQX12SP*/
           strcmp(MagicNumberString, "0x06010004") == 0 || /*CS210-8FP*/
           strcmp(MagicNumberString, "0x09010003") == 0 || /*BSH-25G08*/
           strcmp(MagicNumberString, "0x07010003") == 0 || /*SGS2512*/
           strcmp(MagicNumberString, "0x07010004") == 0 || /*SGS2512FP*/
           strcmp(MagicNumberString, "0x07020011") == 0    /*SGS5512F*/)
        {
            senao_non_rtl_phy_info = &senao_phy_info[0];
            phy_board_type = RTL9302C_BCM50998_BOARD_TYPE_1;

        }
        else if(strcmp(MagicNumberString, "0x83024006") == 0 || /*ECS5512*/
                strcmp(MagicNumberString, "0x83024206") == 0 || /*ECS5512FP*/
                strcmp(MagicNumberString, "0x93130000") == 0 || /*EWS5512*/
                strcmp(MagicNumberString, "0x93130001") == 0 || /*EWS5512FP*/
                strcmp(MagicNumberString, "0x05020003") == 0 || /*SWS32-08*/
                strcmp(MagicNumberString, "0x05020004") == 0 || /*SWS32-08FPOE*/
                strcmp(MagicNumberString, "0x00032003") == 0 || /*SMX12*/
                strcmp(MagicNumberString, "0x60520003") == 0 || /*TEG-7124WS*/
                strcmp(MagicNumberString, "0x08020004") == 0 || /*FXCX5512*/
                strcmp(MagicNumberString, "0x08020005") == 0 || /*FXCX5512PE*/
                strcmp(MagicNumberString, "0x09020004") == 0 || /*BSH-100G08*/
                strcmp(MagicNumberString, "0x07020004") == 0 || /*SGS5512*/
                strcmp(MagicNumberString, "0x07020005") == 0    /*SGS5512FP*/)
        {
            senao_non_rtl_phy_info = &senao_phy_info[1];
            phy_board_type = RTL9313_BCM84898_BOARD_TYPE_1;
        }
        else if(strcmp(MagicNumberString, "0x06020006") == 0 || /*CS210-48FP*/
                strcmp(MagicNumberString, "0x83022606") == 0 || /*ECS2552FP*/
                strcmp(MagicNumberString, "0x93130002") == 0 || /*EWS2552FP*/
                strcmp(MagicNumberString, "0x07020007") == 0    /*SGS2552FP*/)
        {
            senao_non_rtl_phy_info = &senao_phy_info[2];
            phy_board_type = RTL9313_BCM50998_BOARD_TYPE_1;
	    }
        else if(strcmp(MagicNumberString, "0x06010006") == 0 || /*CS210-24FP*/
                strcmp(MagicNumberString, "0x83021605") == 0 || /*ECS2528FP*/
                strcmp(MagicNumberString, "0x93020002") == 0 || /*EWS2528FP*/
                strcmp(MagicNumberString, "0x07010013") == 0    /*SGS2528FP*/)   
        {
            senao_non_rtl_phy_info = &senao_phy_info[3];
            phy_board_type = RTL9302B_BCM50998_BOARD_TYPE_1;
	    }
#endif
        ...
        if(strcmp(MagicNumberString, "0x83026005") == 0 || /*ECS2605*/
           strcmp(MagicNumberString, "0x07010009") == 0 || /*SGS2605*/
            strcmp(MagicNumberString, "0x83026905") == 0   /*ECS2205PD*/)
        {
            senao_non_rtl_phy_info = &senao_phy_info[4];
            phy_board_type = RTL9302C_GPY2xx_BOARD_TYPE_1;
        }
        // Starry@20210621 Add for Gpy -S
        else if(strcmp(MagicNumberString, "0x00042005") == 0 || /*SQX10-T*/
				strcmp(MagicNumberString, "0x00042002") == 0 || /*SQX10SP*/
				strcmp(MagicNumberString, "0x00042004") == 0 || /*SQX10*/
				strcmp(MagicNumberString, "0x60520004") == 0 || /*TEG-3102WS*/
                strcmp(MagicNumberString, "0x60520005") == 0 || /*TPE-3102WS*/
                strcmp(MagicNumberString, "0x83020205") == 0 || /*ECS2510FP*/
                strcmp(MagicNumberString, "0x83020005") == 0 || /*ECS2510*/
                strcmp(MagicNumberString, "0x07010016") == 0 || /*SGS2510FP*/
                strcmp(MagicNumberString, "0x07010017") == 0 || /*SGS2510*/
                strcmp(MagicNumberString, "0x83030005") == 0 || /*EWS2510-FIT*/
				strcmp(MagicNumberString, "0x60112010") == 0 || /*DSW250-8P-2X*/
				strcmp(MagicNumberString, "0x60413010") == 0 || /*LGSM310C*/
				strcmp(MagicNumberString, "0x60413020") == 0    /*LGSM310MPC*/)
        {
            senao_non_rtl_phy_info = &senao_phy_info[5];
            phy_board_type = RTL9302C_GPY2xx_BOARD_TYPE_2;
        }
        // Starry@20210621 Add for Gpy -E
        else if(strcmp(MagicNumberString, "0x83025005") == 0 || /*ECS2610*/
                strcmp(MagicNumberString, "0x07010008") == 0 || /*SGS2610*/
                strcmp(MagicNumberString, "0x83025205") == 0    /*ECS2610FP*/)
        {
            senao_non_rtl_phy_info = &senao_phy_info[6];
            phy_board_type = RTL9302C_GPY2xx_BOARD_TYPE_3;
        }
        else if(strcmp(MagicNumberString, "0x83027005") == 0 || /*ECS2000*/
                strcmp(MagicNumberString, "0x07010010") == 0    /*SGS2000*/)
        {
            senao_non_rtl_phy_info = &senao_phy_info[7];
            phy_board_type = RTL9302C_GPY2xx_BOARD_TYPE_4;
        }
        else if(strcmp(MagicNumberString, "0x83023005") == 0 || /*ECS2008*/
                strcmp(MagicNumberString, "0x07010011") == 0    /*SGS2008*/)
        {
            senao_non_rtl_phy_info = &senao_phy_info[8];
 ...
 *      hwp_force_reinit
 * Description:
 *      Force re-initialize hardware profile related variables
 * Input:
 *      None
 * Output:
 *      None
 ...
 */
void
hwp_force_reinit(void)
{
    hwp_init_sys_status = INIT_NOT_COMPLETED;
}
