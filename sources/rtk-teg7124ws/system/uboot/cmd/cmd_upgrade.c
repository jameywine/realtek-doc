...
#ifdef CONFIG_SENAO_RESCUE_LITEOS
...
struct rtk_partition_info_t rtk_flash_partition_size[6] = {
     ...
     [1] = {
         ...
         .rescue_kernel_size        = (0x00900000U),/*10Mb*/
...
#else     /* Frank Temp Modify to support RD Board Nor Flash 32M, Kernel at NAND Flash */
/* Bruce tmp */
...
#else /*CONFIG_SENAO_RESCUE_LITEOS=n*/
...
#endif /*end CONFIG_SENAO_RESCUE_LITEOS*/
...
void sdk_get_paritition_info(rtk_flash_partition_idx_t index, u32 *offset, u32 *size)
{
    ...
    switch(partition_idx){
        ...
        case FLASH_INDEX_RESCUE_JFFS2_CFG:			/* RESCUE_JFFS2_CFG */
            *offset = rtk_flash_partition_size[size_idx].rescue_jffs2_cfg_offset;
            *size = rtk_flash_partition_size[size_idx].rescue_jffs2_cfg_size;
            break;
        case FLASH_INDEX_RESCUE_JFFS2_LOG:			/* RESCUE_JFFS2_LOG */
            *offset = rtk_flash_partition_size[size_idx].rescue_jffs2_log_offset;
            *size = rtk_flash_partition_size[size_idx].rescue_jffs2_log_size;
            break;
        case FLASH_INDEX_RESCUE_KERNEL:			/* RESCUE_KERNEL */
            *offset = rtk_flash_partition_size[size_idx].rescue_kernel_offset;
            *size = rtk_flash_partition_size[size_idx].rescue_kernel_size;
            break;
