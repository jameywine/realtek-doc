...
#ifdef SENAO_I2C_DEBUG
            RT_INIT_MSG("SENAO:%s, %04d RTL9300_I2C_MST2_CTRL1_ADDR=%04X\n",__FUNCTION__,__LINE__, reg_data);
#endif
...
#if 1 /* SENAO, For slow SFP module */
            /* Set ACK_DELAY */
            reg_data &= ~RTL9300_I2C_MST1_CTRL2_DRIVE_ACK_DELAY_MASK;
            reg_data |= ((i2c_dev->scl_delay) << RTL9300_I2C_MST1_CTRL2_DRIVE_ACK_DELAY_OFFSET);

            /* Set CHECK_ACK_DELAY */
            reg_data &= ~RTL9300_I2C_MST1_CTRL2_CHECK_ACK_DELAY_MASK;
            reg_data |= ((i2c_dev->scl_delay) << RTL9300_I2C_MST1_CTRL2_CHECK_ACK_DELAY_OFFSET);
#endif
...
#if 0 /* SENAO, Frank for Test*/
#if 1
            /* Set ACK_DELAY */
            reg_data &= ~RTL9300_I2C_MST2_CTRL2_DRIVE_ACK_DELAY_MASK;
            reg_data |= ((i2c_dev->scl_delay) << RTL9300_I2C_MST2_CTRL2_DRIVE_ACK_DELAY_OFFSET);  
#endif
#if 1
            /* Set CHECK_ACK_DELAY */
            reg_data &= ~RTL9300_I2C_MST2_CTRL2_CHECK_ACK_DELAY_MASK;
            reg_data |= ((i2c_dev->scl_delay) << RTL9300_I2C_MST2_CTRL2_CHECK_ACK_DELAY_OFFSET);
#endif
#endif

#ifdef SENAO_I2C_DEBUG
            RT_INIT_MSG("SENAO:%s, %04d RTL9300_I2C_MST2_CTRL2_ADDR=%04X\n",__FUNCTION__,__LINE__, reg_data);
#endif
...
#ifdef SENAO_I2C_DEBUG
        RT_INIT_MSG("SENAO:%s, %04d RTL9300_I2C_MST_GLB_CTRL_ADDR=%04X\n",__FUNCTION__,__LINE__, reg_data);
#endif
...
int32 r9300_i2c_hold_time_2_set(uint32 unit, uint32 hold_time_cfg)
{
    uint32  reg_data;
    int32   ret;

    ret = ioal_mem32_read(unit, RTL9300_I2C_MST_GLB_CTRL_ADDR, &reg_data);
    reg_data &= ~RTL9300_I2C_MST_GLB_CTRL_CFG_DATA_HOLD_TIME_2_MASK;
    reg_data |= ( hold_time_cfg << RTL9300_I2C_MST_GLB_CTRL_CFG_DATA_HOLD_TIME_2_OFFSET);
    ret = ioal_mem32_write(unit, RTL9300_I2C_MST_GLB_CTRL_ADDR, reg_data);

    return ret;
}

int32 r9300_i2c_hold_time_1_set(uint32 unit, uint32 hold_time_cfg)
{
    uint32  reg_data;
    int32   ret;

    ret = ioal_mem32_read(unit, RTL9300_I2C_MST_GLB_CTRL_ADDR, &reg_data);
    reg_data &= ~RTL9300_I2C_MST_GLB_CTRL_CFG_DATA_HOLD_TIME_1_MASK;
    reg_data |= ( hold_time_cfg << RTL9300_I2C_MST_GLB_CTRL_CFG_DATA_HOLD_TIME_1_OFFSET);
    ret = ioal_mem32_write(unit, RTL9300_I2C_MST_GLB_CTRL_ADDR, reg_data);
