...
#define PHY_MODEL_ID_CUST1              (0xC001) /*For BCM Shortfin phy*/
...
#define PHY_MODEL_ID_GPY2xx             (0xC006) /*For MXL GPY2xx*/
...
typedef enum phy_type_e {
    ...
    RTK_PHYTYPE_SERDES,
    RTK_PHYTYPE_CUST1,          /*For BCM Shortfin phy*/
    RTK_PHYTYPE_CUST2,
    RTK_PHYTYPE_CUST3,
    RTK_PHYTYPE_CUST4,
    RTK_PHYTYPE_CUST5,
    RTK_PHYTYPE_GPY2xx,         /*For MXL GPY2xx*/
...
#define RTK_PHYTYPE_STRING_GPY2xx           "GPY2xx"
...
#define RTK_PHYTYPE_STRING                         \
    ...
    (uint8 *)RTK_PHYTYPE_STRING_GPY2xx,            \
...
typedef struct rt_phydrv_s
{
    ...
    int32   (*fPhydrv_100MportWorkaround_set)(uint32, rtk_port_t, rtk_enable_t);
