 ...
 */
 ...
 uint32   runtime_rtnic_init_status = INIT_NOT_COMPLETED;
/*
...
/* Function Name:
 *      runtime_rtnic_init_com
 * Description:
 *      set runtime init state to completed
 * Input:
 *      None
 * Output:
 *      None
 ...
 */
void
runtime_rtnic_init_com(void)
{
    /*runtime rtnic init completed*/
    runtime_rtnic_init_status = INIT_COMPLETED;
}


/* Function Name:
 *      runtime_rtnic_init_state_get
 * Description:
 *      get runtime init state
 * Input:
 *      state    - init state
 * Output:
 *      None
 ...
 */
void
runtime_rtnic_init_state_get(uint32 *state)
{
    /*get runtime rtnic init state*/
    *state = runtime_rtnic_init_status;
}