...
#if 0 /* Senao Dan : Follow FAE Suggest to support RTL8221B + GPY241 */
    .flags      = (RTK_PHYINFO_FLAG_1G_MMD_CFG | RTK_PHYINFO_FLAG_NO_RES_REG),/*(RTK_PHYINFO_FLAG_1G_MMD_CFG | RTK_PHYINFO_FLAG_NO_RES_REG), RTK_PHYINFO_FLAG_NONE */ 
#else
    .flags      = (RTK_PHYINFO_FLAG_NONE),/*(RTK_PHYINFO_FLAG_1G_MMD_CFG | RTK_PHYINFO_FLAG_NO_RES_REG), RTK_PHYINFO_FLAG_NONE */ 
#endif
