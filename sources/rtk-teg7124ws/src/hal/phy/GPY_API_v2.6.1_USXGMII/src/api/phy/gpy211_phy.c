		     ...
		     struct gpy211_synce *synce_cfg)
{
	...
	/* Validate STD_PHYID2.INDUS (8th bit) */
	if ((phy->id.model_no & 0x10) == 0) {
		LOG_WARN("ERROR: SyncE is not supported.\n");
		return -EINVAL;
	}
	...
	if (phy->id.family == ID_P31G) {
		if (synce_cfg->master_sel == SYNCE_SLAVE) {
			...
			if (synce_cfg->gpc_sel == SYNCE_GPC1) {
				_cgu_pdi_gpc_addr = CGU_PDI_CGU_PDI_GPC1_CONF;
			} else {
				_cgu_pdi_gpc_addr = CGU_PDI_CGU_PDI_GPC2_CONF;
			}
		...
		/* SyncE is not implemented in FW yet.
		 * To be updated when FW is ready.
		 */
	}
			     ...
			     struct gpy211_usxgmii_reach *reach_cfg)
{
	...
	if (reach_cfg->usxgmii_trace_len < CONST_VSPEC1_SGMII_CTRL_USXGMII_REACH_SHORT ||
	    reach_cfg->usxgmii_trace_len > CONST_VSPEC1_SGMII_CTRL_USXGMII_REACH_CUSTOM) {
	...
	_usxgmii_mode = (u16) _data;

	/** 0x50 is the USXGMII flag, else the value is 0 */
	if (_usxgmii_mode != 0x50) {
	...
	_data = ret;
	FIELD_REPLACE(_data, reach_cfg->usxgmii_trace_len, VSPEC1_SGMII_CTRL_USXGMII_REACH);
	...
	if (_reach_cfg == CONST_VSPEC1_SGMII_CTRL_USXGMII_REACH_CUSTOM) {
		...
		FIELD_REPLACE(_data, reach_cfg->usxgmii_tx_eq_main, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_TX_EQ_CTRL0_TX_EQ_MAIN);
		FIELD_REPLACE(_data, reach_cfg->usxgmii_tx_eq_pre, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_TX_EQ_CTRL0_TX_EQ_PRE);
		...
		FIELD_REPLACE(_data, reach_cfg->usxgmii_tx_vboost_en_0, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_TX_GENCTRL1_VBOOST_EN_0);
		FIELD_REPLACE(_data, reach_cfg->usxgmii_tx_vboost_lvl, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_TX_GENCTRL1_VBOOST_LVL);
		...
		FIELD_REPLACE(_data, reach_cfg->usxgmii_tx_eq_post, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_TX_EQ_CTRL1_TX_EQ_POST);
		...
		FIELD_REPLACE(_data, reach_cfg->usxgmii_tx_iboost_lvl_0, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_TX_BOOST_CTRL_TX0_IBOOST);
		...
		FIELD_REPLACE(_data, reach_cfg->usxgmii_rx_eq_att_lvl_0, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_RX_ATTN_CTRL_RX0_EQ_ATT_LVL);
		...
		FIELD_REPLACE(_data, reach_cfg->usxgmii_rx_eq_ctle_boost_0, XPCS_VR_XS_PMA_SNPS_MP_12G_RX_EQ_CTRL0_CTLE_BOOST_0);
		FIELD_REPLACE(_data, reach_cfg->usxgmii_rx_eq_ctle_pole_0, XPCS_VR_XS_PMA_SNPS_MP_12G_RX_EQ_CTRL0_CTLE_POLE_0);
		FIELD_REPLACE(_data, reach_cfg->usxgmii_rx_eq_vga1_gain_0, XPCS_VR_XS_PMA_SNPS_MP_12G_RX_EQ_CTRL0_VGA1_GAIN_0);
		FIELD_REPLACE(_data, reach_cfg->usxgmii_rx_eq_vga2_gain_0, XPCS_VR_XS_PMA_SNPS_MP_12G_RX_EQ_CTRL0_VGA2_GAIN_0);
		...
		FIELD_REPLACE(_data, reach_cfg->usxgmii_rx_eq_dfe_tap1_0, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_DFE_TAP_CTRL0_DFE_TAP1_0);
		...
		FIELD_REPLACE(_data, reach_cfg->usxgmii_rx_afe_adapt_en, XPCS_VR_XS_PMA_SNPS_MP_12G_AFE_DFE_EN_CTRL_AFE_EN_0);
		FIELD_REPLACE(_data, reach_cfg->usxgmii_rx_dfe_adapt_en, XPCS_VR_XS_PMA_SNPS_MP_12G_AFE_DFE_EN_CTRL_DFE_EN_0);
			     ...
			     struct gpy211_usxgmii_reach *reach_cfg)
{
	...
	_data = ret;
	reach_cfg->usxgmii_trace_len = FIELD_GET(_data, VSPEC1_SGMII_CTRL_USXGMII_REACH);
	...
	reach_cfg->usxgmii_tx_eq_main = FIELD_GET(_data, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_TX_EQ_CTRL0_TX_EQ_MAIN);
	reach_cfg->usxgmii_tx_eq_pre  = FIELD_GET(_data, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_TX_EQ_CTRL0_TX_EQ_PRE);
	...
	reach_cfg->usxgmii_tx_vboost_en_0 = FIELD_GET(_data, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_TX_GENCTRL1_VBOOST_EN_0);
	reach_cfg->usxgmii_tx_vboost_lvl  = FIELD_GET(_data, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_TX_GENCTRL1_VBOOST_LVL);
	...
	reach_cfg->usxgmii_tx_eq_post = FIELD_GET(_data, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_TX_EQ_CTRL1_TX_EQ_POST);
	...
	reach_cfg->usxgmii_tx_iboost_lvl_0 = FIELD_GET(_data, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_TX_BOOST_CTRL_TX0_IBOOST);
	...
	reach_cfg->usxgmii_rx_eq_att_lvl_0 = FIELD_GET(_data, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_RX_ATTN_CTRL_RX0_EQ_ATT_LVL);
	...
	reach_cfg->usxgmii_rx_eq_ctle_boost_0 = FIELD_GET(_data, XPCS_VR_XS_PMA_SNPS_MP_12G_RX_EQ_CTRL0_CTLE_BOOST_0);
	reach_cfg->usxgmii_rx_eq_ctle_pole_0  = FIELD_GET(_data, XPCS_VR_XS_PMA_SNPS_MP_12G_RX_EQ_CTRL0_CTLE_POLE_0);
	reach_cfg->usxgmii_rx_eq_vga1_gain_0  = FIELD_GET(_data, XPCS_VR_XS_PMA_SNPS_MP_12G_RX_EQ_CTRL0_VGA1_GAIN_0);
	reach_cfg->usxgmii_rx_eq_vga2_gain_0  = FIELD_GET(_data, XPCS_VR_XS_PMA_SNPS_MP_12G_RX_EQ_CTRL0_VGA2_GAIN_0);
	...
	reach_cfg->usxgmii_rx_eq_dfe_tap1_0 = FIELD_GET(_data, XPCS_VR_XS_PMA_SNPS_MP_12G_16G_25G_DFE_TAP_CTRL0_DFE_TAP1_0);
	...
	reach_cfg->usxgmii_rx_afe_adapt_en = FIELD_GET(_data, XPCS_VR_XS_PMA_SNPS_MP_12G_AFE_DFE_EN_CTRL_AFE_EN_0);
	reach_cfg->usxgmii_rx_dfe_adapt_en = FIELD_GET(_data, XPCS_VR_XS_PMA_SNPS_MP_12G_AFE_DFE_EN_CTRL_DFE_EN_0);
...
int gpy2xx_usxgmii_pcs_pma_linkstatus_get(struct gpy211_device *phy,
		struct gpy211_usxgmii_pcs_pma_linkstatus *linkstatus)
{
	int ret = -EINVAL;
	u32 _data;
	u16 _usxgmii_mode;
	...
	/* check chip ID for register selection */
	if (phy->id.family != ID_P34X) {
		LOG_WARN("USXGMII is not supported on this PHY familiy. It is applicable to P34X only.\n");
		return -EINVAL;
	}
	...
	linkstatus->usxgmii_pma_latched_linksts = FIELD_GET(_data, XPCS_SR_PMA_STATUS1_RLU);
	...
	linkstatus->usxgmii_pma_linksts = FIELD_GET(_data, XPCS_SR_PMA_STATUS1_RLU);
	...
	linkstatus->usxgmii_pcs_latched_linksts = FIELD_GET(_data, XPCS_SR_XS_PCS_STS1_RLU);
	...
	linkstatus->usxgmii_pcs_linksts = FIELD_GET(_data, XPCS_SR_XS_PCS_STS1_RLU);
...
int gpy2xx_usxgmii_mii_linkstatus_get(struct gpy211_device *phy,
				      struct gpy211_usxgmii_mii_linkstatus *linkstatus)
{
	int ret = -EINVAL;
	u32 _data;
	u16 _usxgmii_mode;
	...
	/*get phy address for user refernce*/
	linkstatus->phy_addr = phy->phy_addr;

	switch (linkstatus->phy_addr & 0x3) {
	case 0:
		/* Read MII Port 0 Link latched status */
		ret = PHY_XPCS_HWRD(phy, XPCS_VS_MII_MMD_XPCS_SR_MII_STS, &_data);

		if (ret < 0) {
			LOG_CRIT("ERROR: XPCS_VS_MII_MMD_XPCS_SR_MII_STS read fails\n");
			goto END;
		}

		linkstatus->usxgmii_mii_latched_linksts_status[0] = FIELD_GET(_data, XPCS_SR_MII_STS_LINK_STS);

		/* Read MII Port 0 Link status */
		ret = PHY_XPCS_HWRD(phy, XPCS_VS_MII_MMD_XPCS_SR_MII_STS, &_data);
		...
		linkstatus->usxgmii_mii_linksts_status[0] = FIELD_GET(_data, XPCS_SR_MII_STS_LINK_STS);
		break;

	case 1:
		/* Read MII Port 1 Link latched status */
		ret = PHY_XPCS_HWRD(phy, XPCS_VS_MII_1_MMD_XPCS_SR_MII_1_STS, &_data);

		if (ret < 0) {
			LOG_CRIT("ERROR: XPCS_VS_MII_1_MMD_XPCS_SR_MII_1_STS read fails\n");
			goto END;
		}

		linkstatus->usxgmii_mii_latched_linksts_status[1] = FIELD_GET(_data, XPCS_SR_MII_1_STS_LINK_STS);

		/* Read MII Port 1 Link status */
		ret = PHY_XPCS_HWRD(phy, XPCS_VS_MII_1_MMD_XPCS_SR_MII_1_STS, &_data);
		...
		linkstatus->usxgmii_mii_linksts_status[1] = FIELD_GET(_data, XPCS_SR_MII_1_STS_LINK_STS);
		break;

	case 2:
		/* Read MII Port 2 Link latched status */
		ret = PHY_XPCS_HWRD(phy, XPCS_VS_MII_2_MMD_XPCS_SR_MII_2_STS, &_data);

		if (ret < 0) {
			LOG_CRIT("ERROR: XPCS_VS_MII_2_MMD_XPCS_SR_MII_2_STS read fails\n");
			goto END;
		}

		linkstatus->usxgmii_mii_latched_linksts_status[2] = FIELD_GET(_data, XPCS_SR_MII_2_STS_LINK_STS);
		...
		linkstatus->usxgmii_mii_linksts_status[2] = FIELD_GET(_data, XPCS_SR_MII_2_STS_LINK_STS);
		break;

	case 3:
		/* Read MII Port 3 Link latched status */
		ret = PHY_XPCS_HWRD(phy, XPCS_VS_MII_3_MMD_XPCS_SR_MII_3_STS, &_data);

		if (ret < 0) {
			LOG_CRIT("ERROR: XPCS_VS_MII_3_MMD_XPCS_SR_MII_3_STS read fails\n");
			goto END;
		}

		linkstatus->usxgmii_mii_latched_linksts_status[3] = FIELD_GET(_data, XPCS_SR_MII_3_STS_LINK_STS);
		...
		linkstatus->usxgmii_mii_linksts_status[3] = FIELD_GET(_data, XPCS_SR_MII_3_STS_LINK_STS);
		break;

	default:
		LOG_CRIT("ERROR: wrong phy id, operation aborts\n");
		ret = -EINVAL;
		goto END;
	}
...
static int __gpy2xx_usxgmii_tx_config_get(struct gpy211_device *phy,
		struct gpy211_usxgmii_aneg_linkstatus *status,
		u32 vr_mii_anegctrl_addr)
{
	int ret = -EINVAL;
	u32 _data;
	...
	ret = PHY_XPCS_HWRD(phy, vr_mii_anegctrl_addr, &_data);

	if (ret < 0) {
		LOG_CRIT("ERROR: XPCS_VR_MII_AN_CTRL for phy address = %x read fails\n", status->phy_addr);
		return -EINVAL;
	}

	status->usxgmii_tx_config[(status->phy_addr & 0x3)] = FIELD_GET(_data, XPCS_VR_MII_AN_CTRL_TX_CONFIG);

	LOG_INFO("Exiting func name :- %s\n", __func__);
	return ret;
}

static int __gpy2xx_usxgmii_forcemode_get(struct gpy211_device *phy,
		struct gpy211_usxgmii_aneg_linkstatus *status,
		u32 vr_mii_dig_ctrl1)
{
	int ret = -EINVAL;
	u32 _data = 0;
	int mac_auto_sw = 0;

	ret = PHY_XPCS_HWRD(phy, vr_mii_dig_ctrl1, &_data);

	if (ret < 0) {
		LOG_CRIT("ERROR: XPCS_VS_MII_MMD_XPCS_VR_MII_DIG_CTRL1 read fails\n");
		return ret;
	}

	mac_auto_sw = FIELD_GET(_data, XPCS_VR_MII_DIG_CTRL1_MAC_AUTO_SW);

	if (mac_auto_sw)
		/*force mode disabled*/
		status->usxgmii_force_mode[(status->phy_addr & 0x3)] = 0;
	else
		/*force mode enabled*/
		status->usxgmii_force_mode[(status->phy_addr & 0x3)] = 1;

	LOG_INFO("Exiting func name :- %s\n", __func__);
	return ret;
}

static int __gpy2xx_usxgmii_phy_anegsts_get(struct gpy211_device *phy,
		struct gpy211_usxgmii_aneg_linkstatus *status,
		u32 vr_mii_anegctrl_addr,
		u32 sr_mii_ctrl,
		u32 sr_mii_sts)
{
	...
	status->usxgmii_aneg_linksts_status[(status->phy_addr & 0x3)] = FIELD_GET(_data, XPCS_VR_MII_AN_CTRL_SGMII_LINK_STS);

	ret = PHY_XPCS_HWRD(phy, sr_mii_ctrl, &_data);

	if (ret < 0) {
		LOG_CRIT("ERROR: XPCS_VS_MII_MMD_XPCS_SR_MII_CTRL for phy address = %x read fails\n", status->phy_addr);
		return -EINVAL;;
	}

	status->usxgmii_aneg_enabled[(status->phy_addr & 0x3)] = FIELD_GET(_data, XPCS_SR_MII_CTRL_AN_ENABLE);
	status->usxgmii_aneg_duplex[(status->phy_addr & 0x3)] = FIELD_GET(_data, XPCS_SR_MII_CTRL_DUPLEX_MODE);
	ss5 = 	FIELD_GET(_data, XPCS_SR_MII_CTRL_SS5);
	ss6 = 	FIELD_GET(_data, XPCS_SR_MII_CTRL_SS6);
	ss13 = 	FIELD_GET(_data, XPCS_SR_MII_CTRL_SS13);

	if (ss5 == 0 && ss6 == 0 && ss13 == 0)
		status->usxgmii_aneg_linkspeed[(status->phy_addr & 0x3)] =	SPEED_10;
	else if (ss5 == 0 && ss6 == 0 && ss13 == 1)
		status->usxgmii_aneg_linkspeed[(status->phy_addr & 0x3)] =	SPEED_100;
	else if (ss5 == 0 && ss6 == 1 && ss13 == 0)
		status->usxgmii_aneg_linkspeed[(status->phy_addr & 0x3)] =	SPEED_1000;
	else if (ss5 == 0 && ss6 == 1 && ss13 == 1)
		status->usxgmii_aneg_linkspeed[(status->phy_addr & 0x3)] =	SPEED_10000;
	else if (ss5 == 1 && ss6 == 0 && ss13 == 0)
		status->usxgmii_aneg_linkspeed[(status->phy_addr & 0x3)] =	SPEED_2500;
	else if (ss5 == 1 && ss6 == 0 && ss13 == 1)
		status->usxgmii_aneg_linkspeed[(status->phy_addr & 0x3)] =	SPEED_5000;
	else
		status->usxgmii_aneg_linkspeed[(status->phy_addr & 0x3)] =	SPEED_UNKNOWN;

	ret = PHY_XPCS_HWRD(phy, sr_mii_sts, &_data);

	if (ret < 0) {
		LOG_CRIT("ERROR: XPCS_SR_MII_STS for phy address = %x read fails\n", status->phy_addr);
		return -EINVAL;;
	}

	status->usxgmii_aneg_complete_status[(status->phy_addr & 0x3)] = FIELD_GET(_data, XPCS_SR_MII_STS_AN_CMPL);

	LOG_INFO("Exiting func name :- %s\n", __func__);
	return ret;
}

static int __gpy2xx_usxgmii_mac_anegsts_get(struct gpy211_device *phy,
		struct gpy211_usxgmii_aneg_linkstatus *status,
		u32 vr_mii_anegctrl_addr,
		u32 vr_mii_an_intrsts_addr,
		u32 sr_mii_ctrl)
{
	int ret = -EINVAL;
	u32 _data;
	u8 speed = 0;
	u8 aneg_interupt_enable = 0;
	...
	aneg_interupt_enable = FIELD_GET(_data, XPCS_VR_MII_AN_CTRL_MII_AN_INTR_EN);

	ret = PHY_XPCS_HWRD(phy, vr_mii_an_intrsts_addr, &_data);

	if (ret < 0) {
		LOG_CRIT("ERROR: XPCS_VR_MII_AN_INTR_STS for phy address = %x read fails\n", status->phy_addr);
		return -EINVAL;;
	}

	status->usxgmii_aneg_linksts_status[(status->phy_addr & 0x3)] = ((_data & 0x4000) >> 0xE);
	status->usxgmii_aneg_duplex[(status->phy_addr & 0x3)] = ((_data & 0x2000) >> 0xD);
	speed = ((_data & 0x1C00) >> 0xA);

	if (aneg_interupt_enable)
		status->usxgmii_aneg_complete_status[(status->phy_addr & 0x3)] = FIELD_GET(_data, XPCS_VR_MII_AN_INTR_STS_CL37_ANCMPLT_INTR);
	else
		status->usxgmii_aneg_complete_status[(status->phy_addr & 0x3)] = ANEG_PROCESS_COMPLETE_STATUS_UNKNOWN;
...
int gpy2xx_usxgmii_anegstatus_get(struct gpy211_device *phy,
				  struct gpy211_usxgmii_aneg_linkstatus *status)
{
	int ret = -EINVAL;
	u32 _data;
	...
	/*get phy address for user refernce*/
	status->phy_addr = phy->phy_addr;

	switch (status->phy_addr & 0x3) {
	case 0:
		/*PORT 0*/
		ret	=	__gpy2xx_usxgmii_tx_config_get(phy,
				status,
				XPCS_VS_MII_MMD_XPCS_VR_MII_AN_CTRL);

		if (ret < 0) {
			LOG_CRIT("ERROR: __gpy2xx_usxgmii_tx_config_get fails for phy addr = %x\n", status->phy_addr);
			goto END;
		}

		if (status->usxgmii_tx_config) {
			ret	=	__gpy2xx_usxgmii_phy_anegsts_get(phy,
					status,
					XPCS_VS_MII_MMD_XPCS_VR_MII_AN_CTRL,
			...
			if (ret < 0) {
				LOG_CRIT("ERROR: __gpy2xx_usxgmii_phy_anegsts_get fails for phy addr = %x\n", status->phy_addr);
				goto END;
			}

			/*not applicable for usxgmii-gphy*/
			status->usxgmii_force_mode[(status->phy_addr & 0x3)] = 0xff;
		} else {
			ret =	__gpy2xx_usxgmii_mac_anegsts_get(phy,
					status,
					XPCS_VS_MII_MMD_XPCS_VR_MII_AN_CTRL,
			...
			if (ret < 0) {
				LOG_CRIT("ERROR: __gpy2xx_usxgmii_mac_anegsts_get fails for phy addr = %x\n", status->phy_addr);
				goto END;
			}

			ret =  __gpy2xx_usxgmii_forcemode_get(phy,
							      status,
							      XPCS_VS_MII_MMD_XPCS_VR_MII_DIG_CTRL1);

			if (ret < 0) {
				LOG_CRIT("ERROR: __gpy2xx_usxgmii_forcemode_get fails for phy addr = %x\n", status->phy_addr);
				goto END;
			}
		}
...
static int __gpy2xx_usxgmii_aneg_en_dis_ctrl(struct gpy211_device *phy,
		struct gpy211_usxgmii_aneg_config *config,
		u32 sr_mii_ctrl)
{
	int ret = -EINVAL;
	u32 _data = 0;
	...
	if (ret < 0) {
		LOG_CRIT("ERROR: XPCS_VS_MII_MMD_XPCS_SR_MII_CTRL read fails\n");
		return ret;
	}

	if (config->usxgmii_aneg_disable[(config->phy_addr & 0x3)] == 1 ||
	    config->usxgmii_force_linkspeed_enable[(config->phy_addr & 0x3)] == 1)
		FIELD_REPLACE(_data, 0, XPCS_SR_MII_CTRL_AN_ENABLE);
	else
		FIELD_REPLACE(_data, 1, XPCS_SR_MII_CTRL_AN_ENABLE);

	ret = PHY_XPCS_HWWR(phy, sr_mii_ctrl, _data);

	if (ret < 0) {
		LOG_CRIT("ERROR: XPCS_VS_MII_MMD_XPCS_SR_MII_CTRL write fails\n");
		return ret;
	}
...
static int __gpy2xx_usxgmii_restart_aneg(struct gpy211_device *phy,
		struct gpy211_usxgmii_aneg_config *config,
		u32 sr_mii_ctrl)
{
	int ret = -EINVAL;
	...
	if (config->usxgmii_restart_aneg[(config->phy_addr & 0x3)] == 1 ||
	    config->usxgmii_force_linkspeed_enable[(config->phy_addr & 0x3)] == 1) {
		ret = PHY_XPCS_HWRD(phy, sr_mii_ctrl, &_data);
...
static int __gpy2xx_usxgmii_forcelink_set(struct gpy211_device *phy,
		struct gpy211_usxgmii_aneg_config *config,
		u32 sr_mii_ctrl,
		u32 vr_mii_dig_ctrl1,
		u32 vr_mii_anegctrl_addr)
{
	int ret = -EINVAL;
	u32 _data = 0, _data1 = 0, _data2 = 0;
	int tx_config = 0XFF;

	ret = PHY_XPCS_HWRD(phy, vr_mii_dig_ctrl1, &_data1);
	...
	ret = PHY_XPCS_HWRD(phy, vr_mii_anegctrl_addr, &_data2);
	...
	tx_config = FIELD_GET(_data2, XPCS_VR_MII_AN_CTRL_TX_CONFIG);

	if (config->usxgmii_force_linkspeed_enable[(config->phy_addr & 0x3)] == 1) {
		...
		if (config->usxgmii_force_linkspeed[(config->phy_addr & 0x3)] ==	SPEED_10) {
			FIELD_REPLACE(_data, 0, XPCS_SR_MII_CTRL_SS5);
			FIELD_REPLACE(_data, 0, XPCS_SR_MII_CTRL_SS6);
			FIELD_REPLACE(_data, 0, XPCS_SR_MII_CTRL_SS13);
		} else if (config->usxgmii_force_linkspeed[(config->phy_addr & 0x3)] ==	SPEED_100) {
			FIELD_REPLACE(_data, 0, XPCS_SR_MII_CTRL_SS5);
			FIELD_REPLACE(_data, 0, XPCS_SR_MII_CTRL_SS6);
			FIELD_REPLACE(_data, 1, XPCS_SR_MII_CTRL_SS13);
		} else if (config->usxgmii_force_linkspeed[(config->phy_addr & 0x3)] ==	SPEED_1000) {
			FIELD_REPLACE(_data, 0, XPCS_SR_MII_CTRL_SS5);
			FIELD_REPLACE(_data, 1, XPCS_SR_MII_CTRL_SS6);
			FIELD_REPLACE(_data, 0, XPCS_SR_MII_CTRL_SS13);
		} else if (config->usxgmii_force_linkspeed[(config->phy_addr & 0x3)] ==	SPEED_10000) {
			FIELD_REPLACE(_data, 0, XPCS_SR_MII_CTRL_SS5);
			FIELD_REPLACE(_data, 1, XPCS_SR_MII_CTRL_SS6);
			FIELD_REPLACE(_data, 1, XPCS_SR_MII_CTRL_SS13);
		} else if (config->usxgmii_force_linkspeed[(config->phy_addr & 0x3)] ==	SPEED_2500) {
			FIELD_REPLACE(_data, 1, XPCS_SR_MII_CTRL_SS5);
			FIELD_REPLACE(_data, 0, XPCS_SR_MII_CTRL_SS6);
			FIELD_REPLACE(_data, 0, XPCS_SR_MII_CTRL_SS13);
		} else if (config->usxgmii_force_linkspeed[(config->phy_addr & 0x3)] ==	SPEED_5000) {
			FIELD_REPLACE(_data, 1, XPCS_SR_MII_CTRL_SS5);
			FIELD_REPLACE(_data, 0, XPCS_SR_MII_CTRL_SS6);
			FIELD_REPLACE(_data, 1, XPCS_SR_MII_CTRL_SS13);
		} else {
			LOG_CRIT("ERROR: Force link SPEED_UNKNOWN\n");
			return ret;
		}

		FIELD_REPLACE(_data, config->usxgmii_force_duplex[(config->phy_addr & 0x3)], XPCS_SR_MII_CTRL_DUPLEX_MODE);
		...
		if (tx_config == 0x0)
			/*enable force mode*/
			FIELD_REPLACE(_data1, 0, XPCS_VR_MII_DIG_CTRL1_MAC_AUTO_SW);
	} else {
		/*if usxgmii-mac*/
		if (tx_config == 0x0)
			/*disable force mode*/
			FIELD_REPLACE(_data1, 1, XPCS_VR_MII_DIG_CTRL1_MAC_AUTO_SW);
	}

	ret = PHY_XPCS_HWWR(phy, vr_mii_dig_ctrl1, _data1);

	if (ret < 0) {
		LOG_CRIT("ERROR: XPCS_VR_MII_DIG_CTRL1 write fails\n");
		return ret;
	}
...
int gpy2xx_usxgmii_anegconfig_set(struct gpy211_device *phy,
				  struct gpy211_usxgmii_aneg_config *config)
{
	int ret = -EINVAL;
	u32 _data;
	...
	/*get phy address for user refernce*/
	config->phy_addr = phy->phy_addr;

	switch (config->phy_addr & 0x3) {
	case 0:
		/*PORT 0*/
		ret	=	__gpy2xx_usxgmii_aneg_en_dis_ctrl(phy,
				config,
				XPCS_VS_MII_MMD_XPCS_SR_MII_CTRL);

		if (ret < 0) {
			LOG_CRIT("ERROR: __gpy2xx_usxgmii_aneg_en_dis_ctrl fails for phy addr = %x\n", config->phy_addr);
			goto END;
		}

		ret	=	__gpy2xx_usxgmii_forcelink_set(phy,
				config,
				XPCS_VS_MII_MMD_XPCS_SR_MII_CTRL,
				XPCS_VS_MII_MMD_XPCS_VR_MII_DIG_CTRL1,
				XPCS_VS_MII_MMD_XPCS_VR_MII_AN_CTRL);
		...
		if (ret < 0) {
			LOG_CRIT("ERROR: __gpy2xx_usxgmii_forcelink_set fails for phy addr = %x\n", config->phy_addr);
			goto END;
		}

		ret	=	__gpy2xx_usxgmii_restart_aneg(phy,
				config,
				XPCS_VS_MII_MMD_XPCS_SR_MII_CTRL);

		if (ret < 0) {
			LOG_CRIT("ERROR: __gpy2xx_usxgmii_restart_aneg fails for phy addr = %x\n", config->phy_addr);
			goto END;
		}
...
int gpy2xx_usxgmii_vr_reset(struct gpy211_device *phy)
{
	...
	ret = PHY_XPCS_HWWR(phy, XPCS_XS_PCS_MMD_XPCS_VR_XS_PCS_DIG_CTRL1, _data);
...
int gpy2xx_usxgmii_vr_reset_sts_get(struct gpy211_device *phy,
				    struct gpy211_usxgmii_vr_reset_status *status)
{
	int ret = -EINVAL;
	u32 _data;
	u16 _usxgmii_mode;
	int vr_reset = 0, pseq_state = 0;
	int idx = 0;
	...
	do {
		...
		if (ret < 0) {
			LOG_CRIT("ERROR: XPCS_XS_PCS_MMD_XPCS_VR_XS_PCS_DIG_CTRL1 read fails\n");
			status->usxgmii_vr_reset_successful = 0;
			goto END;
		}

		vr_reset = FIELD_GET(_data, XPCS_VR_XS_PCS_DIG_CTRL1_VR_RST);
	...
	if (idx >= MAX_BUSY_RETRY) {
		...
		LOG_CRIT("ERROR: VR Reset bit not cleared (self clearing bit)  %d times - retry fail\n", MAX_BUSY_RETRY);
		status->usxgmii_vr_reset_successful = 0;
		goto END;
	}
	...
	/* Set PSEQ_STATE get*/
	ret = PHY_XPCS_HWRD(phy, XPCS_XS_PCS_MMD_XPCS_VR_XS_PCS_DIG_STS, &_data);
	...
	if (pseq_state == 0x3 || pseq_state == 0x4)
		status->usxgmii_vr_reset_successful = 1;
	else
		status->usxgmii_vr_reset_successful = 0;
...
int gpy2xx_usxgmii_alignmentmarker_set(struct gpy211_device *phy,
				       struct gpy211_usxgmii_alignmentmarker *alignmentmarker)
{
	int ret = -EINVAL;
	u32 _data;
	u16 _usxgmii_mode;
	...
	if (phy == NULL || alignmentmarker == NULL) {
		LOG_WARN("WARN: NULL input pointer(s)\n");
		return -EINVAL;
	}
	...
	ret = PHY_XPCS_HWRD(phy, XPCS_XS_PCS_MMD_XPCS_VR_XS_PCS_AM_CTRL, &_data);
	...
	FIELD_REPLACE(_data, alignmentmarker->usxgmii_am_count, XPCS_VR_XS_PCS_AM_CTRL_AM_COUNT);
...
int gpy2xx_usxgmii_alignmentmarker_get(struct gpy211_device *phy,
				       struct gpy211_usxgmii_alignmentmarker *alignmentmarker)
{
	int ret = -EINVAL;
	u32 _data;
	...
	alignmentmarker->usxgmii_am_count = FIELD_GET(_data, XPCS_VR_XS_PCS_AM_CTRL_AM_COUNT);
...
int gpy2xx_usxgmii_tx_bert_config(struct gpy211_device *phy,
				  struct gpy211_usxgmii_tx_bert_config *bert_tx_config)
{
	...
	if (phy == NULL || bert_tx_config == NULL) {
		LOG_WARN("WARN: NULL input pointer(s)\n");
		return -EINVAL;
	}
	...
	switch (bert_tx_config->tx_bert_mode) {
	case BERT_SQUAREWAVE_TX:
		...
		FIELD_REPLACE(_data1, (bert_tx_config->nval_sel & 0x7), XPCS_VR_XS_PCS_KR_CTRL_NVAL_SEL);
...
int gpy2xx_usxgmii_tx_bert_config_get(struct gpy211_device *phy,
				      struct gpy211_usxgmii_tx_bert_config *bert_tx_config)
{
	int ret = -EINVAL;
	u32 _data = 0, _data1 = 0;
	...
	if (tp_sel == 1 && squarewave == 1 && prbs31 == 0 && prbs9 == 0) {
		bert_tx_config->tx_bert_mode = BERT_SQUAREWAVE_TX;
		...
		bert_tx_config->nval_sel	= FIELD_GET(_data, XPCS_VR_XS_PCS_KR_CTRL_NVAL_SEL);
	} else if (tp_sel == 0 && squarewave == 0 && prbs31 == 1 && prbs9 == 0) {
		bert_tx_config->tx_bert_mode = BERT_PRBS31_TX;
	} else if (tp_sel == 0 && squarewave == 0 && prbs31 == 0 && prbs9 == 1) {
		bert_tx_config->tx_bert_mode = BERT_PRBS9_TX;
	} else {
		bert_tx_config->tx_bert_mode = BERT_TX_MODE_DISABLE;
	}
...
int gpy2xx_usxgmii_rx_bert_config(struct gpy211_device *phy,
				  struct gpy211_usxgmii_rx_bert_config *bert_rx_config)
{
	...
	if (phy == NULL || bert_rx_config == NULL) {
		LOG_WARN("WARN: NULL input pointer(s)\n");
		return -EINVAL;
	}
	...
	switch (bert_rx_config->rx_bert_mode) {
	case BERT_PRBS31_RX:
...
int gpy2xx_usxgmii_rx_bert_config_get(struct gpy211_device *phy,
				      struct gpy211_usxgmii_rx_bert_config *bert_rx_config)
{
	int ret = -EINVAL;
	u32 _data = 0, _data1 = 0;
	...
	if (rtp == 0 && prbs31 == 1 && prbs9 == 0) {
		bert_rx_config->rx_bert_mode = BERT_PRBS31_RX;
	} else if (rtp == 0 && prbs31 == 0 && prbs9 == 1) {
		bert_rx_config->rx_bert_mode = BERT_PRBS9_RX;
	} else {
		bert_rx_config->rx_bert_mode = BERT_RX_MODE_DISABLE;
	}
...
int gpy2xx_usxgmii_rx_bert_statistics_get(struct gpy211_device *phy,
		struct gpy211_usxgmii_rx_bert_statistics *rx_bert_statistics)
{
	...
	if (phy == NULL || rx_bert_statistics == NULL) {
		LOG_WARN("WARN: NULL input pointer(s)\n");
		return -EINVAL;
	}
	...
	rx_bert_statistics->tp_error_count = FIELD_GET(_data, XPCS_SR_XS_PCS_TP_ERRCTR_TP_ERR_CNT);
	...
	rx_bert_statistics->error_block_count = FIELD_GET(_data, XPCS_SR_XS_PCS_KR_STS2_ERR_BLK);
	rx_bert_statistics->bit_error_rate_counter = FIELD_GET(_data, XPCS_SR_XS_PCS_KR_STS2_BER_CNT);
	...
	rx_bert_statistics->latched_high_bit_err_rate = FIELD_GET(_data, XPCS_SR_XS_PCS_KR_STS2_LAT_HBER);
	rx_bert_statistics->latched_block_lock = FIELD_GET(_data, XPCS_SR_XS_PCS_KR_STS2_LAT_BL);
...
int gpy2xx_usxgmii_loopback_set(struct gpy211_device *phy,
				struct gpy211_usxgmii_loopback_config *loopback)
{
	int ret = -EINVAL;
	u32 _data;
	u16 _usxgmii_mode;
	...
	if (loopback->tx_to_rx_serial_loopback_en)
		FIELD_REPLACE(_data, 1, XPCS_SR_PMA_CTRL1_LB);
	else
		FIELD_REPLACE(_data, 0, XPCS_SR_PMA_CTRL1_LB);
	...
	if (loopback->rx_to_tx_parallel_loopback_en)
		FIELD_REPLACE(_data, 1, XPCS_VR_XS_PCS_DIG_CTRL1_R2TLBE);
	else
		FIELD_REPLACE(_data, 0, XPCS_VR_XS_PCS_DIG_CTRL1_R2TLBE);
				...
				struct gpy211_usxgmii_loopback_config *loopback)
{
	...
	loopback->tx_to_rx_serial_loopback_en = FIELD_GET(_data, XPCS_SR_PMA_CTRL1_LB);
	...
	loopback->rx_to_tx_parallel_loopback_en = FIELD_GET(_data, XPCS_VR_XS_PCS_DIG_CTRL1_R2TLBE);
