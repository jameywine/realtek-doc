...
//! Field GPIO - GPIO Output Value
#define GPIO_PDI_REGISTERS_GPIO2_OUT_GPIO_MASK 0x7FFu
//! Constant LOW - LOW
...
//! Field GPIO - GPIO Input Value
#define GPIO_PDI_REGISTERS_GPIO2_IN_GPIO_MASK 0x7FFu
//! Constant LOW - LOW
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_DIR_RST 0x000007BFu

//! Field GPIO - GPIO Direction Control
#define GPIO_PDI_REGISTERS_GPIO2_DIR_GPIO_POS 0
//! Field GPIO - GPIO Direction Control
#define GPIO_PDI_REGISTERS_GPIO2_DIR_GPIO_MASK 0x7FFu
//! Constant IN - Input
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_ALTSEL0_RST 0x000007FFu

//! Field GPIO - GPIO Alternate Function Selection LSB
#define GPIO_PDI_REGISTERS_GPIO2_ALTSEL0_GPIO_POS 0
//! Field GPIO - GPIO Alternate Function Selection LSB
#define GPIO_PDI_REGISTERS_GPIO2_ALTSEL0_GPIO_MASK 0x7FFu
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_ALTSEL1_RST 0x000007FFu

//! Field GPIO - GPIO Alternate Function Selection MSB
#define GPIO_PDI_REGISTERS_GPIO2_ALTSEL1_GPIO_POS 0
//! Field GPIO - GPIO Alternate Function Selection MSB
#define GPIO_PDI_REGISTERS_GPIO2_ALTSEL1_GPIO_MASK 0x7FFu
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_OD_RST 0x000007FFu

//! Field GPIO - GPIO Open Drain Mode
#define GPIO_PDI_REGISTERS_GPIO2_OD_GPIO_POS 0
//! Field GPIO - GPIO Open Drain Mode
#define GPIO_PDI_REGISTERS_GPIO2_OD_GPIO_MASK 0x7FFu
//! Constant OD - Open Drain Mode
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_PUDSEL_RST 0x000007FFu

//! Field GPIO - GPIO Pull Up/Down Mode
#define GPIO_PDI_REGISTERS_GPIO2_PUDSEL_GPIO_POS 0
//! Field GPIO - GPIO Pull Up/Down Mode
#define GPIO_PDI_REGISTERS_GPIO2_PUDSEL_GPIO_MASK 0x7FFu
//! Constant PD - Pull Down
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_PUDEN_RST 0x000007FFu

//! Field GPIO - GPIO Pull Up/Down Enable
#define GPIO_PDI_REGISTERS_GPIO2_PUDEN_GPIO_POS 0
//! Field GPIO - GPIO Pull Up/Down Enable
#define GPIO_PDI_REGISTERS_GPIO2_PUDEN_GPIO_MASK 0x7FFu
//! Constant DIS - Disable
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_DRIVE0_CFG_RST 0x000007FFu

//! Field GPIO2 - GPIO2 PAD Drive Strength Bit 0
#define GPIO_PDI_REGISTERS_GPIO2_DRIVE0_CFG_GPIO2_POS 0
//! Field GPIO2 - GPIO2 PAD Drive Strength Bit 0
#define GPIO_PDI_REGISTERS_GPIO2_DRIVE0_CFG_GPIO2_MASK 0x7FFu
//! Constant V2MA - 2mA
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_DRIVE1_CFG_RST 0x000007FFu

//! Field GPIO2 - GPIO2 PAD Drive Strength Bit 1
#define GPIO_PDI_REGISTERS_GPIO2_DRIVE1_CFG_GPIO2_POS 0
//! Field GPIO2 - GPIO2 PAD Drive Strength Bit 1
#define GPIO_PDI_REGISTERS_GPIO2_DRIVE1_CFG_GPIO2_MASK 0x7FFu
//! Constant V2MA - 2mA
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_SLEW_CFG_RST 0x000007FFu

//! Field GPIO2 - GPIO PAD Slew Control
#define GPIO_PDI_REGISTERS_GPIO2_SLEW_CFG_GPIO2_POS 0
//! Field GPIO2 - GPIO PAD Slew Control
#define GPIO_PDI_REGISTERS_GPIO2_SLEW_CFG_GPIO2_MASK 0x7FFu
//! Constant SLOW - Slow
