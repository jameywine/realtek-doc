...
/** \addtogroup GPY211_LED */
/**@{*/
/** \brief LED ID 0 For 10M speed events on P31G, 10M & 100M on P34X */
#define LED_ID_0   			0
/** \brief LED ID 1 For 100M speed events on P31G, 1G on P34X */
#define LED_ID_1   			1
/** \brief LED ID 2 For 1G speed events on P31G, 2.5G on P34X */
#define LED_ID_2   			2
/** \brief LED ID 3 For 2.5G speed events on P31G, unsued on P34X */
#define LED_ID_3   			3
/** \cond INTERNAL */
...
struct gpy211_led_brlvl_cfg {
	...
	/** \brief Maximum brightness level. Applicable only when mode is CONSTANT.
		Level 0 will turns the LED off. */
	int lvl_max;
...
/** \addtogroup GPY211_P34X_USXGMII */
/**@{*/
/** \brief USXMGII EQ configuration (only for P34X) */
...
/** \brief USXMGII PCS/PMA link status (only for P34X) */
...
/** \brief USXMGII MII link status for each lane/slice (only for P34X) */
...
/** \brief USXMGII auto-negotiation status (only for P34X) */
...
/** \brief TX BERT mode (only for P34X) */
...
/** \brief SQUAREWAVE PERIOD (only for P34X) */
...
/** \brief TX BERT config (only for P34X) */
...
/** \brief RX BERT mode (only for P34X) */
...
/** \brief RX BERT config (only for P34X) */
...
/** \brief RX BERT statistics (only for P34X) */
...
/** \brief PCS/SERDES loopback mode (only for P34X) */
...
/**
	...
	\details Use this API to configure LED's switch edge detectio of rising vs
...
/**
	...
	gpy2xx_led_br_cfg like switch edge detectio of rising vs falling edge,
