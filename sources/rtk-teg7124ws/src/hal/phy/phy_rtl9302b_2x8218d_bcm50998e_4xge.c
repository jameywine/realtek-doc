 ...
 */
int32 phy_rtl9302b_2x8218d_bcm50998e_4XGE_init(uint32 unit, rtk_port_t port);
int32 phy_rtl9302b_2x8218d_bcm50998e_4XGE_port_init(uint32 unit, rtk_port_t port);
int32 phy_rtl9302b_2x8218d_bcm50998e_4XGE_eye_diagram_init(uint32 unit);

extern phyp_senao_phy_info_t *senao_non_rtl_phy_info;

/* Function Name:
 *      phy_rtl9302b_2x8218d_bcm50998e_4xgedrv_identify
 * Description:
 ...
 */
int32
phy_rtl9302b_2x8218d_bcm50998e_4xgedrv_identify(uint32 unit, rtk_port_t port, uint32 model_id, uint32 rev_id)
{
    int32                   ret = 0;
    uint32                  reg1d2 = 0;
    uint32                  reg1d3 = 0;
    ...
    if(phy_board_type != RTL9302B_BCM50998_BOARD_TYPE_1)
...
/* Function Name:
 *      phy_rtl9302b_2x8218d_bcm50998e_4XGE_speed_set
 * Description:
 ...
 */
int32
phy_rtl9302b_2x8218d_bcm50998e_4XGE_speed_set(uint32 unit, rtk_port_t port, uint32 speed)
{
...
#endif
/* Function Name:
 *      phy_rtl9302b_2x8218d_bcm50998e_4XGE_init
 * Description:
 *      Initialize PHY.
 * Input:
 *      unit - unit id
 ...
 */
int32
phy_rtl9302b_2x8218d_bcm50998e_4XGE_init(uint32 unit, rtk_port_t port)
{
    ...
    if (upgrade_once_flag == 0)
    {
        ...
        if (pHalCtrlx != NULL)
        {
            if ((rv = MACDRV(pHalCtrlx)->fMdrv_miim_mmd_read(unit, port, 30, 0x400f, &fw_version)) != RT_ERR_OK)
    ...
    if(phy_rtl9302b_2x8218d_bcm50998e_4XGE_port_init(unit, port)!= RT_ERR_OK)
    {
        return RT_ERR_FAILED;
    }
    ...
    /************************************************************************************************************************/
    /*GET:PAIR-SWAP*/
    bcm_plp_reg_value_set(chipname, ((bcm_plp_access_t){&p_ctxt_phy_bcm50998, bcm_phy_id, 0, 0x1}),  0x1e, 0x4005, 0x8000);
    bcm_plp_reg_value_get(chipname, ((bcm_plp_access_t){&p_ctxt_phy_bcm50998, bcm_phy_id, 0, 0x1}),  0x1e, 0x4037, &regval_37);
    bcm_plp_reg_value_get(chipname, ((bcm_plp_access_t){&p_ctxt_phy_bcm50998, bcm_phy_id, 0, 0x1}),  0x1e, 0x4038, &regval_38);
    bcm_plp_reg_value_get(chipname, ((bcm_plp_access_t){&p_ctxt_phy_bcm50998, bcm_phy_id, 0, 0x1}),  0x1e, 0x4039, &regval_39);
    bcm_plp_reg_value_get(chipname, ((bcm_plp_access_t){&p_ctxt_phy_bcm50998, bcm_phy_id, 0, 0x1}),  0x1e, 0x403A, &regval_3a);
    bcm_plp_reg_value_get(chipname, ((bcm_plp_access_t){&p_ctxt_phy_bcm50998, bcm_phy_id, 0, 0x1}),  0x1e, 0x403B, &regval_3b);
    bcm_plp_reg_value_get(chipname, ((bcm_plp_access_t){&p_ctxt_phy_bcm50998, bcm_phy_id, 0, 0x1}),  0x1e, 0x403C, &regval_3c);

    /*phy_osal_time_mdelay(250);*/
    osal_time_mdelay(250);

    /*SET:PAIR-SWAP*/
    if ((port==17) || (port==19) || (port==21) || (port==23))
    {
        bcm_plp_reg_value_set(chipname, ((bcm_plp_access_t){&p_ctxt_phy_bcm50998, bcm_phy_id, 0, 0x1}),  0x1e, 0x4039, 0x006c);
        bcm_plp_reg_value_set(chipname, ((bcm_plp_access_t){&p_ctxt_phy_bcm50998, bcm_phy_id, 0, 0x1}),  0x1e, 0x4005, 0x8001);
        bcm_plp_reg_value_get(chipname, ((bcm_plp_access_t){&p_ctxt_phy_bcm50998, bcm_phy_id, 0, 0x1}),  0x1e, 0x4037, &regval_37);
        bcm_plp_reg_value_get(chipname, ((bcm_plp_access_t){&p_ctxt_phy_bcm50998, bcm_phy_id, 0, 0x1}),  0x1e, 0x4039, &regval_39);
    }
    /************************************************************************************************************************/
    ...
    if(phy_rtl9302b_2x8218d_bcm50998e_4XGE_eye_diagram_init(unit)!= RT_ERR_OK)
    {
        return RT_ERR_FAILED;
    }

    /*20K Alignment Marker*/
    /*if((hal_serdes_reg_set(unit, 4, 6, 18, 0xc8)) != RT_ERR_OK)
        return RT_ERR_FAILED;
    if((hal_serdes_reg_set(unit, 5, 6, 18, 0xc8)) != RT_ERR_OK)
        return RT_ERR_FAILED;*/

    /*128.6K Alignment Marker, for B0-v02-02-03*/
    if((hal_serdes_reg_set(unit, 4, 6, 18, 0x506)) != RT_ERR_OK)
        return RT_ERR_FAILED;
    if((hal_serdes_reg_set(unit, 5, 6, 18, 0x506)) != RT_ERR_OK)
        return RT_ERR_FAILED;

    /*Disable serdes 4 AN*/
    if((hal_serdes_reg_set(unit, 4, 7, 17, 0x0540)) != RT_ERR_OK)
        return RT_ERR_FAILED;

    /*Disable serdes 5 AN*/
    if((hal_serdes_reg_set(unit, 5, 7, 17, 0x0540)) != RT_ERR_OK)
        return RT_ERR_FAILED;

    /*---------------------------------------------*/
    /* Register default value for MAC's flow-control */
    /* LONGAN_FC_PORT_ACT_CTRLr [0xBB00D804] */
    /* Bits[12] : ACT ; Bits[11:0] : ALLOW_PAGE_CNT */
    /* For copper ports */
    ioal_mem32_write(unit, 0xD844, 0x0000107f);
    ioal_mem32_write(unit, 0xD848, 0x0000107f);
    ioal_mem32_write(unit, 0xD84C, 0x0000107f);
    ioal_mem32_write(unit, 0xD850, 0x0000107f);
    ioal_mem32_write(unit, 0xD854, 0x0000107f);
    ioal_mem32_write(unit, 0xD858, 0x0000107f);
    ioal_mem32_write(unit, 0xD85C, 0x0000107f);
    ioal_mem32_write(unit, 0xD860, 0x0000107f);
...
int32
phy_rtl9302b_2x8218d_bcm50998e_4XGE_port_init(uint32 unit, rtk_port_t port)
{
    hal_control_t   *pHalCtrl;
    int32           ret = 0;
    unsigned int    or_data = 0;
...
int32
phy_rtl9302b_2x8218d_bcm50998e_4XGE_eye_diagram_init(uint32 unit)
{
    hal_control_t   *pHalCtrl;
    int32           ret = 0;
...
/* Function Name:
 *      phy_rtl9302b_2x8218d_bcm50998e_4XGE_reset_set
 * Description:
 ...
 */
int32
phy_rtl9302b_2x8218d_bcm50998e_4XGE_reset_set(uint32 unit, rtk_port_t port)
{
 ...
 */
void
phy_rtl9302b_2x8218d_bcm50998e_4xgedrv_mapperInit(rt_phydrv_t *pPhydrv)
{
    ...
    pPhydrv->fPhydrv_speed_set = phy_rtl9302b_2x8218d_bcm50998e_4XGE_speed_set;
    ...
    pPhydrv->fPhydrv_reset_set = phy_rtl9302b_2x8218d_bcm50998e_4XGE_reset_set;
}
