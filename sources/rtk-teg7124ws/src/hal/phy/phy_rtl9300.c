...
#ifdef CONFIG_SDK_PHY_CUST1
/*SENAO eye param init*/
/* Starry@20230210 GPY2xx use 10gEyeParam_load setting -S */
#ifdef CONFIG_SDK_PHY_GPY2xx
    dal_longan_sds_10gEyeParam_load(unit, sdsId);
#endif
/* Starry@20230210 GPY2xx use 10gEyeParam_load setting -E */ 
#else
    dal_longan_sds_10gEyeParam_load(unit, sdsId);
#endif
#endif
