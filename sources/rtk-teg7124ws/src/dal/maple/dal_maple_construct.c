...
static confcode_mac_regval_t rtl8380_serdes01_qsgmii_6275b_8218d[] = {
  {0x0ff8, 0xaaaaaaaf},{0xf38c, 0x0000f46f},
  {0xf388, 0x000085fa},{0xf488, 0x000085fa},{0xf398, 0x000020d8},{0xf498, 0x000020d8},
  {0xf3c4, 0x0000B7C9},{0xf4ac, 0x00000482},{0xf4a8, 0x000080c7},{0xf3c8, 0x0000ab8e},
  {0xf3ac, 0x00000482},{0xf3cc, 0x000024ab},{0xf4c4, 0x00004208},{0xf4c8, 0x0000c208},
...
static confcode_mac_regval_t rtl8380_serdes23_qsgmii_6275b_8218d[] = {
  {0xf58c, 0x0000f46d},
  {0xf588, 0x000085fa},{0xf688, 0x000085fa},{0xf788, 0x000085fa},{0xf598, 0x000020d8},
  {0xf698, 0x000020d8},{0xf5c4, 0x0000B7C9},{0xf5c8, 0x0000ab8e},{0xf5ac, 0x00000482},
  {0xf6ac, 0x00000482},{0xf5cc, 0x000024ab},{0xf6c4, 0x00004208},{0xf6c8, 0x0000c208},
...
void dal_maple_construct_serdesConfig_init(uint32 unit)
{
    ...
    else
    {
        ...
        else if(HWP_SDS_MODE(unit,0) == RTK_MII_QSGMII)
        {
            ...
            if(HWP_SDS_ID2PHYMODEL(unit, 0) == RTK_PHYTYPE_RTL8218D)
            {
                /*Save 0xbb000FF8 bit0-bit3 from Array*/
                ...
                for (i=0; i<(sizeof(rtl8380_serdes01_qsgmii_6275b_8218d)/sizeof(confcode_mac_regval_t)); i++)
                {
                    ioal_mem32_write(unit, rtl8380_serdes01_qsgmii_6275b_8218d[i].reg,  rtl8380_serdes01_qsgmii_6275b_8218d[i].val);
                    osal_time_mdelay(1);
                }
            }
            else
        ...
        {
            if(HWP_SDS_ID2PHYMODEL(unit, 2) == RTK_PHYTYPE_RTL8218D)
            {
                for (i=0; i<(sizeof(rtl8380_serdes23_qsgmii_6275b_8218d)/sizeof(confcode_mac_regval_t)); i++)
                {
                    ioal_mem32_write(unit, rtl8380_serdes23_qsgmii_6275b_8218d[i].reg,  rtl8380_serdes23_qsgmii_6275b_8218d[i].val);
                    osal_time_mdelay(1);
                }
            }
            else
