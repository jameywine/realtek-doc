...
{
#if (defined(CONFIG_SDK_RTL8390) || defined(CONFIG_SDK_RTL8380) || defined(CONFIG_SDK_RTL9300)) && !defined(CONFIG_SDK_RTL9330)
    ...
    INDIRECT_CTRL_GROUP_SET6,
#endif
#if (defined(CONFIG_SDK_RTL9330))
    INDIRECT_CTRL_GROUP_SET7,
    INDIRECT_CTRL_GROUP_SET8,
    INDIRECT_CTRL_GROUP_SET9,
    INDIRECT_CTRL_GROUP_SET10,
#endif
...
MEM_ENTRY_DECLARE(multicast_index_entry_t, 4);
MEM_ENTRY_DECLARE(port_iso_entry_t, 3);

MEM_ENTRY_DECLARE(vlan_entry_t, 4);

#if (defined(CONFIG_SDK_RTL8390) || defined(CONFIG_SDK_RTL8380) || defined(CONFIG_SDK_RTL9310) || defined(CONFIG_SDK_RTL9300)) || defined(CONFIG_SDK_RTL9311B) || defined(CONFIG_SDK_RTL9330)
...
#if (defined(CONFIG_SDK_RTL9310) || defined(CONFIG_SDK_RTL9300) || defined(CONFIG_SDK_RTL9311B) || defined(CONFIG_SDK_RTL9330))
MEM_ENTRY_DECLARE(lag_entry_t, 4);
...
MEM_ENTRY_DECLARE(l3_host_route_entry_t, 13);
MEM_ENTRY_DECLARE(l3_prefix_route_entry_t, 6);
MEM_ENTRY_DECLARE(l3_ecmp_entry_t, 6);
MEM_ENTRY_DECLARE(l3_nexthop_entry_t, 3);
...
#if (defined(CONFIG_SDK_RTL9310) || defined(CONFIG_SDK_RTL9311B))
MEM_ENTRY_DECLARE(mib_portPrvteCntr_entry_t, 52);
MEM_ENTRY_DECLARE(mib_portPrvteEQCntr_entry_t, 8);
#endif

#if defined(CONFIG_SDK_RTL9330)
MEM_ENTRY_DECLARE(ipp_bd_entry_t, 4);
MEM_ENTRY_DECLARE(ipp_mc_pmsk_entry_t, 4);
MEM_ENTRY_DECLARE(ipp_iva_pf_entry_t, 8);
MEM_ENTRY_DECLARE(tm_igr_pg_cntr_entry_t, 16);
MEM_ENTRY_DECLARE(tm_mc_abs_pg_cntr_entry_t, 4);
MEM_ENTRY_DECLARE(tm_mir_abs_pg_cntr_entry_t, 3);
MEM_ENTRY_DECLARE(tm_cpu_abs_pg_cntr_entry_t, 3);
MEM_ENTRY_DECLARE(tm_egr_q_cntr_entry_t, 60);
MEM_ENTRY_DECLARE(tm_e2e_q_stat_entry_t, 16);
MEM_ENTRY_DECLARE(dbg_iport_cnt_entry_t, 4);
MEM_ENTRY_DECLARE(dbg_eport_cnt_entry_t, 8);
MEM_ENTRY_DECLARE(mib_portCounter_entry_t, 53);
MEM_ENTRY_DECLARE(mib_portPrvteCounter_entry_t, 30);
MEM_ENTRY_DECLARE(mib_portPrvteEQCounter_entry_t, 38);
#endif
...
#if defined(CONFIG_SDK_RTL9330)
MEM_ENTRY_DECLARE(lmep_tx_entry_t, 17);
MEM_ENTRY_DECLARE(ma_state_entry_t, 3);
MEM_ENTRY_DECLARE(rmep_rx_entry_t, 2);
MEM_ENTRY_DECLARE(lmep_entry_t, 3);
MEM_ENTRY_DECLARE(rmep_entry_t, 3);
#endif
