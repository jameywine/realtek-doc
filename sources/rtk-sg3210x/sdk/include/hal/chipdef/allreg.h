...
#define CONFIG_SDK_REG_DFLT_VAL
#define CONFIG_SDK_REG_FIELD_TYPE
#else
...
typedef enum rtk_field_type_e
{
    ...
    FIELD_TYPE_RWAC,          /* read, write, write 1 and auto clear to 0 after command done*/
...
#if defined(CONFIG_SDK_REG_DFLT_VAL)
#define RTK_REG_FIELD_DFLT_VAL(value)     value
#else
#define RTK_REG_FIELD_DFLT_VAL(value)
#endif
