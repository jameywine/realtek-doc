...
typedef struct rt_macdrv_s
{
    ...
    int32   (*fMdrv_construct_reg_write)(uint32 , uint32, uint32, uint32, uint32);
} rt_macdrv_t;
...
#endif
#if defined(CONFIG_SDK_RTL9311B)
extern rt_driver_t rtl9311b_a_driver;
#endif
#if defined(CONFIG_SDK_RTL9300)
extern rt_driver_t rtl9300_a_driver;
#endif
#if defined(CONFIG_SDK_RTL9330)
extern rt_driver_t rtl9330_a_driver;
#endif
/*
