 ...
 */
extern int32
phy_rtl9310_10gmedia_get(uint32 unit, rtk_port_t port, rtk_port_serdesMedia_t *pMedia);

/* Function Name:
 *      phy_rtl9310_serdesMedia_set
 * Description:
 *
 * Input:
 *      unit - unit id
...
extern int32
phy_rtl9310_serdesMedia_set(uint32 unit, rtk_port_t port, rtk_port_serdesMedia_t media);
 ...
 */
extern int32
phy_rtl9310_sdsCustConfig_init(uint32 unit, uint32 sds, rtk_port_serdesMedia_t media);
 ...
 */
extern int32
phy_rtl9310_exit(uint32 unit, rtk_port_t port);
