 ...
 */
extern int32
phy_9300_10gmedia_get(uint32 unit, rtk_port_t port, rtk_port_serdesMedia_t *pMedia);

/* Function Name:
 *      phy_9300_serdesMedia_set
 * Description:
 *
 * Input:
 *      unit - unit id
 ...
 */
extern int32
phy_9300_serdesMedia_set(uint32 unit, rtk_port_t port, rtk_port_serdesMedia_t media);
