...
#if PHY_826X_FT_API
extern int32 phy_826x_R_cal(uint32 unit, rtk_port_t port);
extern int32 phy_826x_RC_cal(uint32 unit, rtk_port_t port);
extern int32 phy_826x_DAC_cal(uint32 unit, rtk_port_t port);
#endif
