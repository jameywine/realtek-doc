...
void rtl8214fc_rtl8390_post_config(uint32 unit, uint32 baseMacId);
...
void phy_construct_config_init(uint32 phy_index);
void phy_construct_reset(uint32 phy_index);
void phy_construct_sdsRx_reset(uint32 phy_index);
