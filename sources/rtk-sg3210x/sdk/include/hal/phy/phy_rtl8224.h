...
#define PHY_8224_TGR_STD_1_PAGE                     (0x5)
#define PHY_8224_TGR_STD_1_REG0                     (0x0)
#define PHY_8224_TGR_STD_1_REG0_LINK_ON_OFFSET      (12)
#define PHY_8224_TGR_STD_1_REG0_LINK_ON_MASK        (1 << PHY_8224_TGR_STD_1_REG0_LINK_ON_OFFSET)
#define PHY_8224_TGR_STD_1_REG0_HI_BER_OFFSET       (1)
#define PHY_8224_TGR_STD_1_REG0_HI_BER_MASK         (1 << PHY_8224_TGR_STD_1_REG0_HI_BER_OFFSET)

#define PHY_8224_WDIG_PAGE                          (0x1f)
#define PHY_8224_WDIG_REG02                         (0x2)
#define PHY_8224_WDIG_REG21                         (0x15)
#define PHY_8224_WDIG_REG21_RXIDEL_OFFSET           (7)
#define PHY_8224_WDIG_REG21_RXIDEL_MASK             (1 << PHY_8224_WDIG_REG21_RXIDEL_OFFSET)
#define PHY_8224_WDIG_REG21_NSQ_OFFSET              (6)
#define PHY_8224_WDIG_REG21_NSQ_MASK                (1 << PHY_8224_WDIG_REG21_NSQ_OFFSET)

#define PHY_8224_ANA_MISC_PAGE                      (0x20)
#define PHY_8224_ANA_MISC_REG0                      (0)
#define PHY_8224_FRC_RX_EN_VAL_BIT                  (5)
#define PHY_8224_FRC_RX_EN_ON_BIT                   (4)

#define PHY_8224_ANA_COM_PAGE                       (0x21)
#define PHY_8224_ANA_COM_REG00                      (0)
#define PHY_8224_RX_EN_TEST_BIT                     (2)

#define PHY_8224_ANA_COM_EXT_PAGE                   (0x36)
#define PHY_8224_ANA_COM_EXT_REG05                  (0x5)
...
/* Function Name:
 *      phy_8224_sdsRx_reset
 * Description:
 *      Check SerDes RX status, if not okay, reset it
 * Input:
 *      unit      - unit id
 *      port      - port id
 * Output:
 ...
 */
extern int32
phy_8224_sdsRx_reset(uint32 unit, rtk_port_t port);
