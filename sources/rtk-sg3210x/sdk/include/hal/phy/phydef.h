...
#define PHY_MODEL_ID_RTL8213B           (0x14)
#define PHY_MODEL_ID_RTL8363SC_VB       (0x14)
...
typedef enum phy_type_e {
    ...
    RTK_PHYTYPE_RTL8213B,
    RTK_PHYTYPE_RTL8363SC_VB,
    RTK_PHYTYPE_SERDES,
    RTK_PHYTYPE_CUST1,
...
#define RTK_PHYTYPE_STRING_RTL8213B          "RTL8213B"
#define RTK_PHYTYPE_STRING_RTL8363SC_VB      "RTL8363SC_VB"
...
#define RTK_PHYTYPE_STRING                                  \
    (uint8 *)RTK_PHYTYPE_STRING_NONE,              /* RTK_PHYTYPE_STRING_NONE */    \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8208D,          /* RTK_PHYTYPE_RTL8208D */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8208G,          /* RTK_PHYTYPE_RTL8208G */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8208L,          /* RTK_PHYTYPE_RTL8208L */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8208L_INT,      /* RTK_PHYTYPE_RTL8208L_INT */   \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8212B,          /* RTK_PHYTYPE_RTL8212B */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8214FB,         /* RTK_PHYTYPE_RTL8214FB */      \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8214B,          /* RTK_PHYTYPE_RTL8214B */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8214FC,         /* RTK_PHYTYPE_RTL8214FC */      \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8214C,          /* RTK_PHYTYPE_RTL8214C */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8218B,          /* RTK_PHYTYPE_RTL8218B */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8218FB,         /* RTK_PHYTYPE_RTL8218FB */      \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8218D,          /* RTK_PHYTYPE_RTL8218D */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8295R,          /* RTK_PHYTYPE_RTL8295R */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8214QF,         /* RTK_PHYTYPE_RTL8214QF */      \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8224QF,         /* RTK_PHYTYPE_RTL8224QF */      \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8218D_NMP,      /* RTK_PHYTYPE_RTL8218D_NMP */   \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8295R_C22,      /* RTK_PHYTYPE_RTL8295R_C22 */   \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8214QF_NC5,     /* RTK_PHYTYPE_RTL8214QF_NC5 */  \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8226,           /* RTK_PHYTYPE_RTL8226 */        \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8226B,          /* RTK_PHYTYPE_RTL8226B */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8261,           /* RTK_PHYTYPE_RTL8261 */        \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8264,           /* RTK_PHYTYPE_RTL8264 */        \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8218E,          /* RTK_PHYTYPE_RTL8218E */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8261I,          /* RTK_PHYTYPE_RTL8261I */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8264I,          /* RTK_PHYTYPE_RTL8264I */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8251 ,          /* RTK_PHYTYPE_RTL8251 */        \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8254 ,          /* RTK_PHYTYPE_RTL8254 */        \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8251I,          /* RTK_PHYTYPE_RTL8251I */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8254I,          /* RTK_PHYTYPE_RTL8254I */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8251L,          /* RTK_PHYTYPE_RTL8251L */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8254L,          /* RTK_PHYTYPE_RTL8254L */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8224 ,          /* RTK_PHYTYPE_RTL8224 */        \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8261B,          /* RTK_PHYTYPE_RTL8261B */        \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8261BE,         /* RTK_PHYTYPE_RTL8261BE */        \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8264B,          /* RTK_PHYTYPE_RTL8264B */        \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8213B,          /* RTK_PHYTYPE_RTL8213B */       \
    (uint8 *)RTK_PHYTYPE_STRING_RTL8363SC_VB,      /* RTK_PHYTYPE_RTL8363SC_VB */   \
    (uint8 *)RTK_PHYTYPE_STRING_SERDES,            /* RTK_PHYTYPE_SERDES */         \
    (uint8 *)RTK_PHYTYPE_STRING_CUST1,             /* RTK_PHYTYPE_CUST1 */          \
    (uint8 *)RTK_PHYTYPE_STRING_UNKNOWN,           /* RTK_PHYTYPE_UNKNOWN */        \
    (uint8 *)RTK_PHYTYPE_STRING_INVALID,           /* RTK_PHYTYPE_INVALID */        \
...
#define PHY_RT_OUI_CHK(id_1_data, id_2_data)           ((id_1_data == PHY_IDENT_OUI_03_18) && ((id_2_data >> OUI_19_24_OFFSET) == PHY_IDENT_OUI_19_24))
...
#define PHY_RESL_STS_SPEED(status)      _dal_phy_resolutionResult2Speed_get(status)
...
typedef struct rt_phydrv_s
{
    ...
    int32   (*fPhydrv_exit)(uint32, rtk_port_t);
    ...
    int32   (*fPhydrv_autoNegoAbilityLinkPartner_get)(uint32, rtk_port_t, rtk_port_phy_ability_t *);
    ...
    int32   (*fPhydrv_serdesMedia_get)(uint32, rtk_port_t, rtk_port_serdesMedia_t *);
    int32   (*fPhydrv_serdesMedia_set)(uint32, rtk_port_t, rtk_port_serdesMedia_t);
    ...
    int32   (*_fPhydrv_macIntfSerdes_reset)(uint32, rtk_port_t);
    int32   (*_fPhydrv_serdes_linkdown_chk)(uint32, rtk_port_t, uint32 *);
    int32   (*_fPhydrv_swMacPollPhyStatus_get)(uint32, rtk_port_t, rtk_port_swMacPollPhyStatus_t *);
