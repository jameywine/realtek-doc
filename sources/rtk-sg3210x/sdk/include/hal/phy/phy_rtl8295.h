...
extern int32
phy_8295r_serdesMedia_get(uint32 unit, rtk_port_t port, rtk_port_serdesMedia_t *pMedia);

extern int32
phy_8295r_serdesMedia_set(uint32 unit, rtk_port_t port, rtk_port_serdesMedia_t media);
