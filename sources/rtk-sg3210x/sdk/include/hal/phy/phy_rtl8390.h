 ...
 *      phy_8390_enable_get
 * Description:
 *      Get interface status of the specific port
 * Input:
 *      unit          - unit id
 *      port          - port id
 * Output:
 *      pEnable       - pointer to admin status of PHY interface
 * Return:
 *      RT_ERR_OK     - OK
 *      RT_ERR_FAILED - invalid parameter
 * Note:
 ...
 */
extern int32
phy_8390_enable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable);
...
int32
phy_8390_serdesMedia_get(uint32 unit, rtk_port_t port, rtk_port_serdesMedia_t *media);

int32
phy_8390_serdesMedia_set(uint32 unit, rtk_port_t port, rtk_port_serdesMedia_t media);
 ...
 *      phy_rtl8390_exit
 * Description:
 *      Exit switch module of the specified device.
 * Input:
 *      unit          - unit id
 *      port - port id
 * Output:
 ...
 */
extern int32
phy_rtl8390_exit(uint32 unit, rtk_port_t port);
