...
#define PHY_RTL8264_OP_BCAST_SAME_CHIP  2
 ...
 *      None
 */
extern int32 phy_rtl826x_broadcast_patch(uint32 unit, uint8 port, uint8 portOffset, uint8 perChip);
