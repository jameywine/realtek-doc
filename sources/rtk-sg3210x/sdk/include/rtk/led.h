 ...
 *      rtk_led_clk_get
 * Description:
 *      Get LED clock period time
 * Input:
 *      unit  - unit id
 * Output:
 *      pClk - clock period time
 * Return:
 *      RT_ERR_OK
 *      RT_ERR_FAILED
 *      RT_ERR_UNIT_ID      - invalid unit id
 ...
 */
extern int32
rtk_led_clk_get(uint32 unit, rtk_led_clk_t *pClk);

/* Function Name:
 *      rtk_led_clk_set
 * Description:
 *      Set LED clock period time
 * Input:
 *      unit - unit id
 *      clk - clock period time
 * Output:
 *      None
 * Return:
 *      RT_ERR_OK
 ...
 */
extern int32
rtk_led_clk_set(uint32 unit, rtk_led_clk_t clk);
