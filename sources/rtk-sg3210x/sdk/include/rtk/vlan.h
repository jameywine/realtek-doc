 ...
 * Symbol Definition
 */
typedef enum rtk_vlan_fldMode_e
{
    VLAN_FLD_MODE_ALL_PORTS = 0, /* flood to all ports */
    VLAN_FLD_MODE_VLAN_MEMBER,         /* flood to VLAN member */
    VLAN_FLD_MODE_END
} rtk_vlan_fldMode_t;
...
typedef enum rtk_vlan_vlanAct_e {
    VLAN_ACT_NONE = 0,
    VLAN_ACT_IVID,
    VLAN_ACT_OVID,
    VLAN_ACT_IPCP,
...
typedef struct rtk_vlan_protoVlanCfg_s
{
    ...
    /* action */
    rtk_vlan_tagVidAct_t        ut_ivid_action;
    rtk_vlan_tagVidAct_t        sit_ivid_action;
    rtk_vlan_tagVidAct_t        sot_ivid_action;
    rtk_vlan_tagVidAct_t        dt_ivid_action;
    rtk_vlan_tagVidAct_t        ut_ovid_action;
    rtk_vlan_tagVidAct_t        sit_ovid_action;
    rtk_vlan_tagVidAct_t        sot_ovid_action;
    rtk_vlan_tagVidAct_t        dt_ovid_action;
    rtk_vlan_tagPriorityAct_t   ut_ipcp_action;
    rtk_vlan_tagPriorityAct_t   sit_ipcp_action;
    rtk_vlan_tagPriorityAct_t   sot_ipcp_action;
    rtk_vlan_tagPriorityAct_t   dt_ipcp_action;
    rtk_vlan_tagPriorityAct_t   ut_opcp_action;
    rtk_vlan_tagPriorityAct_t   sit_opcp_action;
    rtk_vlan_tagPriorityAct_t   sot_opcp_action;
    rtk_vlan_tagPriorityAct_t   dt_opcp_action;
#endif
} rtk_vlan_protoVlanCfg_t;

/* configuration of each protocol dbl vlan */
typedef struct rtk_vlan_protoDblVlanCfg_s
{
    rtk_enable_t    dbl_vid_assign;
    rtk_enable_t    dbl_pri_assign;
    rtk_vlan_t  dbl_vid;
    rtk_pri_t   dbl_pri;
} rtk_vlan_protoDblVlanCfg_t;
...
/* Function Name:
 *      rtk_vlan_portEgrTpidEntry_get
 * Description:
 *      Get egress port TPID configration on specified port.
 * Input:
 *      unit    - unit id
 *      port    - port id
 *      type    - vlan tag type
 ...
 */
extern int32
rtk_vlan_portEgrTpidEntry_get(uint32 unit, rtk_port_t port, rtk_vlan_tagType_t type, uint32 *pTpid);

/* Function Name:
 *      rtk_vlan_portEgrTpidEntry_set
 * Description:
 *      Set egress port TPID configration on specified port.
 * Input:
 *      unit    - unit id
 *      port    - port id
 *      type    - vlan tag type
 ...
 */
extern int32
rtk_vlan_portEgrTpidEntry_set(uint32 unit, rtk_port_t port, rtk_vlan_tagType_t type, uint32 tpid);
...
/* Function Name:
 *      rtk_vlan_portProtoVlanAssDblTagEn_get
 * Description:
 *      Get assign double tag en configuration.
 * Input:
 *      unit           - unit id
 * Output:
 *      pEnable - assign double tag en
 * Return:
 *      RT_ERR_OK
 *      RT_ERR_FAILED
 *      RT_ERR_UNIT_ID      - invalid unit id
 ...
 */
extern int32
rtk_vlan_portProtoVlanAssDblTagEn_get(uint32 unit, rtk_enable_t *pEnable);

/* Function Name:
 *      rtk_vlan_portProtoVlanAssDblTagEn_set
 * Description:
 *      Set assign double tag en configuration.
 * Input:
 *      unit           - unit id
 *      enable - assign double tag en
 * Output:
 *      none
 * Return:
 *      RT_ERR_OK
 ...
 */
extern int32
rtk_vlan_portProtoVlanAssDblTagEn_set(uint32 unit, rtk_enable_t enable);

/* Function Name:
 *      rtk_vlan_portProtoDblVlan_get
 * Description:
 *      Get VLAN and priority configuration of specified protocol group on port.
 * Input:
 *      unit           - unit id
 ...
 *      protoGroup_idx - protocol group index
 * Output:
 *      pDblVlan_cfg      - pointer to vlan configuration of protocol group
 * Return:
 *      RT_ERR_OK
 *      RT_ERR_FAILED
 *      RT_ERR_UNIT_ID      - invalid unit id
 ...
 */
extern int32
rtk_vlan_portProtoDblVlan_get(uint32 unit, rtk_port_t port, uint32 protoGroup_idx, rtk_vlan_protoDblVlanCfg_t *pDblVlan_cfg);

/* Function Name:
 *      rtk_vlan_portProtoDblVlan_set
 * Description:
 *      Set the other VLAN and priority configuration of specified protocol group on port.
 * Input:
 *      unit           - unit id
 *      port           - port id
 *      protoGroup_idx - protocol group index
 *      pDblVlan_cfg      - vlan configuration of protocol group
 * Output:
 *      None
 * Return:
 *      RT_ERR_OK
 ...
 */
extern int32
rtk_vlan_portProtoDblVlan_set(uint32 unit, rtk_port_t port, uint32 protoGroup_idx, rtk_vlan_protoDblVlanCfg_t *pDblVlan_cfg);

/* Function Name:
 *      rtk_vlan_fldMode_get
 * Description:
 *      Get vlan flood mode.
 * Input:
 *      unit           - unit id
 * Output:
 *      pFldMode - status of flood mode
 * Return:
 *      RT_ERR_OK
 *      RT_ERR_FAILED
 *      RT_ERR_UNIT_ID      - invalid unit id
 ...
 */
extern int32
rtk_vlan_fldMode_get(uint32 unit, rtk_vlan_fldMode_t *pFldMode);

/* Function Name:
 *      rtk_vlan_fldMode_set
 * Description:
 *      Set vlan flood mode.
 * Input:
 *      unit           - unit id
 *      fldMode - status of flood mode
 * Output:
 *      none
 * Return:
 *      RT_ERR_OK
 ...
 */
extern int32
rtk_vlan_fldMode_set(uint32 unit, rtk_vlan_fldMode_t fldMode);
