...
#if (defined(CONFIG_SDK_APP_DIAG_EXT) && (defined (CONFIG_SDK_RTL9300) || defined(CONFIG_SDK_RTL9311B)))
...
#define RTK_DIAG_TBL_DATAREG_NUM_MAX  128  // number of 4bytes
#define RTK_DIAG_TBL_FIELD_WORDS_MAX  96   // number of 4bytes
 ...
 */
extern int32
rtk_diag_regArrayField_read(uint32 unit, uint32 reg, int32 index_1, int32 index_2, uint32 field, uint32 *pValue, uint32  *pData);

/* Function Name:
 *      rtk_diag_regArrayField_write
 * Description:
 ...
 */
extern int32
rtk_diag_regArrayField_write(uint32 unit, uint32 reg, int32 index_1, int32 index_2, uint32 field, uint32 *pValue, uint32  *pData);
 ...
 */
int32
rtk_diag_regField_read(uint32 unit, uint32 reg, uint32 field, uint32 *pValue, uint32 *pData);
