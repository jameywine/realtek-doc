...
/* Function Name:
 *      rtk_oam_cfmCcmInstPcp_get
 * Description:
 *      Get outer PCP for instance member to be inserted to generated CCM frame.
 * Input:
 *      unit     - unit id
 *      instance - tx control entry instance
 * Output:
 *      pPcp     - pointer buffer of PCP
 * Return:
 *      RT_ERR_OK
 *      RT_ERR_FAILED
 *      RT_ERR_UNIT_ID      - invalid unit id
 ...
 *      9330
 * Note:
 *      Support configurate fields for generate VLAN tag of CCM frame is as following:
 *      - Outer Vid             is setting by rtk_oam_cfmCcmInstVid_set
 *      - Outer Pcp             is setting by rtk_oam_cfmCcmInstPcp_set
 *      - Outer Dei             is setting by rtk_oam_cfmCcmInstDei_set
 *      - Outer Tpid            is setting by rtk_oam_cfmCcmInstTpid_set
 *      - Inner Vid             is setting by rtk_oam_cfmCcmInstInnerVid_set
 *      - Inner Pcp             is setting by rtk_oam_cfmCcmInstInnerPcp_set
 *      - Inner Dei             is setting by rtk_oam_cfmCcmInstInnerDei_set
 *      - Inner Tpid            is setting by rtk_oam_cfmCcmInstInnerTpid_set
 * Changes:
 *      None
 */
extern int32
rtk_oam_cfmCcmInstPcp_get(uint32 unit, uint32 instance, uint32 *pPcp);

/* Function Name:
 *      rtk_oam_cfmCcmInstPcp_set
 * Description:
 *      Set outer PCP for instance member to be inserted to generated CCM frame.
 * Input:
 *      unit     - unit id
 *      instance - tx control entry instance
 *      pcp      - pcp
 ...
 */
extern int32
rtk_oam_cfmCcmInstPcp_set(uint32 unit, uint32 instance, uint32 pcp);

/* Function Name:
 *      rtk_oam_cfmCcmInstDei_get
 * Description:
 *      Get outer DEI for instance member to be inserted to generated CCM frame.
 * Input:
 *      unit     - unit id
 *      instance - tx control entry instance
 * Output:
 *      pDei     - pointer buffer of DEI
 * Return:
 *      RT_ERR_OK
 *      RT_ERR_FAILED
 *      RT_ERR_UNIT_ID      - invalid unit id
 ...
 */
extern int32
rtk_oam_cfmCcmInstDei_get(uint32 unit, uint32 instance, uint32 *pDei);

/* Function Name:
 *      rtk_oam_cfmCcmInstDei_set
 * Description:
 *      Set outer DEI for instance member to be inserted to generated CCM frame.
 * Input:
 *      unit     - unit id
 *      instance - tx control entry instance
 *      dei      - dei
 ...
 */
extern int32
rtk_oam_cfmCcmInstDei_set(uint32 unit, uint32 instance, uint32 dei);


/* Function Name:
 *      rtk_oam_cfmCcmInstTpid_get
 * Description:
 *      Get outer TPID for instance member to be inserted to generated CCM frame.
 * Input:
 *      unit     - unit id
 *      instance - tx control entry instance
 * Output:
 *      pTpid     - pointer buffer of DEI
 * Return:
 *      RT_ERR_OK
 *      RT_ERR_FAILED
 *      RT_ERR_UNIT_ID      - invalid unit id
 ...
 */
extern int32
rtk_oam_cfmCcmInstTpid_get(uint32 unit, uint32 instance, uint32 *pTpid);

/* Function Name:
 *      rtk_oam_cfmCcmInstTpid_set
 * Description:
 *      Set outer TPID for instance member to be inserted to generated CCM frame.
 * Input:
 *      unit     - unit id
 *      instance - tx control entry instance
 *      tpid     - tpid
 ...
 */
extern int32
rtk_oam_cfmCcmInstTpid_set(uint32 unit, uint32 instance, uint32 tpid);

/* Function Name:
 *      rtk_oam_cfmCcmInstInnerTagStatus_get
 * Description:
 *      Get Inner VLAN tag status of the generated CCM frame.
 * Input:
 *      unit     - unit id
 *      instance - tx control entry instance
 * Output:
 ...
 *      9330
 * Note:
 *      Indicate whether to insert Inner VLAN tag to the generated CCM frame.
 * Changes:
 *      None
 */
extern int32
rtk_oam_cfmCcmInstInnerTagStatus_get(uint32 unit, uint32 instance, rtk_enable_t *pEnable);

/* Function Name:
 *      rtk_oam_cfmCcmInstInnerTagStatus_set
 * Description:
 *      Set Inner VLAN tag status of the generated CCM frame.
 * Input:
 *      unit     - unit id
 *      instance - tx control entry instance
 *      enable   - tag status
 ...
 */
extern int32
rtk_oam_cfmCcmInstInnerTagStatus_set(uint32 unit, uint32 instance, rtk_enable_t enable);


/* Function Name:
 *      rtk_oam_cfmCcmInstInnerVid_get
 * Description:
 *      Get vlan id for instance member to be inserted to generated CCM frame.
 * Input:
 *      unit     - unit id
 ...
 */
extern int32
rtk_oam_cfmCcmInstInnerVid_get(uint32 unit, uint32 instance, rtk_vlan_t *pVid);

/* Function Name:
 *      rtk_oam_cfmCcmInstInnerVid_set
 * Description:
 *      Set vlan id for instance member to be inserted to generated CCM frame.
 * Input:
 *      unit     - unit id
 ...
 */
extern int32
rtk_oam_cfmCcmInstInnerVid_set(uint32 unit, uint32 instance, rtk_vlan_t vid);

/* Function Name:
 *      rtk_oam_cfmCcmInstInnerPcp_get
 * Description:
 *      Get inner PCP for instance member to be inserted to generated CCM frame.
 * Input:
 *      unit     - unit id
 *      instance - tx control entry instance
 * Output:
 ...
 */
extern int32
rtk_oam_cfmCcmInstInnerPcp_get(uint32 unit, uint32 instance, uint32 *pPcp);

/* Function Name:
 *      rtk_oam_cfmCcmInstInnerPcp_set
 * Description:
 *      Set inner PCP for instance member to be inserted to generated CCM frame.
 * Input:
 *      unit     - unit id
 *      instance - tx control entry instance
 *      pcp      - pcp
 ...
 */
extern int32
rtk_oam_cfmCcmInstInnerPcp_set(uint32 unit, uint32 instance, uint32 pcp);

/* Function Name:
 *      rtk_oam_cfmCcmInstInnerDei_get
 * Description:
 *      Get inner DEI for instance member to be inserted to generated CCM frame.
 * Input:
 *      unit     - unit id
 *      instance - tx control entry instance
 * Output:
 ...
 */
extern int32
rtk_oam_cfmCcmInstInnerDei_get(uint32 unit, uint32 instance, uint32 *pDei);

/* Function Name:
 *      rtk_oam_cfmCcmInstInnerDei_set
 * Description:
 *      Set inner DEI for instance member to be inserted to generated CCM frame.
 * Input:
 *      unit     - unit id
 *      instance - tx control entry instance
 *      dei      - dei
 ...
 */
extern int32
rtk_oam_cfmCcmInstInnerDei_set(uint32 unit, uint32 instance, uint32 dei);


/* Function Name:
 *      rtk_oam_cfmCcmInstInnerTpid_get
 * Description:
 *      Get inner TPID for instance member to be inserted to generated CCM frame.
 * Input:
 *      unit     - unit id
 *      instance - tx control entry instance
 * Output:
 ...
 */
extern int32
rtk_oam_cfmCcmInstInnerTpid_get(uint32 unit, uint32 instance, uint32 *pTpid);

/* Function Name:
 *      rtk_oam_cfmCcmInstInnerTpid_set
 * Description:
 *      Set inner TPID for instance member to be inserted to generated CCM frame.
 * Input:
 *      unit     - unit id
 *      instance - tx control entry instance
 *      tpid     - tpid
 ...
 */
extern int32
rtk_oam_cfmCcmInstInnerTpid_set(uint32 unit, uint32 instance, uint32 tpid);
