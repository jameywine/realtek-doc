...
{
    STORM_GROUP_MULTICAST = 0,
    STORM_GROUP_BROADCAST,
    STORM_GROUP_UNICAST,
    STORM_GROUP_KWN_UNICAST,        /*for 9300 only*/
    STORM_GROUP_KWN_MULTICAST,      /*for 9300 only*/
    STORM_GROUP_END
...
typedef enum rtk_rate_bspUnit_e
{
    RATE_BPS_UNIT_16KBPS = 0,
    RATE_BPS_UNIT_1024KBPS,
    RATE_BPS_UNIT_END,
}rtk_rate_bspUnit_t;
...
/* Function Name:
 *      rtk_rate_portIgrBwCtrlRateUnit_get
 * Description:
 *       Get the ingress bandwidth control rate unit
 * Input:
 *      unit      - unit id
 * Output:
 *      pBps_unit - BPS unit
 ...
 */
extern int32
rtk_rate_portIgrBwCtrlRateUnit_get(uint32 unit, rtk_port_t port,
    rtk_rate_bspUnit_t *pBps_unit);

/* Function Name:
 *      rtk_rate_portIgrBwCtrlRateUnit_set
 * Description:
 *      Set the ingress bandwidth control rate unit
 * Input:
 *      unit      - unit id
 *      bps_unit  - BPS unit
 * Output:
 ...
 */
extern int32
rtk_rate_portIgrBwCtrlRateUnit_set(uint32 unit, rtk_port_t port,
    rtk_rate_bspUnit_t bps_unit);

/* Function Name:
 *      rtk_rate_igrBwCtrlBypassInclude_get
 * Description:
 *      Get the status of include or exclude bypass ingress bandwidth control
 * Input:
 *      unit       - unit id
 * Output:
 *      pEnable    - pointer to enable status of include bypass ingress bandwidth control
 * Return:
 *      RT_ERR_OK
 *      RT_ERR_FAILED
 *      RT_ERR_UNIT_ID      - Invalid unit id
 ...
 */
extern int32
rtk_rate_igrBwCtrlBypassInclude_get(uint32 unit, rtk_enable_t *pEnable);

/* Function Name:
 *      rtk_rate_igrBwCtrlBypassInclude_set
 * Description:
 *      Set the status of include or exclude bypass ingress bandwidth control
 * Input:
 *      unit       - unit id
 *      enable     - status of include bypass ingress bandwidth control
 * Output:
 *      None
 * Return:
 *      RT_ERR_OK
 ...
 */
extern int32
rtk_rate_igrBwCtrlBypassInclude_set(uint32 unit, rtk_enable_t enable);
...
/* Function Name:
 *      rtk_rate_portStormCtrlMeterRate_get
 * Description:
 *      Get the storm control rate.
 * Input:
 *      unit       - unit id
 *      port       - port id
 *      meter_idx  - meter index. 0 is not supported
 * Output:
 *      pRate      - storm control rate
 * Return:
 *      RT_ERR_OK
 ...
 * Note:
 *      (1) The actual rate is "rate * chip granularity".
 *      (2) The unit of granularity is 16Kbps or 1pps depend on mode set by 'rtk_rate_portStormCtrlMeterRateMode_set'.
 * Changes:
 *      [SDK_4.0.0]
 *          New added function.
 */
...
/* Function Name:
 *      rtk_rate_portStormCtrlMeterRate_set
 * Description:
 *      Set the storm control rate.
 * Input:
 *      unit       - unit id
...
/* Function Name:
 *      rtk_rate_portStormCtrlMeterBurstSize_get
 * Description:
 *      Get burst size of storm control on specified port.
 * Input:
 *      unit        - unit id
 ...
 *      9330
 * Note:
 *      (1) The unit of burst size is 1 byte or 1 packet depend on mode.
 * Changes:
 *      [SDK_4.0.0]
 *          New added function.
 */
...
/* Function Name:
 *      rtk_rate_portStormCtrlMeterBurstSize_set
 * Description:
 *      Set burst size of storm control on specified port.
 * Input:
 *      unit       - unit id
...
/* Function Name:
 *      rtk_rate_portStormCtrlMeterExceed_get
 * Description:
 *      Get exceed status of storm control on specified port.
 * Input:
 *      unit       - unit id
...
/* Function Name:
 *      rtk_rate_portStormCtrlMeterExceed_reset
 * Description:
 *      Reset exceed status of storm control on specified port.
 * Input:
 *      unit       - unit id
...
/* Function Name:
 *      rtk_rate_portStormCtrlMeterIdx_get
 * Description:
 *      Get meter index of storm control on specified port of specify storm type.
 * Input:
 *      unit       - unit id
 *      port       - port id
 * Output:
 *      pMeter_idx  - returns meter index. 0 indicates disable storm control.
 * Return:
 *      RT_ERR_OK
 *      RT_ERR_FAILED
 *      RT_ERR_UNIT_ID  - invalid unit id
...
/* Function Name:
 *      rtk_rate_portStormCtrlMeterIdx_set
 * Description:
 *      Get meter index of storm control on specified port of specify storm type.
 * Input:
 *      unit       - unit id
 *      port       - port id
 *      meter_idx  - meter index. 0 indicates disable storm control.
 * Output:
 *      None
 * Return:
 *      RT_ERR_OK
...
/* Function Name:
 *      rtk_rate_portStormCtrlBpsUnit_get
 * Description:
 *      Get storm control counting unit when counting mode is in BASED_ON_BYTE mode
 * Input:
 *      unit      - unit id
 * Output:
 *      pBps_unit - BPS unit
 ...
 */
extern int32
rtk_rate_portStormCtrlBpsUnit_get(uint32 unit, rtk_port_t port, rtk_rate_bspUnit_t *pBps_unit);

/* Function Name:
 *      rtk_rate_portStormCtrlBpsUnit_set
 * Description:
 *      Set storm control counting unit when counting mode is in BASED_ON_BYTE mode
 * Input:
 *      unit      - unit id
 *      bps_unit  - BPS unit
 * Output:
 ...
 */
extern int32
rtk_rate_portStormCtrlBpsUnit_set(uint32 unit, rtk_port_t port, rtk_rate_bspUnit_t bps_unit);
