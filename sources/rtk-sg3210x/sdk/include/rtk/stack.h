...
typedef enum rtk_stack_cascadeHashMode_e
{
    RTK_STACK_CASCADE_HSAH_DYNAMIC =             0,        /* normal trunk hash algorithm */
    RTK_STACK_CASCADE_HSAH_PERPORT,                       /* per-port select cascade port */
} rtk_stack_cascadeHashMode_t;
...
/* Function Name:
 *      rtk_stack_cascadeHashMode_get
 * Description:
 *      Get cascade port hash mode
 * Input:
 *      unit          - unit id
 * Output:
 *      pMode         - hash mode
 ...
 */
extern int32
rtk_stack_cascadeHashMode_get(uint32 unit, rtk_stack_cascadeHashMode_t *pMode);

/* Function Name:
 *      rtk_stack_cascadeHashMode_set
 * Description:
 *      Set cascade port hash mode
 * Input:
 *      unit        - unit id
 *      mode        - hash mode
 * Output:
 ...
 */
extern int32
rtk_stack_cascadeHashMode_set(uint32 unit, rtk_stack_cascadeHashMode_t mode);
