...
/* learning options */
typedef enum rtk_stp_learnOption_e
{
    STP_LEARN_OPT_IVP_OR_PORT = 0,   /* learning base on IVP, or if no IVP, base on Physical-Port */
    STP_LEARN_OPT_IVP_AND_PORT,      /* learning base on both IVP and Physical-Port */
    STP_LEARN_OPT_END
}rtk_stp_learnOption_t;
