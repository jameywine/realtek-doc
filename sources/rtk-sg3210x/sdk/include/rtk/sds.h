...
typedef struct rtk_sds_info_s
{
    ...
    int32   vth;
#if defined(CONFIG_SDK_RTL9311B)
    int32   offset_fore_out;
    int32   offset_fore_range;
    int32   offset_sa_out_edge;
    int32   offset_sa_out_data;
    int32   offset_sa_out_dh;
    int32   offset_sa_out_dl;
    int32   tap1;
    int32   tap2;
    int32   tap3;
    int32   tap4;
 ...
 *      rtk_sds_ePhyReg_set
 * Description:
 *      set pcie ePhy register
 * Input:
 *      unit   - unit id
 *      addr   - ePhy register address
 *      val    - ePhy register value
 * Output:
 *      None
 * Return:
 *      RT_ERR_OK
 ...
 */
extern int32
rtk_sds_ePhyReg_set(uint32 unit, uint32 addr, uint32 val);

/* Function Name:
 *      rtk_sds_ePhyReg_get
 * Description:
 *      get pcie ePhy register
 * Input:
 *      unit   - unit id
 *      addr   - ePhy register address
 * Output:
 *      pVal   - ePhy register value
 * Return:
 *      RT_ERR_OK
 *      RT_ERR_FAILED
 *      RT_ERR_UNIT_ID              - invalid unit id
 ...
 */
extern int32
rtk_sds_ePhyReg_get(uint32 unit, uint32 addr, uint32 *pVal);
