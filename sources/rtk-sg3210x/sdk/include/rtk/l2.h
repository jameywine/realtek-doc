...
#define RTK_L2_HASH_BLOCK_NUM               0x00000006
#else
...
typedef enum rtk_l2_flushAct_e
{
    ...
    FLUSH_ACT_FLUSH_ALL_UC,         /* Applicable to 9300, 9310, 9311b */
    FLUSH_ACT_REPLACE_ALL_UC,       /* Applicable to 9300, 9310, 9311b */
    FLUSH_ACT_FLUSH_DYNM_ONLY,      /* Applicable to 9300, 9310, 9311b */
    FLUSH_ACT_REPLACE_DYNM_ONLY,    /* Applicable to 9300, 9310, 9311b */
    FLUSH_ACT_CLEAR_NEXTHOP,        /* Applicable to 9300, 9310 */
    FLUSH_ACT_CLEAR_AGG_VID,        /* Applicable to 9300, 9310, 9311b */
    FLUSH_ACT_END
} rtk_l2_flushAct_t;
...
{
    SA_IS_ZERO,                     /* Applicable to 8380, 8390, 9300, 9310, 9311b*/
    SA_IS_BCAST_OR_MCAST,           /* Applicable to 8380, 8390, 9300, 9310, 9311b*/
...
typedef enum rtk_l2_lookupMissType_e
{
    ...
    DLF_TYPE_UCAST,         /* Applicable to 8380, 8390, 9300, 9310, 9311b */
...
{
    MAC_FILTER_MODE_SA = 0,                /* Applicable to 8390, 9300, 9310, 9311b */
    MAC_FILTER_MODE_DA,                    /* Applicable to 8390, 9300, 9310, 9311b */
    MAC_FILTER_MODE_END
...
rtk_l2_ucastAddr_s
{
    ...
    uint8           l2_kt;
    uint8           pri;
    rtk_enable_t    is_specified_l2_if;
    uint32          specified_l2_if;
#endif
...
typedef enum rtk_l2_nextValidType_e
{
    ...
    L2_NEXT_VALID_TYPE_UC,                  /* Applicable to 9300, 9310, 9311b */
    L2_NEXT_VALID_TYPE_AUTO_UC,             /* Applicable to 9300, 9310, 9311b */
    L2_NEXT_VALID_TYPE_SOFTWARE_UC,         /* Applicable to 9300, 9310, 9311b */
    L2_NEXT_VALID_TYPE_UC_NH,               /* Applicable to 9300, 9310 */
    L2_NEXT_VALID_TYPE_MC,                  /* Applicable to 9300, 9310, 9311b */
...
typedef struct rtk_l2_learn_level_pf_s {
    rtk_enable_t tie_learn;
    uint16       learn_level;
} rtk_l2_learn_level_pf_t;
 ...
 *      8380, 8390, 9300, 9310, 9311B, 9330
 * Note:
 *      For 8380/8390/9300/9310, this API will not use
 *      Parameter:
 *                pAction.sttAct.port.
 *
 * Changes:
...
/* Function Name:
 *      rtk_l2_lookupMissFloodPortMaskByVlan_get
 * Description:
 *      Get flooding port mask which limits the lookup missed flooding domain.
 * Input:
 *      unit            - unit id
 ...
 */
extern int32
rtk_l2_lookupMissFloodPortMaskByVlan_get(uint32 unit, rtk_vlan_t vid, rtk_l2_lookupMissType_t type, rtk_portmask_t *pFlood_portmask);

/* Function Name:
 *      rtk_l2_lookupMissFloodPortMaskByVlan_set
 * Description:
 *      Set flooding port mask when unicast or multicast address lookup missed in L2 table.
 * Input:
 *      unit            - unit id
 ...
 */
extern int32
rtk_l2_lookupMissFloodPortMaskByVlan_set(uint32 unit, rtk_vlan_t vid, rtk_l2_lookupMissType_t type, rtk_portmask_t *pFlood_portmask);

/* Function Name:
 *      rtk_l2_lookupMissFloodPortMaskByVlan_add
 * Description:
 *      Add one port member to the lookup missed flooding port mask.
 * Input:
 *      unit       - unit id
 ...
 */
extern int32
rtk_l2_lookupMissFloodPortMaskByVlan_add(uint32 unit, rtk_vlan_t vid, rtk_l2_lookupMissType_t type, rtk_port_t flood_port);
 ...
 */
extern int32
rtk_l2_lookupMissFloodPortMaskByVlan_del(uint32 unit, rtk_vlan_t vid, rtk_l2_lookupMissType_t type, rtk_port_t flood_port);
...
/* Function Name:
 *      rtk_l2_portLearnLevelProfileIndex_get
 * Description:
 *      Get the learn level profile index of the specified module port.
 * Input:
 *      unit      - unit id
 *      module_id - module id
 *      port      - port id
 * Output:
 *      pProfileIndex - pointer to the learn level profile index
 * Return:
 *      RT_ERR_OK
 *      RT_ERR_FAILED
 *      RT_ERR_UNIT_ID      - invalid unit id
...
rtk_l2_portLearnLevelProfileIndex_get(
    ...
    uint32 module_id,
    rtk_port_t port,
    uint32* pProfileIndex);

/* Function Name:
 *      rtk_l2_portLearnLevelProfileIndex_set
 * Description:
 *      Set the learn level profile index of the specified module port.
 * Input:
 *      unit      - unit id
 *      module id - module id
 *      port      - port id
 *      profileIndex  - learn level profile index
 * Output:
 *      None
 * Return:
 *      RT_ERR_OK
...
/* Function Name:
 *      rtk_l2_trkLearnLevelProfileIndex_get
 * Description:
 *      Get the learn level profile index of the specified trunk.
 * Input:
 *      unit    - unit id
 *      tid     - trunk id
 * Output:
...
/* Function Name:
 *      rtk_l2_trkLearnLevelProfileIndex_set
 * Description:
 *      Get the learn level profile index of the specified trunk.
 * Input:
 *      unit    - unit id
...
/* Function Name:
 *      rtk_l2_learnLevelProfile_get
 * Description:
 *      Get the specified learn level profile.
 * Input:
 *      unit    - unit id
 *      uint32  - profile index
 * Output:
 *      pProfile - pointer to the learn level profile
 * Return:
 *      RT_ERR_OK
 *      RT_ERR_FAILED
 *      RT_ERR_UNIT_ID      - invalid unit id
...
rtk_l2_learnLevelProfile_get(
    uint32 unit,
    uint32 profileIndex,
    rtk_l2_learn_level_pf_t* pProfile);
...
/* Function Name:
 *      rtk_l2_learnLevelProfile_set
 * Description:
 *      Set the specified learn level profile.
 * Input:
 *      unit          - unit id
...
/* Function Name:
 *      rtk_l2_portFREREnable_get
 * Description:
 *      Get the FRER state configuration of the specified port.
 * Input:
 *      unit    - unit id
 *      port    - port id
 * Output:
 *      pEnable - enable status of FRER
 * Return:
 *      RT_ERR_OK
 *      RT_ERR_FAILED
 *      RT_ERR_UNIT_ID      - invalid unit id
 ...
 */
int32
rtk_l2_portFREREnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable);

/* Function Name:
 *      rtk_l2_portFREREnable_set
 * Description:
 *      Set the FRER state configuration of the specified port.
 * Input:
 *      unit   - unit id
 *      port   - port id
 *      enable - enable status of FRER
 * Output:
 *      None
 * Return:
 *      RT_ERR_OK
 ...
 */
int32
rtk_l2_portFREREnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable);
