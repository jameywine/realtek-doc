...
{
    TRAP_Q_ARP_REQ_REP_GRTS,     /* Applicable to 9300, 9310 9311b */
    TRAP_Q_DHCP_DHCP6,           /* Applicable to 9300, 9310 9311b */
    TRAP_Q_IGMP_MLD ,            /* Applicable to 9300, 9310 9311b */
    TRAP_Q_BPDU,                 /* Applicable to 9300, 9310 9311b */
    TRAP_Q_PTP,                  /* Applicable to 9300, 9310 9311b */
    TRAP_Q_LLDP,                 /* Applicable to 9300, 9310 9311b */
    TRAP_Q_EAPOL,                /* Applicable to 9300, 9310 9311b */
    TRAP_Q_OAM,                  /* Applicable to 9300, 9310 9311b */
    TRAP_Q_LACP,                 /* Applicable to 9300, 9310 9311b */
    TRAP_Q_RLDP_RLPP,            /* Applicable to 9300*/
    TRAP_Q_CFM,                  /* Applicable to 9310 9311b */
    TRAP_Q_CFM_ETHDM,            /* Applicable to 9310 9311b */
    TRAP_Q_RMA_USR_DEF,          /* Applicable to 9300, 9310 9311b */
    TRAP_Q_RMA,                  /* Applicable to 9300, 9310 9311b */
    TRAP_Q_IPV6ND,               /* Applicable to 9300, 9310 9311b */
    TRAP_Q_IP4_IP6_HDR_ERR,      /* Applicable to 9300, 9310 9311b */
    TRAP_Q_L2_CRC_ERR,           /* Applicable to 9300, 9310 9311b */
    TRAP_Q_IP4_CHKSUM_ERR,       /* Applicable to 9300, 9310 9311b */
    TRAP_Q_IP4_IP6_RSVD_ADDR,    /* Applicable to 9300, 9310 9311b */
    TRAP_Q_IGR_VLAN_FLTR,        /* Applicable to 9300, 9310 9311b */
    TRAP_Q_CFI,                  /* Applicable to 9300, 9310 9311b */
    TRAP_Q_IVC,                  /* Applicable to 9300, 9310 9311b */ // naing for ip/mac vlan ??
    TRAP_Q_INVALID_SA,           /* Applicable to 9300, 9310 9311b */
    TRAP_Q_MAC_CST,              /* Applicable to 9300, 9310 9311b */
    TRAP_Q_NEW_SA,               /* Applicable to 9300, 9310 9311b */
    TRAP_Q_PMV_FORBID,           /* Applicable to 9300, 9310 9311b */
    TRAP_Q_L2_STTC_PMV,          /* Applicable to 9300, 9310 9311b */
    TRAP_Q_L2_DYN_PMV,           /* Applicable to 9300, 9310 9311b */
    TRAP_Q_HASH_FULL,            /* Applicable to 9300, 9310 9311b */
    TRAP_Q_ATK,                  /* Applicable to 9300, 9310 9311b */
    TRAP_Q_ACL_HIT,              /* Applicable to 9300, 9310 9311b */
    TRAP_Q_MIR_HIT,              /* Applicable to 9300, 9310 9311b */
    TRAP_Q_CAPWAP,               /* Applicable to 9300, 9310 */
    TRAP_Q_MPLS_EXCPT,           /* Applicable to 9310 */
    TRAP_Q_OF_HIT,               /* Applicable to 9310 9311b */
    TRAP_Q_OF_TBL_LUMIS,         /* Applicable to 9310 */
    TRAP_Q_TT_HIT,               /* Applicable to 9310, 9311b */
    TRAP_Q_SFLOW,                /* Applicable to 9310, 9311b */
    TRAP_Q_PASR_EXCPT,           /* Applicable to 9310, 9311b */
    TRAP_Q_MALFORM_PKT,          /* Applicable to 9310, 9311b */
    TRAP_Q_CPU2CPU_TALK,         /* Applicable to 9300, 9310, 9311b */

    TRAP_Q_L3_IPUC_RPF,                   /* Applicable to 9300, 9310, 9311b */
    TRAP_Q_L3_IPMC_RPF,                   /* Applicable to 9300, 9310 ,9311b */ /*(ASSERT) */
    TRAP_Q_L2_UC_MC_BDG_LUMIS,            /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_IP4_IP6_BDG_LUMIS,             /* Applicable to 9300, 9310 ,9311b */ //only ip6 ??
    TRAP_Q_ROUTER_MAC_IF,                 /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_L3_IPUC_NON_IP_PKT,            /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_ROUTE_IP_CHK,                  /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_L3_ROUTE_DIP_DMAC_MISMATCH,    /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_IP6_UC_MC_HOP_BY_HOP,          /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_IP6_UC_MC_ROUTE_HDR,           /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_IP4_IP_OPT,                    /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_IP4_IP6_MC_ROUTE_LUMIS,        /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_L3_IPUC_NULL_ROUTE,            /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_L3_IPUC_PBR_NULL_ROUTE,        /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_L3_UC_HOST_ROUTE,              /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_L3_UC_NET_ROUTE,               /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_L3_MC_BDG_ENTRY,               /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_L3_MC_ROUTE_ENTRY,             /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_TTL_EXCPT,                     /* Applicable to 9310 */
    TRAP_Q_ROUTE_EXCPT_NH_AGE_OUT_ACT,    /* Applicable to 9300, 9310*/
    TRAP_Q_IP4_IP6_ICMP_REDRT,            /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_IPUC_MTU,                      /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_IPMC_MTU,                      /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_IPUC_TTL,                      /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_IPMC_TTL,                      /* Applicable to 9300, 9310 ,9311b */
    TRAP_Q_IP_MAC_BINDING,                /* Applicable to 9310, 9311b */
    TRAP_Q_TUNL_MAC_IF,                   /* Applicable to 9310, 9311b */
    TRAP_Q_TUNL_IP_CHK,                   /* Applicable to 9310, 9311b */
    TRAP_Q_ROUTE_EXCPT_NH_ERR_ACT,        /* Applicable to 9310 */
    TRAP_Q_ROUTE_EXCPT_ROUTE_TO_TUNL_ACT, /* Applicable to 9310, 9311b */
    TRAP_Q_NOTIFICATION,                  /* Applicable to 9300, 9310, 9311b*/
    TRAP_Q_EST_TX_LEN_EXCEED,                  /* Applicable to 9311b */
    TRAP_Q_EST_MISMATCH,                  /* Applicable to 9311b */
    TRAP_Q_ECID_EQ_PCID,                  /* Applicable to 9311b */
    TRAP_Q_INVLD_VXLAN_HDR,                  /* Applicable to 9311b */
    TRAP_Q_VXLAN_CTRL_PKT,                  /* Applicable to 9311b */
    TRAP_Q_VXLAN_TT_EXCPT,                  /* Applicable to 9311b */
...
typedef enum rtk_trap_module_e
{
    TRAP_MODULE_NIC = 0,
    TRAP_MODULE_RMA,
    TRAP_MODULE_L2,
    ...
    TRAP_MODULE_DM,
    TRAP_MODULE_ATTACK,
    TRAP_MODULE_IP_MAC_BIND,
    TRAP_MODULE_BFD,
    TRAP_MODULE_END
} rtk_trap_module_t;

typedef enum rtk_trap_targetSel_e
{
    TRAP_TARGETSEL_LOCALCPU = 0,
    TRAP_TARGETSEL_MASTERCPU,
    TRAP_TARGETSEL_END
} rtk_trap_targetSel_t;

typedef struct rtk_trap_moduleMask_s
{
    rtk_bitmap_t  bits[RTK_TOTAL_NUM_OF_WORD_FOR_1BIT_TRAP_LIST];
} rtk_trap_moduleMask_t;

typedef struct rtk_trap_moduleStatus_s
{
    rtk_bitmap_t  bits[RTK_TOTAL_NUM_OF_WORD_FOR_1BIT_TRAP_LIST];
} rtk_trap_moduleStatus_t;
...
/* Function Name:
 *      rtk_trap_targetSel_get
 * Description:
 *      Get module trap target state
 * Input:
 *      unit                        - unit id
 *      pModuleMask                 - module mask indicate which module should be set
 * Output:
 *      pModuleStatus               - indicate the respective module's trap state is Local or Master CPU
 * Return:
 *      RT_ERR_OK
 *      RT_ERR_FAILED
 *      RT_ERR_NOT_INIT             - The module is not initial
 *      RT_ERR_NULL_POINTER         - invalid type of management frame
 *      RT_ERR_INPUT                - invalid input parameter
 *      RT_ERR_CHIP_NOT_SUPPORTED   - chip not support the function
 * Applicable:
 *      9330
 * Note:
 *      rtk_trap_module_t is used to indicate module offset in mask.
 * Changes:
 *      SDK_4.0.0
 */
extern int32
rtk_trap_targetSel_get(uint32 unit, rtk_trap_moduleMask_t *pModuleMask, rtk_trap_moduleStatus_t *pModuleStatus);


/* Function Name:
 *      rtk_trap_targetSel_set
 * Description:
 *      Set module trap target is Local or Master CPU.
 * Input:
 *      unit                        - unit id
 *      pModuleMask                 - module mask indicate which module should be set
 *      trap_targetSel              - Local or Master CPU
 * Output:
 *      None
 * Return:
 *      RT_ERR_OK
 ...
 */
extern int32
rtk_trap_targetSel_set(uint32 unit, rtk_trap_moduleMask_t *pModuleMask, rtk_trap_targetSel_t trap_targetSel);
