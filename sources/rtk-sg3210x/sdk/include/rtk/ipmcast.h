...
typedef enum rtk_ipmc_flag_e
{
    ...
    RTK_IPMC_FLAG_L2_HIT                = 0x00000800,   /* l2 hit-specific (hit bit is set), for 9311B */
    RTK_IPMC_FLAG_L2_HIT_CLEAR          = 0x00001000,   /* action - clear the l2 hit bit if it's set, for 9311B */
} rtk_ipmc_flag_t;
...
#endif
    RTK_IPMC_GCT_IPMC_DMAC_MISMATCH_BYPASS,             /* rtk_enable_t */
    RTK_IPMC_GCT_IP6MC_DMAC_MISMATCH_BYPASS,            /* rtk_enable_t */
