...
#if defined(CONFIG_SDK_RTL8390) || defined(CONFIG_SDK_RTL9310) || defined(CONFIG_SDK_RTL9311B) || defined(CONFIG_SDK_RTL9300)
    rtk_vlan_t vid_high;
#endif
    rtk_portmask_t portmask;
} rtk_port_vlanIsolationEntry_t;

typedef enum rtk_port_serdesMedia_e
{
    PORT_SERDES_MEDIA_NONE,
    PORT_SERDES_MEDIA_FIBER_20G,
    PORT_SERDES_MEDIA_FIBER_10G,
    PORT_SERDES_MEDIA_FIBER_1G,
    PORT_SERDES_MEDIA_FIBER_2_5G,
    PORT_SERDES_MEDIA_FIBER_100M,
    PORT_SERDES_MEDIA_DAC_10G50CM,
    PORT_SERDES_MEDIA_DAC_10G100CM,
    PORT_SERDES_MEDIA_DAC_10G300CM,
    PORT_SERDES_MEDIA_DAC_10G500CM,
    PORT_SERDES_MEDIA_DAC_10GEND,
    PORT_SERDES_MEDIA_END
} rtk_port_serdesMedia_t;
...
#define RTK_PHY_CTRL_LED_MODE_10M              (1 << 9)      /* LED light when link up at specific speed */
#define RTK_PHY_CTRL_LED_MODE_10G_FLASH        (1 << 10)     /* LED flash when link up at specific speed */
#define RTK_PHY_CTRL_LED_MODE_10G_LITE_FLASH   (1 << 11)     /* LED flash when link up at specific speed at two-pair mode */
#define RTK_PHY_CTRL_LED_MODE_5G_FLASH         (1 << 12)     /* LED flash when link up at specific speed */
#define RTK_PHY_CTRL_LED_MODE_5G_LITE_FLASH    (1 << 13)     /* LED flash when link up at specific speed at two-pair mode */
#define RTK_PHY_CTRL_LED_MODE_2P5G_FLASH       (1 << 14)     /* LED flash when link up at specific speed */
#define RTK_PHY_CTRL_LED_MODE_2P5G_LITE_FLASH  (1 << 15)     /* LED flash when link up at specific speed at two-pair mode */
#define RTK_PHY_CTRL_LED_MODE_1G_FLASH         (1 << 16)     /* LED flash when link up at specific speed */
#define RTK_PHY_CTRL_LED_MODE_500M_FLASH       (1 << 17)     /* LED flash when link up at specific speed at two-pair mode */
#define RTK_PHY_CTRL_LED_MODE_100M_FLASH       (1 << 18)     /* LED flash when link up at specific speed */
#define RTK_PHY_CTRL_LED_MODE_RX_ACT           (1 << 19)     /* LED blink when packet receiving */
#define RTK_PHY_CTRL_LED_MODE_TX_ACT           (1 << 20)     /* LED blink when packet transmitting */
#define RTK_PHY_CTRL_LED_MODE_LITE_FLASH       (1 << 21)     /* LED flash when link at two-pair mode */
#define RTK_PHY_CTRL_LED_MODE_LITE             (1 << 22)     /* LED light when link at two-pair mode */
#define RTK_PHY_CTRL_LED_MODE_DUPLEX           (1 << 23)     /* LED light when link at full duplex */
#define RTK_PHY_CTRL_LED_MODE_MASTER           (1 << 24)     /* LED light when link at master mode*/
#define RTK_PHY_CTRL_LED_MODE_TRAINING         (1 << 25)     /* LED blink when PHY at training state*/
#define RTK_PHY_CTRL_LED_MODE_LINK_EN          (1 << 26)     /* LED light when link up, unset this bit for power-saving */
#define RTK_PHY_CTRL_LED_MODE_LINK_FLASH       (1 << 27)     /* LED flash when link up*/
...
/* Function Name:
 *      rtk_port_phyAutoNegoAbilityLinkPartner_get
 * Description:
 *      Get abilities advertised by link partner
 * Input:
 *      unit - unit id
 *      port - port id
 *
 ...
 * Applicable:
 *      8261, 8264, 8251, 8254, 8224, 8218D
 * Note:
 *      None
 * Changes:
 *      [SDK_4.0.0]
 ...
 */
extern int32
rtk_port_phyAutoNegoAbilityLinkPartner_get(uint32 unit, rtk_port_t port, rtk_port_phy_ability_t *pAbility);
 ...
 *      [SDK_4.0.2]
 *      New added function.
 *      This function replaced rtk_port_10gMedia_set(),
 *      Strucure rtk_port_serdesMedia_t replaced rtk_port_10gMedia_t
 *      Enum PORT_SERDES_MEDIA_NONE replaced PORT_10GMEDIA_NONE
 *      Enum PORT_SERDES_MEDIA_FIBER_10G replaced PORT_10GMEDIA_FIBER_10G
 *      Enum PORT_SERDES_MEDIA_FIBER_1G replaced PORT_10GMEDIA_FIBER_1G
 *      Enum PORT_SERDES_MEDIA_FIBER_2_5G replaced PORT_10GMEDIA_FIBER_2_5G
 *      Enum PORT_SERDES_MEDIA_FIBER_100M replaced PORT_10GMEDIA_FIBER_100M
 *      Enum PORT_SERDES_MEDIA_DAC_10G50CM replaced PORT_10GMEDIA_DAC_50CM
 *      Enum PORT_SERDES_MEDIA_DAC_10G100CM replaced PORT_10GMEDIA_DAC_100CM
 *      Enum PORT_SERDES_MEDIA_DAC_10G300CM replaced PORT_10GMEDIA_DAC_300CM
 *      Enum PORT_SERDES_MEDIA_DAC_10G500CM replaced PORT_10GMEDIA_DAC_500CM
 */
int32
rtk_port_serdesMedia_set(uint32 unit, rtk_port_t port, rtk_port_serdesMedia_t media);

/* Function Name:
 *      rtk_port_serdesMedia_get
 * Description:
 ...
 *      [SDK_4.0.2]
 *      New added function.
 *      This function replaced rtk_port_10gMedia_get(),
 *      Strucure rtk_port_serdesMedia_t replaced rtk_port_10gMedia_t
 *      Enum PORT_SERDES_MEDIA_NONE replaced PORT_10GMEDIA_NONE
 *      Enum PORT_SERDES_MEDIA_FIBER_10G replaced PORT_10GMEDIA_FIBER_10G
 *      Enum PORT_SERDES_MEDIA_FIBER_1G replaced PORT_10GMEDIA_FIBER_1G
 ...
 */
int32
rtk_port_serdesMedia_get(uint32 unit, rtk_port_t port, rtk_port_serdesMedia_t *media);
