...
int32 r9310_cpuTxTagFromRaw_cnvt(uint32 unit, uint8 *txTag, drv_nic_pkt_t *pPacket)
{
    RT_PARAM_CHK(NULL == pPacket, RT_ERR_NULL_POINTER);
...
int32 r9310_cpuTagLen_get(uint32 unit, uint32* rxTag_len, uint32* txTag_len)
{
    *rxTag_len = NIC_9310_RX_TAG_SIZE;
    *txTag_len = NIC_9310_TX_TAG_SIZE;
    return RT_ERR_OK;
}
