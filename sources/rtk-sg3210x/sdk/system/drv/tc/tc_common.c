...
tc_reg_definition_t tc_reg[DRV_REG_END] =
{
    ...
    [DRV_REG_9311B] =
    {
        .tmr_cntr_data_addr =
        {
            {.reg_addr = RTL9311B_TC0DATA_ADDR},
            {.reg_addr = RTL9311B_TC1DATA_ADDR},
            {.reg_addr = RTL9311B_TC2DATA_ADDR},
            {.reg_addr = RTL9311B_TC3DATA_ADDR},
            {.reg_addr = RTL9311B_TC4DATA_ADDR},
            {.reg_addr = RTL9311B_TC5DATA_ADDR},
            {.reg_addr = RTL9311B_TC6DATA_ADDR},
        },
        .tmr_cntr_cntr_addr =
        {
            {.reg_addr = RTL9311B_TC0CNT_ADDR},
            {.reg_addr = RTL9311B_TC1CNTR_ADDR},
            {.reg_addr = RTL9311B_TC2CNTR_ADDR},
            {.reg_addr = RTL9311B_TC3CNTR_ADDR},
            {.reg_addr = RTL9311B_TC4CNTR_ADDR},
            {.reg_addr = RTL9311B_TC5CNTR_ADDR},
            {.reg_addr = RTL9311B_TC6CNTR_ADDR},
        },
        .tmr_cntr_ctrl_addr =
        {
            {.reg_addr = RTL9311B_TC0CTRL_ADDR},
            {.reg_addr = RTL9311B_TC1CTRL_ADDR},
            {.reg_addr = RTL9311B_TC2CTRL_ADDR},
            {.reg_addr = RTL9311B_TC3CTRL_ADDR},
            {.reg_addr = RTL9311B_TC4CTRL_ADDR},
            {.reg_addr = RTL9311B_TC5CTRL_ADDR},
            {.reg_addr = RTL9311B_TC6CTRL_ADDR},
        },
        .tmr_cntr_intr_addr =
        {
            {.reg_addr = RTL9311B_TC0INTR_ADDR},
            {.reg_addr = RTL9311B_TC1INTR_ADDR},
            {.reg_addr = RTL9311B_TC2INTR_ADDR},
            {.reg_addr = RTL9311B_TC3INTR_ADDR},
            {.reg_addr = RTL9311B_TC4INTR_ADDR},
            {.reg_addr = RTL9311B_TC5INTR_ADDR},
            {.reg_addr = RTL9311B_TC6INTR_ADDR},
        },
    },
#endif
};
