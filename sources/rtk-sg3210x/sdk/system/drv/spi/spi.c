...
drv_spi_init(uint32 unit)
{
    ...
    RT_INIT_MSG("(type5)\n");
    ret = spi_dev5_init(unit);
#elif defined(CONFIG_SDK_SPI_DEV_6)
    RT_INIT_MSG("(type6)\n");
    ret = spi_dev6_init(unit);
#elif defined(CONFIG_SDK_SPI_DEV_7)
    RT_INIT_MSG("(type7)\n");
    ret = spi_dev7_init(unit);
...
#elif defined(CONFIG_SDK_SPI_DEV_5)
    ret = spi_dev5Reg_write(unit, mAddrs, pBuff);
#elif defined(CONFIG_SDK_SPI_DEV_6)
    ret = spi_dev6Reg_write(unit, mAddrs, pBuff);
#elif defined(CONFIG_SDK_SPI_DEV_7)
    ret = spi_dev7Reg_write(unit, mAddrs, pBuff);
#elif defined(CONFIG_SDK_SPI_DEV_NONE)
...
#elif defined(CONFIG_SDK_SPI_DEV_5)
    ret = spi_dev5Reg_read(unit, mAddrs, pBuff);
#elif defined(CONFIG_SDK_SPI_DEV_6)
    ret = spi_dev6Reg_read(unit, mAddrs, pBuff);
#elif defined(CONFIG_SDK_SPI_DEV_7)
    ret = spi_dev7Reg_read(unit, mAddrs, pBuff);
#elif defined(CONFIG_SDK_SPI_DEV_NONE)
