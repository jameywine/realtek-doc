...
#if (defined(CONFIG_SDK_DRIVER_L2NTFY_R9311B) || defined(CONFIG_SDK_DRIVER_L2NTFY_R9311B_MODULE))
...
#endif
#if defined(CONFIG_SDK_DRIVER_L2NTFY_R9311B)
    {RTL9311B_FAMILY_ID, L2NTFY_R9311B},
#endif
};
...
#endif
#if defined(CONFIG_SDK_DRIVER_L2NTFY_R9311B) && !defined(__MODEL_USER__)
    {   /* NOTIF_R9311B */
        .l2ntfy_init = r9311b_l2ntfy_init,
        .l2ntfy_enable_get = r9311b_l2ntfy_enable_get,
        .l2ntfy_enable_set = r9311b_l2ntfy_enable_set,
        .l2ntfy_notificationEventEnable_get = r9311b_l2ntfy_notificationEventEnable_get,
        .l2ntfy_notificationEventEnable_set = r9311b_l2ntfy_notificationEventEnable_set,
        .l2ntfy_fifoEmptyStatus_get = r9311b_l2ntfy_fifoEmptyStatus_get,

        .l2ntfy_dst_get  = r9311b_l2ntfy_dst_get,
        .l2ntfy_dst_set  = r9311b_l2ntfy_dst_set,
        .l2ntfy_reset  = r9311b_l2ntfy_reset,
        .l2ntfy_iTag_get  = r9311b_l2ntfy_iTag_get,
        .l2ntfy_iTag_set  = r9311b_l2ntfy_iTag_set,
        .l2ntfy_magicNum_get  = r9311b_l2ntfy_magicNum_get,
        .l2ntfy_magicNum_set  = r9311b_l2ntfy_magicNum_set,
        .l2ntfy_macAddr_get  = r9311b_l2ntfy_macAddr_get,
        .l2ntfy_macAddr_set  = r9311b_l2ntfy_macAddr_set,
        .l2ntfy_maxEvent_get  = r9311b_l2ntfy_maxEvent_get,
        .l2ntfy_maxEvent_set  = r9311b_l2ntfy_maxEvent_set,
        .l2ntfy_timeout_get  = r9311b_l2ntfy_timeout_get,
        .l2ntfy_timeout_set  = r9311b_l2ntfy_timeout_set,
        .l2ntfy_rawToEvent_cnvt = r9311b_l2ntfy_rawToEvent_cnvt,
        .l2ntfy_sizeInfo_get = r9311b_l2ntfy_sizeInfo_get,
        .l2ntfy_entryLen_get = r9311b_l2ntfy_entryLen_get,
        .l2ntfy_pktCpuQue_set = r9311b_l2ntfy_pktCpuQue_set,
        .l2ntfy_pktCpuQueBwCtrlEnable_set = r9311b_l2ntfy_pktCpuQueBwCtrlEnable_set,
        .l2ntfy_pktCpuQueRate_set = r9311b_l2ntfy_pktCpuQueRate_set,
        .l2ntfy_l2LearningAge_disable = r9311b_l2ntfy_l2LearningAge_disable,
        .l2ntfy_l2LearningAge_restore = r9311b_l2ntfy_l2LearningAge_restore,

        .l2ntfy_ageThresh_get = r9311b_l2ntfy_ageThresh_get,
        .l2ntfy_ageThresh_set = r9311b_l2ntfy_ageThresh_set,
        .l2ntfy_learnThresh_get = r9311b_l2ntfy_learnThresh_get,
        .l2ntfy_learnThresh_set = r9311b_l2ntfy_learnThresh_set,
        .l2ntfy_cngstDrop_get = r9311b_l2ntfy_cngstDrop_get,
        .l2ntfy_cngstDrop_set = r9311b_l2ntfy_cngstDrop_set,
        .l2ntfy_remoteCngstDropCoverEnable_get = r9311b_l2ntfy_remoteCngstDropCoverEnable_get,
        .l2ntfy_remoteCngstDropCoverEnable_set = r9311b_l2ntfy_remoteCngstDropCoverEnable_set,
        .l2ntfy_remoteCngstDrop_get = r9311b_l2ntfy_remoteCngstDrop_get,
        .l2ntfy_remoteCngstDrop_set = r9311b_l2ntfy_remoteCngstDrop_set,
    },
#endif
};
