...
#if defined(CONFIG_SDK_RTL9311B)
#define GPIO_R9311B_PORT_MAX          (GPIO_PORT_D+1)
static gpio_portReg_t   gpio_r9311b_portReg[GPIO_R9311B_PORT_MAX] =
        {
            [GPIO_PORT_A] = { .cnr.addr = RTL9311B_PABCD_CNR_ADDR, .cnr.offset = RTL9311B_PABCD_CNR_PFC_A_OFFSET,
                              .dir.addr = RTL9311B_PABCD_DIR_ADDR, .dir.offset = RTL9311B_PABCD_DIR_DRC_A_OFFSET,
                              .dat.addr = RTL9311B_PABCD_DAT_ADDR, .dat.offset = RTL9311B_PABCD_DAT_PD_A_OFFSET,
                              .isr.addr = RTL9311B_PABCD_ISR_ADDR, .isr.offset = RTL9311B_PABCD_ISR_IPS_A_OFFSET,
                              .imr.addr = RTL9311B_PAB_IMR_ADDR,   .imr.offset = RTL9311B_PAB_IMR_PA0_IM_OFFSET,
                            },
            [GPIO_PORT_B] = { .cnr.addr = RTL9311B_PABCD_CNR_ADDR, .cnr.offset = RTL9311B_PABCD_CNR_PFC_B_OFFSET,
                              .dir.addr = RTL9311B_PABCD_DIR_ADDR, .dir.offset = RTL9311B_PABCD_DIR_DRC_B_OFFSET,
                              .dat.addr = RTL9311B_PABCD_DAT_ADDR, .dat.offset = RTL9311B_PABCD_DAT_PD_B_OFFSET,
                              .isr.addr = RTL9311B_PABCD_ISR_ADDR, .isr.offset = RTL9311B_PABCD_ISR_IPS_B_OFFSET,
                              .imr.addr = RTL9311B_PAB_IMR_ADDR,   .imr.offset = RTL9311B_PAB_IMR_PB0_IM_OFFSET,
                            },
            [GPIO_PORT_C] = { .cnr.addr = RTL9311B_PABCD_CNR_ADDR, .cnr.offset = RTL9311B_PABCD_CNR_PFC_C_OFFSET,
                              .dir.addr = RTL9311B_PABCD_DIR_ADDR, .dir.offset = RTL9311B_PABCD_DIR_DRC_C_OFFSET,
                              .dat.addr = RTL9311B_PABCD_DAT_ADDR, .dat.offset = RTL9311B_PABCD_DAT_PD_C_OFFSET,
                              .isr.addr = RTL9311B_PABCD_ISR_ADDR, .isr.offset = RTL9311B_PABCD_ISR_IPS_C_OFFSET,
                              .imr.addr = RTL9311B_PCD_IMR_ADDR,   .imr.offset = RTL9311B_PCD_IMR_PC0_IM_OFFSET,
                            },
            [GPIO_PORT_D] = { .cnr.addr = RTL9311B_PABCD_CNR_ADDR, .cnr.offset = RTL9311B_PABCD_CNR_PFC_D_OFFSET,
                              .dir.addr = RTL9311B_PABCD_DIR_ADDR, .dir.offset = RTL9311B_PABCD_DIR_DRC_D_OFFSET,
                              .dat.addr = RTL9311B_PABCD_DAT_ADDR, .dat.offset = RTL9311B_PABCD_DAT_PD_D_OFFSET,
                              .isr.addr = RTL9311B_PABCD_ISR_ADDR, .isr.offset = RTL9311B_PABCD_ISR_IPS_D_OFFSET,
                              .imr.addr = RTL9311B_PCD_IMR_ADDR,   .imr.offset = RTL9311B_PCD_IMR_PD0_IM_OFFSET,
                            },
        };
#endif /* CONFIG_SDK_RTL9311B */


gpio_regDef_t gpio_reg[DRV_REG_END] =
{
#if (defined(CONFIG_SDK_RTL9310))
    [DRV_REG_9310] =
    {
    ...
    [DRV_REG_9311B] =
    {
        .pPortReg           = gpio_r9311b_portReg,
        .portMax            = GPIO_R9311B_PORT_MAX,
    },
#endif /* defined(CONFIG_SDK_RTL9300) */
...
#define GPIO_REG(unit)      gpio_reg[RT_DRV_REG_TYPE(unit)]
#define GPIO_COM_CHK(unit)  (GPIO_REG(unit).pPortReg != NULL)
