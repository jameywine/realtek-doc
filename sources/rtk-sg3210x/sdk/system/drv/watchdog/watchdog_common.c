...
wdg_reg_definition_t wdg_reg[DRV_REG_END] =
{
    ...
    [DRV_REG_9311B] =
    {
        .wdog_ctrlr =
        {
            .reg_addr = RTL9311B_WDT_CTRL_ADDR,
            .wdtCtrlr_wdt_clk_sc.mask = RTL9311B_WDT_CTRL_WDT_CLK_SC_MASK,
            .wdtCtrlr_wdt_clk_sc.offset = RTL9311B_WDT_CTRL_WDT_CLK_SC_OFFSET,
            .wdtCtrlr_wdt_e.mask = RTL9311B_WDT_CTRL_WDT_E_MASK,
            .wdtCtrlr_wdt_e.offset = RTL9311B_WDT_CTRL_WDT_E_OFFSET,
            .wdtCtrlr_ph1_to.mask = RTL9311B_WDT_CTRL_PH1_TO_MASK,
            .wdtCtrlr_ph1_to.offset = RTL9311B_WDT_CTRL_PH1_TO_OFFSET,
            .wdtCtrlr_ph2_to.mask = RTL9311B_WDT_CTRL_PH2_TO_MASK,
            .wdtCtrlr_ph2_to.offset = RTL9311B_WDT_CTRL_PH2_TO_OFFSET,
            .wdtCtrlr_reset_mode.mask = RTL9311B_WDT_CTRL_WDT_RESET_MODE_MASK,
            .wdtCtrlr_reset_mode.offset = RTL9311B_WDT_CTRL_WDT_RESET_MODE_OFFSET,
        },
        .wdtcntrr_addr =
        {
            .reg_addr = RTL9311B_WDTCNTRR_ADDR,
            .wdog_cntr_wdt_kick.mask = RTL9311B_WDTCNTRR_WDT_KICK_MASK,
            .wdog_cntr_wdt_kick.offset = RTL9311B_WDTCNTRR_WDT_KICK_OFFSET,
        },
...
watchdog_enable_set(uint32 unit, uint32 enable)
{
    ...
    switch (enable)
    {
        case DISABLED:          /* Disable */
            ...
            if (!(RTK_9310_FAMILY_ID(unit) || RTK_9311B_FAMILY_ID(unit)))
            {
