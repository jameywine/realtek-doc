...
static hwp_swDescp_t rtl9303_2x8254L_swDescp = {
    ...
    .port.descp = {
        { .mac_id = 0,  .attr = HWP_ETH, .eth = HWP_5GE,  .medi = HWP_COPPER, .sds = HWP_1SDS(2), .phy_idx = 0, .smi = 0,  .phy_addr = 0, .led_c = 0, .led_f = 0, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 8,  .attr = HWP_ETH, .eth = HWP_5GE,  .medi = HWP_COPPER, .sds = HWP_1SDS(3), .phy_idx = 0, .smi = 0,  .phy_addr = 1, .led_c = 0, .led_f = 0, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 16, .attr = HWP_ETH, .eth = HWP_5GE,  .medi = HWP_COPPER, .sds = HWP_1SDS(4), .phy_idx = 0, .smi = 0,  .phy_addr = 2, .led_c = 0, .led_f = 0, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 20, .attr = HWP_ETH, .eth = HWP_5GE,  .medi = HWP_COPPER, .sds = HWP_1SDS(5), .phy_idx = 0, .smi = 0,  .phy_addr = 3, .led_c = 0, .led_f = 0, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 24, .attr = HWP_ETH, .eth = HWP_5GE,  .medi = HWP_COPPER, .sds = HWP_1SDS(6), .phy_idx = 1, .smi = 3,  .phy_addr = 4, .led_c = 0, .led_f = 0, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 25, .attr = HWP_ETH, .eth = HWP_5GE,  .medi = HWP_COPPER, .sds = HWP_1SDS(7), .phy_idx = 1, .smi = 3,  .phy_addr = 5, .led_c = 0, .led_f = 0, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 26, .attr = HWP_ETH, .eth = HWP_5GE,  .medi = HWP_COPPER, .sds = HWP_1SDS(8), .phy_idx = 1, .smi = 3,  .phy_addr = 6, .led_c = 0, .led_f = 0, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 27, .attr = HWP_ETH, .eth = HWP_5GE,  .medi = HWP_COPPER, .sds = HWP_1SDS(9), .phy_idx = 1, .smi = 3,. phy_addr  = 7, .led_c = 0, .led_f = 0, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
    ...
    .phy.descp = {
        ...
        [1] = { .chip = RTK_PHYTYPE_RTL8254L, .mac_id = 24, .phy_max = 4, .interruptSocGpioDev = HWP_NONE, .interruptSocGpioPin = HWP_NONE },
        [2] = { .chip = HWP_END },
    }   /* .phy.descp */
};
