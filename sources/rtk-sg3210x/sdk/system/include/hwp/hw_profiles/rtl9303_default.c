...
static hwp_swDescp_t rtl9303_default_swDescp = {
    ...
    .port.descp = {
        { .mac_id =  0, .attr = HWP_TBD, .eth = HWP_TBD,  .medi = HWP_SERDES, .sds = HWP_1SDS(2), .phy_idx = HWP_NONE, .smi = 0, .phy_addr =   0, .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id =  8, .attr = HWP_TBD, .eth = HWP_TBD,  .medi = HWP_SERDES, .sds = HWP_1SDS(3), .phy_idx = HWP_NONE, .smi = 1, .phy_addr =   8, .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 16, .attr = HWP_TBD, .eth = HWP_TBD,  .medi = HWP_SERDES, .sds = HWP_1SDS(4), .phy_idx = HWP_NONE, .smi = 2, .phy_addr =  16, .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 20, .attr = HWP_TBD, .eth = HWP_TBD,  .medi = HWP_SERDES, .sds = HWP_1SDS(5), .phy_idx = HWP_NONE, .smi = 2, .phy_addr =  20, .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 24, .attr = HWP_TBD, .eth = HWP_TBD,  .medi = HWP_SERDES, .sds = HWP_1SDS(6), .phy_idx = HWP_NONE, .smi = 3, .phy_addr =  24, .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 25, .attr = HWP_TBD, .eth = HWP_TBD,  .medi = HWP_SERDES, .sds = HWP_1SDS(7), .phy_idx = HWP_NONE, .smi = 3, .phy_addr =  25, .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 26, .attr = HWP_TBD, .eth = HWP_TBD,  .medi = HWP_SERDES, .sds = HWP_1SDS(8), .phy_idx = HWP_NONE, .smi = 3, .phy_addr =  26, .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 27, .attr = HWP_TBD, .eth = HWP_TBD,  .medi = HWP_SERDES, .sds = HWP_1SDS(9), .phy_idx = HWP_NONE, .smi = 3, .phy_addr =  27, .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
