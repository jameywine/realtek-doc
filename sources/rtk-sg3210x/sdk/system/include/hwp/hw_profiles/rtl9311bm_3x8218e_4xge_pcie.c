...
static hwp_swDescp_t rtl9311bm_3x8218e_4xge_pcie_swDescp = {
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9311bm_3x8218e_4xge_pcie = {
    .identifier.name        = "RTL9311BM_3x8218E_4XGE_PCIE",
    .identifier.id          = HWP_RTL9311BM_3x8218E_4XGE_PCIE,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9311bm_3x8218e_4xge_pcie_swDescp,
    }
};
