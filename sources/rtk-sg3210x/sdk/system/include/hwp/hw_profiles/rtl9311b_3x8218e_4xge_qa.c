...
static hwp_swDescp_t rtl9311b_3x8218e_4xge_qa_swDescp = {
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9311b_3x8218e_4xge_qa = {
    .identifier.name        = "RTL9311B_3x8218E_4XGE_QA",
    .identifier.id          = HWP_RTL9311B_3x8218E_4XGE_QA,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9311b_3x8218e_4xge_qa_swDescp,
    }
};
