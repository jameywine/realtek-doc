...
static hwp_swDescp_t rtl9311b_6x8218e_4xge_swDescp1 = {
    ...
    .port.descp = {
        ...
        { .mac_id = 24, .attr = HWP_ETH|HWP_CASCADE, .eth = HWP_XGE,  .medi = HWP_SERDES,  .sds = HWP_1SDS(3),  .phy_idx = HWP_NONE, .smi = HWP_NONE, .phy_addr = HWP_NONE, .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 25, .attr = HWP_ETH|HWP_CASCADE, .eth = HWP_XGE,  .medi = HWP_SERDES,  .sds = HWP_1SDS(4),  .phy_idx = HWP_NONE, .smi = HWP_NONE, .phy_addr = HWP_NONE, .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        ...
        { .mac_id = RTK_OOB_IDX_TO_PORT(0), .attr = HWP_OOB, .eth = HWP_GE, .medi = HWP_COPPER,  .sds = HWP_1SDS(RTK_OOB_IDX_TO_SDS(0)), .phy_idx = 3, .smi = RTK_OOB_IDX_TO_SMI(0), .phy_addr =  0, .led_c = HWP_NONE, .led_f = HWP_NONE,.led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, },
        { .mac_id = HWP_END },
    },  /* port.descp */
    ...
    .led.descp = {
        ...
        .led_signal_invert = TRUE,
        .led_definition_set[0].led[0] = 0x0BFF,
        .led_definition_set[0].led[1] = HWP_LED_END,    /* None */
        .led_definition_set[3].led[0] = 0x09FF,
        .led_definition_set[3].led[1] = 0x03FF,
        .led_definition_set[3].led[2] = HWP_LED_END,    /* None */
        /* OOB LED is controlled by phy */
    },/* led.descp */
    ...
    .serdes.descp = {
        ...
        { .sds_id = 3, .mode = RTK_MII_20GR,    .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_NORMAL },
...
static hwp_swDescp_t rtl9311b_6x8218e_4xge_swDescp2 = {
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9311b_6x8218e_4xge_cascade = {
    .identifier.name        = "RTL9311B_6x8218E_4XGE_CASCADE",
    .identifier.id          = HWP_RTL9311B_6x8218E_4XGE_CASCADE,
    ...
    .sw_count               = 2,
    .swDescp = {
        [0]                 = &rtl9311b_6x8218e_4xge_swDescp1,
        [1]                 = &rtl9311b_6x8218e_4xge_swDescp2,
    }
#else
    .sw_count               = 1,
    .swDescp = {
