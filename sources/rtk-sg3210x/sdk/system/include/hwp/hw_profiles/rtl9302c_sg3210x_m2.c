...
static hwp_swDescp_t rtl9302c_sg3210x_m2_swDescp = {
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9302c_sg3210x_m2 = {

    .identifier.name        = "RTL9302C_SG3210X_M2",
    .identifier.id          = HWP_RTL9302C_SG3210X_M2,
