...
static hwp_swDescp_t rtl9302c_sg3210xhp_m2_v3_swDescp = {
    ...
    .port.descp = {
        { .mac_id = 0, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds = HWP_1SDS(2), .phy_idx = 0,        .smi = 0,        .phy_addr =  0,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        ...
        { .mac_id = 2, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds = HWP_1SDS(2), .phy_idx = 0,        .smi = 0,        .phy_addr =  2,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        ...
        { .mac_id = 8, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds = HWP_1SDS(3), .phy_idx = 1,        .smi = 1,        .phy_addr =  4,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        ...
        { .mac_id = 10, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds = HWP_1SDS(3), .phy_idx = 1,        .smi = 1,        .phy_addr =  6,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
        { .mac_id = 11, .attr = HWP_ETH,   .eth = HWP_2_5GE, .medi = HWP_COPPER, .sds = HWP_1SDS(3), .phy_idx = 1,        .smi = 1,        .phy_addr =  7,        .led_c = 2,        .led_f = HWP_NONE,.led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0,},
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9302c_sg3210xhp_m2_v3 = {

    .identifier.name        = "RTL9302C_SG3210XHP_M2_V3",
    .identifier.id          = HWP_RTL9302C_SG3210XHP_M2_V3,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9302c_sg3210xhp_m2_v3_swDescp,
    }
