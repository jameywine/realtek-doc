...
static hwp_swDescp_t rtl9303_2xcust1_swDescp = {
    ...
    .phy.descp = {
        [0] = { .chip = RTK_PHYTYPE_CUST1/* 407/408/409 */, .mac_id = 0,  .phy_max = 4, .interruptSocGpioDev = HWP_NONE, .interruptSocGpioPin = HWP_NONE },
        [1] = { .chip = RTK_PHYTYPE_CUST1/* 407/408/409 */, .mac_id = 24, .phy_max = 4, .interruptSocGpioDev = HWP_NONE, .interruptSocGpioPin = HWP_NONE },
        [2] = { .chip = HWP_END },
    },   /* .phy.descp */
