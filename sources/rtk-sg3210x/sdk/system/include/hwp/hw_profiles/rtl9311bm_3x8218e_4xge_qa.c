...
static hwp_swDescp_t rtl9311bm_3x8218e_4xge_qa_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id = RTK_OOB_IDX_TO_PORT(0), .attr = HWP_OOB, .eth = HWP_GE, .medi = HWP_COPPER,  .sds = HWP_1SDS(RTK_OOB_IDX_TO_SDS(0)), .phy_idx = HWP_NONE, .smi = RTK_OOB_IDX_TO_SMI(0), .phy_addr =  1, .led_c = HWP_NONE, .led_f = HWP_NONE,.led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, },
        { .mac_id = HWP_END },
    },  /* port.descp */
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9311bm_3x8218e_4xge_qa = {
    .identifier.name        = "RTL9311BM_3x8218E_4XGE_QA",
    .identifier.id          = HWP_RTL9311BM_3x8218E_4XGE_QA,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9311bm_3x8218e_4xge_qa_swDescp,
    }
};
