...
static hwp_swDescp_t rtl9311bm_3x8218d_4xge_qa_swDescp = {
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9311bm_3x8218d_4xge_qa = {
    .identifier.name        = "RTL9311BM_3x8218D_4XGE_QA",
    .identifier.id          = HWP_RTL9311BM_3x8218D_4XGE_QA,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9311bm_3x8218d_4xge_qa_swDescp,
    }
};
