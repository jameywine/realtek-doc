 ...
 */
static hwp_swDescp_t rtl9303_2x8264_swDescp = {
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9303_2x8264 = {

    .identifier.name        = "RTL9303_2X8264",
    .identifier.id          = HWP_RTL9303_2x8264,
