 ...
 * Macro Definition
 */
/* phy_index translation */
#define HWP_UNIT_BASE_MACID_TO_PHY_INDEX(unit, basePort)    ((unit) * RTK_MAX_PORT_PER_UNIT + (basePort))
#define HWP_PHY_INDEX_TO_UNIT(phy_index)                    ((phy_index) / RTK_MAX_PORT_PER_UNIT)
#define HWP_PHY_INDEX_TO_BASE_MACID(phy_index)              ((phy_index) % RTK_MAX_PORT_PER_UNIT)
