...
/* Function Name:
 *      ioal_soc_mem32_field_read
 * Description:
 *      Write the value to the field of SoC register.
 * Input:
 *      unit   - unit id
 *      addr   - register address
 *      offset - field offset
 ...
 */
extern int32
ioal_soc_mem32_field_read(uint32 unit, uintptr addr, uint32 offset, uint32 mask, uint32 *pVal);

/* Function Name:
 *      ioal_soc_mem32_field_write
 * Description:
 *      Write the value to the field of SoC register.
 * Input:
 *      unit   - unit id
 ...
 */
extern int32
ioal_soc_mem32_field_write(uint32 unit, uintptr addr, uint32 offset, uint32 mask, uint32 val);
