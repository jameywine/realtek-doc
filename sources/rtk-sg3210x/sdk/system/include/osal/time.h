...
/* Function Name:
 *      osal_time_is_hrtimer_enabled
 * Description:
 *      Check if the high resolution timer is enabled,
 *      if enabled, the resolution nsec will be smaller than
 *      the kernel definition TICK_NSEC (e.g., 10,000,000)
 * Input:
 *      None
 * Output:
 *      None
 ...
 */
extern uint32
osal_time_is_hrtimer_enabled(void);
