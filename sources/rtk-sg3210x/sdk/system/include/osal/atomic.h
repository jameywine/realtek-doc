...
#if defined(CONFIG_BUILD_WORDSIZE_64)
  #define CONFIG_SDK_OSAL_ATOMIC64    1
#endif
 ...
 */
  ...
  #ifdef CONFIG_SDK_OSAL_ATOMIC64
    #define osal_atomic64_t atomic64_t
  #endif /* CONFIG_SDK_OSAL_ATOMIC64 */
#else
  typedef int osal_atomic_t;
  typedef int64 osal_atomic64_t;
#endif
 ...
 */
int32
osal_atomic64_inc(osal_atomic64_t *pAtomic);
#endif /* CONFIG_SDK_OSAL_ATOMIC64 */
 ...
 */
int64
osal_atomic64_add_return(int64 val, osal_atomic64_t *pAtomic);
#endif /* CONFIG_SDK_OSAL_ATOMIC64 */
 ...
 */
int32
osal_atomic64_set(osal_atomic64_t *pAtomic, int64 counter);
#endif /* CONFIG_SDK_OSAL_ATOMIC64 */
 ...
 */
int64
osal_atomic64_dec_return(osal_atomic64_t *pAtomic);
#endif /* CONFIG_SDK_OSAL_ATOMIC64 */
 ...
 */
int64
osal_atomic64_sub_return(int64 val, osal_atomic64_t *pAtomic);
#endif /* CONFIG_SDK_OSAL_ATOMIC64 */
 ...
 */
int64
osal_atomic64_read(osal_atomic64_t *pAtomic);
#endif /* CONFIG_SDK_OSAL_ATOMIC64 */
