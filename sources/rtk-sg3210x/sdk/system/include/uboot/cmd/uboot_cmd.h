...
/* Function Name:
 *      rtk_serdesMedia_none_set
 *      rtk_serdesMedia_fiber10g_set
 *      rtk_serdesMedia_fiber1g_set
 *      rtk_serdesMedia_fiber100m_set
 *      rtk_serdesMedia_dac10g50cm_set
 *      rtk_serdesMedia_dac10g100cm_set
 *      rtk_serdesMedia_dac10g300cm_set
 * Description:
 *      Set 10G port media as defined in rtk_port_serdesMedia_t
 * Input:
 *      port        mac ID
 * Output:
 *      None
 ...
 *      None
 */
void rtk_serdesMedia_none_set(unsigned int port);
void rtk_serdesMedia_fiber10g_set(unsigned int port);
void rtk_serdesMedia_fiber1g_set(unsigned int port);
void rtk_serdesMedia_fiber100m_set(unsigned int port);
void rtk_serdesMedia_dac10g50cm_set(unsigned int port);
void rtk_serdesMedia_dac10g100cm_set(unsigned int port);
void rtk_serdesMedia_dac10g300cm_set(unsigned int port);
