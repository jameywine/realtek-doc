...
/* Function Name:
 *      _rt_util_intr_gmac_isr
 * Description:
 *      ISR callback handler of OSAL for Internal GMAC(OOB).
 * Input:
 *      None
 * Output:
 *      None
 ...
 */
extern osal_isrret_t
_rt_util_intr_gmac_isr(void *pParam);
 ...
 */
extern int32
_rt_util_intr_handler(drv_intr_isrBitmap_t *isr_glb_sts);
