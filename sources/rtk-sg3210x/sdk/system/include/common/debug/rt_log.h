...
#define MOD_BUFFMGMT            (1ULL << SDK_MOD_BUFFMGMT)      /* 0x00001000-00000000 */
#define MOD_OOB                 (1ULL << SDK_MOD_OOB)           /* 0x00002000-00000000 */
#define MOD_EVPN                (1ULL << SDK_MOD_EVPN)          /* 0x00004000-00000000 */
#define MOD_NV                  (1ULL << SDK_MOD_NV)            /* 0x00008000-00000000 */
#define MOD_FLOW                (1ULL << SDK_MOD_FLOW)          /* 0x00010000-00000000 */
#define MOD_ECN                 (1ULL << SDK_MOD_ECN)           /* 0x00020000-00000000 */
#define MOD_TSN                 (1ULL << SDK_MOD_TSN)           /* 0x00040000-00000000 */
#define MOD_METER               (1ULL << SDK_MOD_METER)         /* 0x00080000-00000000 */
#define MOD_OSB                 (1ULL << SDK_MOD_OSB)           /* 0x00100000-00000000 */
#define MOD_SER                 (1ULL << SDK_MOD_SER)           /* 0x00200000-00000000 */
...
#define STR_MOD_BUFFMGMT        "buffmgmt"      /* SDK_MOD_BUFFMGMT */
#define STR_MOD_OOB             "oob"           /* SDK_MOD_OOB */
#define STR_MOD_EVPN            "evpn"          /* SDK_MOD_EVPN */
#define STR_MOD_NV              "nv"            /* SDK_MOD_NV */
#define STR_MOD_FLOW            "flow"          /* SDK_MOD_FLOW */
#define STR_MOD_ECN             "ecn"           /* SDK_MOD_ECN */
#define STR_MOD_TSN             "tsn"           /* SDK_MOD_TSN */
#define STR_MOD_METER           "meter"         /* SDK_MOD_METER */
#define STR_MOD_OSB             "osb"           /* SDK_MOD_OSB */
#define STR_MOD_SER             "ser"           /* SDK_MOD_SER */
...
#undef _RT_ERR
  ...
  #define RT_LOG(level, module, args...) \
      do { if(0){int32 _ret = rt_log(level, module, ## args); (void)_ret;}} while (0)
  ...
  #define RT_INIT_ERR(error_code, module, fmt, args...)   do { if (0) {RT_ERR(error_code, (MOD_INIT|module), fmt, ##args);} } while(0)
  #define RT_INIT_MSG(fmt, args...)                       do { if (0) { osal_printf(fmt, ##args); } } while (0)
#else

  /* Turn off all messages for reducing code size at compile time */
  #define RT_LOG(level, module, args...)                  do {} while(0)
  #define RT_ERR(error_code, module, fmt, args...)        do { if (error_code); /*avoid compile error*/ } while(0)
  #define RT_INIT_ERR(error_code, module, fmt, args...)   do { if (error_code); /*avoid compile error*/ osal_printf(fmt, ##args); } while (0)
  #define RT_INIT_MSG(fmt, args...)                       do { osal_printf(fmt, ##args); } while (0)
...
do {                                                \
    if (log_init_flag == INIT_NOT_COMPLETED)        \
        break;                                      \
...
#define RT_LOG_MODULE_STRING               \
    ...
    (uint8 *)STR_MOD_BUFFMGMT,              /* SDK_MOD_BUFFMGMT */          \
    (uint8 *)STR_MOD_OOB,                   /* SDK_MOD_OOB */               \
    (uint8 *)STR_MOD_EVPN,                  /* SDK_MOD_EVPN */              \
    (uint8 *)STR_MOD_NV,                    /* SDK_MOD_NV */                \
    (uint8 *)STR_MOD_FLOW,                  /* SDK_MOD_FLOW */              \
    (uint8 *)STR_MOD_ECN,                   /* SDK_MOD_ECN */               \
    (uint8 *)STR_MOD_TSN,                   /* SDK_MOD_TSN */               \
    (uint8 *)STR_MOD_METER,                 /* SDK_MOD_METER */             \
    (uint8 *)STR_MOD_OSB,                   /* SDK_MOD_OSB */               \
    (uint8 *)STR_MOD_SER,                   /* SDK_MOD_SER */               \
