...
int	webfailsafe_upgrade_type = 0/*WEBFAILSAFE_UPGRADE_TYPE_FIRMWARE*/;
...
/*#endif*/
	...
	do_http_progress( 0/*WEBFAILSAFE_PROGRESS_START*/ );
	...
	for ( ; ; ) {
		...
		if ( ctrlc() ) {
			...
			webfailsafe_upgrade_type = 0/*WEBFAILSAFE_UPGRADE_TYPE_FIRMWARE*/;
		...
		// show progress
		do_http_progress( 2/*WEBFAILSAFE_PROGRESS_UPLOAD_READY*/ );

		// try to make upgrade!
		if ( do_http_upgrade( NetBootFileXferSize, webfailsafe_upgrade_type ) >= 0 ) {
			udelay( 500000 );
			do_http_progress( 3/*WEBFAILSAFE_PROGRESS_UPGRADE_READY*/ );
			udelay( 500000 );
