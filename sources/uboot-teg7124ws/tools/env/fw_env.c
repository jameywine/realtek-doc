...
static char default_sys_environment[] = {
...
#endif
#ifdef CONFIG_SENAO_DEFAULT_SN
    "senao_serial_num=" CONFIG_SENAO_DEFAULT_SN "\0"
#endif
#ifdef CONFIG_SENAO_DEFAULT_MAGIC_NUMBER
    "magic_number=" MK_STR(CONFIG_IH_MAGIC_NUMBER) "\0"
#endif
#ifdef CONFIG_SENAO_BOOT_VERSION
    "boot_version=" CONFIG_SENAO_BOOT_VERSION "\0"
#endif
#ifdef CONFIG_SENAO_RESET_FLAG
    "reset_flag=" CONFIG_SENAO_RESET_FLAG "\0"
#endif
#ifdef CONFIG_SENAO_IMMORTAL_FLAG
    "immortal=" CONFIG_SENAO_IMMORTAL_FLAG "\0"
#endif
#ifdef CONFIG_SENAO_SGS_MODEL
    "sgs_model=" CONFIG_SENAO_SGS_MODEL "\0"
#endif
	...
	if (!HaveRedundEnv) {
		if (!crc0_ok) {
			...
			memcpy(environment.data, default_environment, sizeof default_environment);
					...
					memcpy(environment.data, default_sys_environment, sizeof default_sys_environment);
		}
	} else {
